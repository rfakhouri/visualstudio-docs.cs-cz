---
title: "Jsgetpropertyidtype – funkce | Microsoft Docs"
ms.custom: 
ms.date: 01/18/2017
...
---
# <a name="jsgetpropertyidtype-function"></a>JsGetPropertyIdType – funkce
...
#### <a name="parameters"></a>Parametry  
 `propertyId`  
 ID vlastnosti získat typu.  
  
 `propertyIdType`  
 `JsPropertyIdType` Daná vlastnost ID.  
