---
title: "Výčet Js_property_members | Microsoft Docs"
ms.custom: 
ms.date: 01/18/2017
...
|Název|Popis|  
|----------|-----------------|  
|`JS_PROPERTY_MEMBERS_ALL`|Představuje žádost výčet všech členů.|  
|`JS_PROPERTY_MEMBERS_ARGUMENTS`|Představuje žádost výčet pouze argumenty.|  
