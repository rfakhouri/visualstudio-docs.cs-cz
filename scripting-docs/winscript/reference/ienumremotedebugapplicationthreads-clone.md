---
title: IEnumRemoteDebugApplicationThreads::Clone | Dokumentace Microsoftu
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
#### <a name="parameters"></a>Parametry  
 `pperdat`  
 [out] Vrátí `IEnumRemoteDebugApplicationThreads` rozhraní klonu enumerátor.  
