---
title: Konstanty ladicího programu aktivních skriptů, výčty a struktury | Dokumentace Microsoftu
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
|[DEBUG_TEXT – konstanty](../../winscript/reference/debug-text-constants.md)|Příznaky možností používané během [IDebugExpressionContext::ParseLanguageText](../../winscript/reference/idebugexpressioncontext-parselanguagetext.md).|  
...
|[JS_PROPERTY_ATTRIBUTES – výčet](../../winscript/reference/js-property-attributes-enumeration.md)|Označuje atributy vlastnosti.|  
|[JS_PROPERTY_MEMBERS – výčet](../../winscript/reference/js-property-members-enumeration.md)|Příznaky pro určení typu informací, které mají být vráceny v žádosti o členy objektu|  
|[JsDebugReadMemoryFlags – výčet](../../winscript/reference/jsdebugreadmemoryflags-enumeration.md)|Příznaky pro určení chování při čtení paměti|  
|[SCRIPT_DEBUGGER_OPTIONS – výčet](../../winscript/reference/script-debugger-options-enumeration.md)|Označuje sadu možností a schopností, které se vztahují na připojený ladicí program.|  
|[SCRIPT_ERROR_DEBUG_EXCEPTION_THROWN_KIND – výčet](../../winscript/reference/script-error-debug-exception-thrown-kind-enumeration.md)|Označuje druh vyvolané výjimky.|  
...
|[JS_NATIVE_FRAME – struktura](../../winscript/reference/js-native-frame-structure.md)|Představuje rámec zásobníku.|  
|[JsDebugPropertyInfo – struktura](../../winscript/reference/jsdebugpropertyinfo-structure.md)|Označuje informace o vlastnosti.|  
