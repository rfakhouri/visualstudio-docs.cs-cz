---
title: lastmatch – vlastnost ($&amp;) (RegExp) (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24790860"
---
# <a name="lastmatch-property-amp-regexp-javascript"></a>lastmatch – vlastnost ($&amp;) (RegExp) (JavaScript)
Vrátí poslední odpovídající znaky z jakékoli hledání regulárního výrazu. Jen pro čtení.  
...
## <a name="remarks"></a>Poznámky  
 ...
 Počáteční hodnota `lastMatch` vlastnost je prázdný řetězec. Hodnota `lastMatch` změny vlastností vždy, když je proveden úspěšně shody.  
  
## <a name="example"></a>Příklad  
 Následující příklad ukazuje použití `lastMatch` vlastnost:  
