---
title: Bytes_per_element – konstanta (Int8Array) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24789036"
---
# <a name="bytesperelement-constant-int8array"></a>BYTES_PER_ELEMENT – konstanta (Int8Array)
