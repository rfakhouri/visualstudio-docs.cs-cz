---
title: getfloat64 – metoda (DataView) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24790446"
---
# <a name="getfloat64-method-dataview"></a>getFloat64 – metoda (DataView)
Získá hodnotu Float64 v zadané odsazení bajtu od začátku zobrazení. Neexistuje žádné omezení zarovnání; vícebajtové hodnoty může být získána z jakékoli posun.  
...
## <a name="parameters"></a>Parametry  
 `testFloat`  
 Požadováno. Float64 hodnota, která je vrátila z metody.  
...
## <a name="example"></a>Příklad  
 Následující příklad ukazuje, jak získat první Float64 v zobrazení DataView.  
