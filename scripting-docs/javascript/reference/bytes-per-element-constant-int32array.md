---
title: Bytes_per_element – konstanta (Int32Array) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24789054"
---
# <a name="bytesperelement-constant-int32array"></a>BYTES_PER_ELEMENT – konstanta (Int32Array)
