---
title: Bytes_per_element – konstanta (Float32Array) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24788925"
---
# <a name="bytesperelement-constant-float32array"></a>BYTES_PER_ELEMENT – konstanta (Float32Array)
