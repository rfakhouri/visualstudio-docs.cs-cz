---
title: constructor – vlastnost (WeakSet) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24790347"
---
# <a name="constructor-property-weakset"></a>constructor – vlastnost (WeakSet)
Určuje funkce, která vytvoří `WeakSet`.  
...
## <a name="remarks"></a>Poznámky  
 Požadované `weakset` je název sady.  
