---
title: lastparen – vlastnost ($ +) (RegExp) (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24791316"
---
# <a name="lastparen-property--regexp-javascript"></a>lastParen – vlastnost ($+) (RegExp) (JavaScript)
Vrátí poslední submatch závorky z jakékoli hledání regulárního výrazu, pokud existuje. Jen pro čtení.  
...
## <a name="remarks"></a>Poznámky  
 ...
 Počáteční hodnota `lastParen` vlastnost je prázdný řetězec. Hodnota `lastParen` změny vlastností vždy, když je proveden úspěšně shody.  
  
## <a name="example"></a>Příklad  
 Následující příklad ukazuje použití `lastParen` vlastnost:  
