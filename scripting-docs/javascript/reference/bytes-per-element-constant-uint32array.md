---
title: Bytes_per_element – konstanta (Uint32Array) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24788958"
---
# <a name="bytesperelement-constant-uint32array"></a>BYTES_PER_ELEMENT – konstanta (Uint32Array)
