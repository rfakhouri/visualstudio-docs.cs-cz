---
title: Operátor přiřazení dělení (-) (JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24790428"
---
# <a name="division-assignment-operator---javascript"></a>Operátor přiřazení dělení (-) (JavaScript)
Rozdělí hodnoty proměnné hodnotou výrazu a přiřadí výsledek proměnné.  
...
## <a name="see-also"></a>Viz také  
 [Operátor dělení (/)](../../javascript/reference/division-operator-decrement-javascript.md)   
