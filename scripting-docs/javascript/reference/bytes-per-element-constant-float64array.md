---
title: Bytes_per_element – konstanta (Float64Array) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24789099"
---
# <a name="bytesperelement-constant-float64array"></a>BYTES_PER_ELEMENT – konstanta (Float64Array)
