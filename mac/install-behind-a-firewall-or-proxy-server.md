...
- [Instalace a používání sady Visual Studio 2017 a služeb Azure za bránou firewall nebo proxy serverem](https://docs.microsoft.com/visualstudio/install/install-and-use-visual-studio-behind-a-firewall-or-proxy-server)
- [Řešení potíží s obdobným problémům ve Windows](https://docs.microsoft.com/visualstudio/install/troubleshooting-network-related-errors-in-visual-studio)