...
Napsat další kód použitelné s nabídkami rychlý a klávesové zkratky pro [přejmenování, refaktoring a kontextu akce](refactoring.md).
...
Zvýšení produktivity pomocí vazeb klíče, které znáte. Visual Studio pro Mac poskytuje známé [klíče vazby](customizing-the-ide.md) pro mnoho oblíbených integrovaného vývojového prostředí, jako je například Visual Studio v systému Windows, ReSharper, Visual Studio Code a Xcode.

### <a name="customize-the-visual-theme"></a>Přizpůsobení Visual motiv

Poskytnout vaše očí rest s zahrnutou [tmavým motivem](customizing-the-ide.md).
...
* [Přizpůsobení integrovaného vývojového prostředí](customizing-the-ide.md) – přečtěte si postup [změnit vizuální motiv](customizing-the-ide.md#dark-theme) nebo přepnout na další známé [klíče vazby](customizing-the-ide.md#key-bindings) schéma.
* [Editor zdroj](source-editor.md) – zjistěte, jak Visual Studio pro Mac provádět zápis lepší kódu rychlejší a snadnější, včetně běžné [klávesové zkratky](keyboard-shortcuts.md).
