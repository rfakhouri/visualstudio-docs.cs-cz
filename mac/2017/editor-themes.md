...
1. Vyberte **přidat** tlačítko v dialogovém okně Možnosti motivy barev:  ![Přidat barevný motiv](media/source-editor-image20.png)
2. Procházet pro motiv na místním počítači a stiskněte klávesu **otevřít**.
3. Motiv se přidá do dolní části seznamu předinstalované motivů. Náhled motiv, vyberte ho: ![Barva motivu ve verzi Preview](media/source-editor-image21.png)
