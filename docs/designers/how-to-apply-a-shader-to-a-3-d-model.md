...
-   Použití shaderu 3D modelu  
  
## <a name="applying-a-shader-to-a-3-d-model"></a>Použití shaderu 3D modelu  
 Můžete použít efekt shaderu 3D modelu umožnit zajímavé vzhled.  
  
 Než začnete, ujistěte se, že **vlastnosti** zobrazí se okno.  
  
#### <a name="to-apply-a-shader-to-a-3-d-model"></a>Chcete-li použít shaderu 3D modelu  
