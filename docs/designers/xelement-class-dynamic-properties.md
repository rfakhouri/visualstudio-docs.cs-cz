---
title: Dynamické vlastnosti XElement – třída
ms.date: 11/04/2016
...
|Téma|Popis|
|-----------|-----------------|
|[Atribut](../designers/attribute-xelement-dynamic-property.md)|Získá indexeru. používá se k načtení atributu, který odpovídá zadaným rozšířené názvem.|
|[Element](../designers/element-xelement-dynamic-property.md)|Získá indexeru. používá se k načtení podřízený element, který odpovídá zadaným rozšířené názvem.|
