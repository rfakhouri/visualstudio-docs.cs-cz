...
|----------|-------------|----------------|  
|**Vektor fotoaparát**|Vektor, který rozšiřuje z aktuální pixelů ke kameře v prostoru world.<br /><br /> Můžete použít k výpočtu odrazů v prostoru world.<br /><br /> **Výstup**<br /><br /> `Output`: `float3`<br /> Vektor z aktuální pixelů fotoaparát.|Žádné|  
|**Barva konstanta**|Barva konstantní hodnotu.<br /><br /> **Výstup**<br /><br /> `Output`: `float4`<br /> Hodnoty barvy.|**Výstup**<br /> Hodnoty barvy.|  
|**Konstantní**|Konstantní skalární hodnotu.<br /><br /> **Výstup**<br /><br /> `Output`: `float`<br /> Skalární hodnota.|**Výstup**<br /> Skalární hodnota.|  
|**2D konstanta**|Toto je konstanta vektoru dvě součásti.<br /><br /> **Výstup**<br /><br /> `Output`: `float2`<br /> Hodnota vektoru.|**Výstup**<br /> Hodnota vektoru.|  
|**3D konstanta**|Tři součásti vektoru konstanta.<br /><br /> **Výstup**<br /><br /> `Output`: `float3`<br /> Hodnota vektoru.|**Výstup**<br /> Hodnota vektoru.|  
|**Konstanta 4D**|Čtyři součást vektoru konstanta.<br /><br /> **Výstup**<br /><br /> `Output`: `float4`<br /> Hodnoty barvy.|**Výstup**<br /> Hodnota vektoru.|  
|**Normalizovaný pozice**|Umístění aktuální pixelů, vyjádřené v souřadnicích normalizovaný zařízení.<br /><br /> Souřadnice x a souřadnici y mají hodnoty v rozsahu [-1, 1],-souřadnice má hodnotu v rozsahu [0, 1], a w součást obsahuje hodnotu hloubky bodu v zobrazení prostoru; w není normalized.<br /><br /> **Výstup**<br /><br /> `Output`: `float4`<br /> Umístění aktuální pixelů.|Žádné|  
|**Barva bodu**|Rozptýlené barva aktuální pixelů, která jsou tvořena kombinací podstatným rozptýlených barvy a vrchol atributy barvy.<br /><br /> **Výstup**<br /><br /> `Output`: `float4`<br /> Rozptýlené barva aktuální pixelů.|Žádné|  
