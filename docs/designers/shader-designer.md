...
ms.locfileid: "39078950"
---
# <a name="shader-designer"></a>Návrhář shaderů

Tento dokument popisuje, jak pracovat [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] návrháře shaderu k vytváření, úpravě a exportovat vlastní vizuální efekty, které jsou označovány jako *shadery*.
...
Tato část popisuje, jak přidat DGSL shader, který má vaše [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] projektu a poskytuje základní informace, které vám pomůžou začít.

### <a name="to-add-a-dgsl-shader-to-your-project"></a>Chcete-li přidat do projektu DGSL shader

1.  V **Průzkumníka řešení**, otevřete místní nabídku pro projekt, ke kterému chcete přidat shaderu a klikněte na tlačítko **přidat** > **nová položka**.
...
Příkazy, které mají vliv na stav návrháře shaderu jsou umístěny na **režim návrháře shaderu** nástrojů v hlavním [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] okna. Návrhářské nástroje a příkazy jsou umístěny na **návrháře shaderu** nástrojů na návrhové ploše návrháře shaderu.
...
|**Režim vykreslování v reálném čase**|Pokud je povoleno vykreslení v reálném čase, [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] překreslí plochu návrhu, i když je provedena žádná akce uživatele. Tento režim je užitečný při práci se shadery, které se mění v průběhu času.|
...
|Název|Popis|
|-----------|-----------------|
|[Práce s 3D prostředky pro hry a aplikace](../designers/working-with-3-d-assets-for-games-and-apps.md)|Najdete zde přehled [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] nástroje, které můžete použít pro práci s texturami a obrazy, 3D modely a efekty shaderu.|
|[Editor obrázků](../designers/image-editor.md)|Popisuje způsob použití [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] Editor obrázků pro práci s texturami a obrázky.|
|[Editor modelů](../designers/model-editor.md)|Popisuje způsob použití [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] editoru modelů pro práci s 3D modely.|