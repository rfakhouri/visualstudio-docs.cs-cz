...
### <a name="previewing-shaders"></a>Zobrazení náhledu shadery  
...
###### <a name="to-choose-a-preview-shape"></a>Chcete-li zvolit obrazce preview  
...
###### <a name="to-enable-real-time-rendering"></a>Chcete-li povolit vykreslování v reálném čase  
  
-   Na panelu nástrojů návrháře shaderu zvolte **vykreslování v reálném čase**.  
  
#### <a name="examining-the-effect"></a>Zkoumání účinek  
...
###### <a name="to-rotate-the-shape"></a>Chcete-li otočit tvaru  
  
-   Stiskněte a podržte klávesu Alt a pak vyberte libovolného bodu na návrhovou plochu a přesunout ho.  
  
### <a name="exporting-shaders"></a>Export shadery  
