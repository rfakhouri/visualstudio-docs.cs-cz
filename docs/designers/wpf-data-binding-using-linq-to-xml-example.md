---
title: Datové vazby WPF pomocí LINQ to XML příklad
ms.date: 11/04/2016
ms.topic: conceptual
...
ms.locfileid: "55951641"
---
# <a name="wpf-data-binding-using-linq-to-xml-example"></a>Datové vazby WPF pomocí LINQ na ukázkový kód XML
