...
2.  Klikněte nebo klepněte sem a můžete spustit instalační program a potom vyberte **upravit**.  
     ...
     ![Spustit nebo upravit sadu Visual Studio](media/vs2017-modify.PNG "upravit 2017 Visual Studio")  
...
4. Klikněte nebo klepněte na **upravit** znovu.  

5. Po instalaci nové úlohy a součásti, klikněte na tlačítko **spusťte**.

## <a name="modify-individual-components"></a>Upravit jednotlivé komponenty

Pokud nechcete použít funkci užitečný úlohy k přizpůsobení instalace Visual Studia, vyberte **jednotlivých součástí** z instalačního programu Visual Studio, vyberte co chcete a potom postupujte podle pokynů.  
