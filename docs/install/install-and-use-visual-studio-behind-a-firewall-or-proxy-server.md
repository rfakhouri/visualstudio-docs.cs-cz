---
title: Instalace a používání sady Visual Studio a služeb Azure za bránou firewall nebo proxy serverem | Dokumentace Microsoftu
...
| visualstudiogallery.msdn.microsoft.com | Umístění pro stahování rozšíření sady Visual Studio |
...
| Rozšíření <br>Kontrola aktualizací | visualstudiogallery.msdn.microsoft.com<br><br>&#42;.windows.net <br>&#42;.microsoftonline.com <br>&#42;.live.com  | | 443 | Používá k poskytování oznámení, když má nainstalovaná rozšíření k dispozici aktualizace. <br><br> Použít jako umístění přihlášení|
...
| Publikování aktualizované webové nástroje <br>kontroly a rozšíření <br>Doporučení  | marketplace.visualstudio.com  <br> visualstudiogallery.msdn.microsoft.com  | protokol HTTPS | 443 | Ke kontrole dostupnost aktualizovat nástroje pro publikování. Pokud je zakázané, se nemusí zobrazit potenciální doporučená rozšíření pro publikování na webu |
...
* Návrh produktu s námi sdílet na [UserVoice](https://visualstudio.uservoice.com/forums/121579).
* Sledování problémů s produktem a najít odpovědi v [komunity vývojářů v aplikaci Visual Studio](https://developercommunity.visualstudio.com/).
