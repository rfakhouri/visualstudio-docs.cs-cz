...
|Balení služby | [account].visualstudio.com <br/> [account].*.visualstudio.com <br/> *.blob.core.windows.net <br/> registry.npmjs.org </br> nodejs.org <br/> dist.nuget.org <br/> nuget.org | https | 443 | *. Npmjs.org, *. nuget.org, a *. nodejs.org jsou jen požadovaná pro určité sestavení scénáře úkolu (např. Instalační program nástroje NuGet, instalační program nástroje uzlu), nebo pokud máte v úmyslu použít veřejné upstreams s informačních kanálů.  Tři domény jsou požadovány pro základní functinality Packaigng služby. |
|||||||
