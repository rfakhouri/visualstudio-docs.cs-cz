...
1.  Spusťte instalační program. Možná budete muset aktualizovat instalační program, než budete pokračovat. Pokud je to tento případ, budete vyzváni k tomu.
 >[!NOTE]
 > V počítači se systémem Windows 10, najdete v části písmeno instalační program **V** jako **instalační program Visual Studio**, nebo pod písmeno **M** jako  **Instalační program Microsoft Visual Studio**.
