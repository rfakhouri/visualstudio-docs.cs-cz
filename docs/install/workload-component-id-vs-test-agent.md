---
title: ID pracovního vytížení a komponenta Visual Studio Test Agent
titleSuffix: ''
...
ms.locfileid: "62553760"
---
# <a name="visual-studio-test-agent-component-directory"></a>Visual Studio Test Agent součástí adresáře
