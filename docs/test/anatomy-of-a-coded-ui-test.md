...
```  
 ...
 T:Microsoft.VisualStudio.TestTools.UITesting.CodedUITestAttribute je automaticky použita pro třídu, která umožňuje testování framework rozpoznat jako testování rozšíření. Všimněte si také, že se nejedná konkrétní třídu. Všechny třídy kódu je obsažený v tomto souboru.  
