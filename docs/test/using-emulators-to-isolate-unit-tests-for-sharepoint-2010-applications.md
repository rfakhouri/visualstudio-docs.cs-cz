...
-   [Probíhá přidávání balíčku emulátorů na zkušební projekt](#BKMK_Adding_the_Emulators_package_to_a_test_project)  
  
-   [Spuštění testu metody s emulace](#BKMK__Running_a_test_method_in_the_emulation_context)  
  
 [Vytváření duální použití třídy a metody](#BKMK_Creating_dual_use_classes_and_methods)  
  
 [Pomocí TestInitialize a TestCleanup atributy pro vytvoření dual použití testovací – třída](#BKMK_Using_TestInitialize_and_TestCleanup_attributes_to_create_a_dual_use_test_class)  
  
 [Zpracování – emulace metod služby SharePoint](#BKMK_Handling_non_emulated_SharePoint_methods)  
  
 [Zápis emulace testy od začátku a souhrn](#BKMK_Writing_emulation_tests_from_scratch__and_a_summary)  
...
##  <a name="BKMK_Using_TestInitialize_and_TestCleanup_attributes_to_create_a_dual_use_test_class"></a>Pomocí TestInitialize a TestCleanup atributy pro vytvoření dual použití testovací – třída  
