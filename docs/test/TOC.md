...
### [Rychlé spuštění](getting-started-with-unit-testing.md)
...
### [Referenční příručka funkce IntelliTest](intellitest-manual/introduction.md)
...
#### [Zápis testů částí pro knihovny DLL jazyka C/C++](how-to-write-unit-tests-for-cpp-dlls.md)
...
### [Izolace testů částí aplikací pro SharePoint 2010 s použitím emulátorů](using-emulators-to-isolate-unit-tests-for-sharepoint-2010-applications.md)
...
## [Testování aplikací pro UWP se sadou Visual Studio](testing-store-apps-with-visual-studio.md)
### [Vytváření a spouštění testování částí pro aplikace pro UWP v sadě Visual Studio](create-and-run-unit-tests-for-a-store-app-in-visual-studio.md)
#### [Testování jednotek knihovny DLL v jazyce Visual C++ pro aplikace pro UWP](unit-testing-a-visual-cpp-dll-for-store-apps.md)
#### [Testování jednotek kódu v jazyce Visual C# v aplikaci pro UWP](unit-testing-visual-csharp-code-in-a-store-app.md)
#### [Spouštění testování částí pro aplikace pro UWP v sadě Visual Studio](run-unit-tests-for-store-apps-in-visual-studio.md)
### [Analýza kvality kódu aplikací pro UWP pomocí statické analýzy kódu sady Visual Studio](analyze-the-code-quality-of-store-apps-using-visual-studio-static-code-analysis.md)
#### [Analýza kódu v jazyce Visual Basic a C# v aplikacích pro UWP pomocí statické analýzy kódu sady Visual Studio](analyze-visual-basic-and-csharp-code-quality-in-store-apps-using-visual-studio-static-code-analysis.md)
#### [Analýza kvality kódu v jazyce C++ v aplikacích pro UWP pomocí statické analýzy kódu sady Visual Studio](analyze-cpp-code-quality-of-store-apps-using-visual-studio-static-code-analysis.md)
...
### [Upgrade prostředí SCVMM 2008 R2 na SCVMM 2012](lab-management/upgrade-scvmm-2008-r2-scvmm-2012.md)
