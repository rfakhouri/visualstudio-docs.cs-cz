...
## [Zápis testů jednotek pro spravovaný kód](writing-unit-tests-for-the-dotnet-framework-with-the-microsoft-unit-test-framework-for-managed-code.md)
...
### [Ukázkový projekt testů jednotek](sample-project-for-creating-unit-tests.md)
...
### [Návod: Zápis testů jednotek pro knihovny DLL v jazyce C++](walkthrough-writing-unit-tests-for-cpp-dlls.md)
