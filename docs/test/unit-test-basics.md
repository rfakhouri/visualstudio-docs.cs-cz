...
-   [Rychlé spuštění](#BKMK_Quick_starts)  
  
-   [Příklad MyBank řešení](#BKMK_The_MyBank_Solution_example)  
  
-   [Vytváření projektů testování částí a testování metody](#BKMK_Creating_the_unit_test_projects)  
  
-   [Zápis testů](#BKMK_Writing_your_tests)  
  
-   [Spuštění testů Průzkumníka testů](#BKMK_Running_tests_in_Test_Explorer)  
...
##  <a name="BKMK_Creating_the_unit_test_projects"></a>Vytváření projektů testování částí a testování metody  
...
###  <a name="BKMK_Running_tests_after_every_build"></a>Spouštění testů po každé sestavení  
 ...
 **Odpověď:** Ano. Pokud máte Visual Studio Enterprise, Microsoft Fakes lze použít s zkušební metody, které můžete psát pomocí systémů testování částí pro spravovaný kód.  
 ...
 Microsoft Fakes používá dva přístupy k vytvoření třídy substitute pro externí závislosti.  
