---
title: "Spouštění testů jednotek v sadě Visual Studio | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="run-unit-tests-in-visual-studio"></a>Spouštění testů jednotek v sadě Visual Studio
