...
```
 ...
 Definuje *methodName* jako metodu, která spouští před vytvořením každá třída test. `TEST_CLASS_INITIALIZE` může být definovaný jenom jednou v třídě test a musí být definován v oboru třídy testu.
