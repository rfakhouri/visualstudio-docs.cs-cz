...
## <a name="importing-reusable-workflows-by-using-the-import-reusable-workflow-template"></a>Import opakovaně použitelných pracovních postupů pomocí šablony Import opakovaně použitelného pracovního postupu  
...
### <a name="importing-task-forms"></a>Import formuláře úkolů  
...
## <a name="importing-reusable-workflows-by-using-the-import-sharepoint-2010-solution-package-template"></a>Import opakovaně použitelných pracovních postupů pomocí balíčku šablony importu služby SharePoint 2010 řešení  
...
-   Po importu pracovního postupu, které okamžitě můžete nasadit a spustit [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)] výběrem klávesy F5. Pokud změníte nic v pracovním postupu v importovaných řešení, může ale muset ručně opravte elementy v projektu, než bude možné nasadit a spustit pracovní postup.  
...
## <a name="importing-globally-reusable-workflow-solutions"></a>Import řešení globálně opakovaně použitelného pracovního postupu  
