...
-   [!INCLUDE[vsPro](../sharepoint/includes/vspro-md.md)]nebo novější.  
...
#### <a name="to-create-a-visual-web-part-project"></a>Vytvoření projektu Visual webové části  
...
#### <a name="to-design-the-layout-of-the-web-part"></a>Návrh rozložení webové části  
...
#### <a name="to-handle-events-of-controls-on-the-web-part"></a>Zpracování událostí ovládacích prvků na webové části  
...
1.  Ve webové části zadejte kalendářích, které chcete zahrnout do zobrazení měsíční kalendář a potom vyberte **aktualizace** tlačítko.  
