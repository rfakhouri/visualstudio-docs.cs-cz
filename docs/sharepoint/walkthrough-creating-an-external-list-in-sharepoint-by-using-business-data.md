...
-   [!INCLUDE[vsPro](../sharepoint/includes/vspro-md.md)], [!INCLUDE[vsUltLong](../sharepoint/includes/vsultlong-md.md)], nebo [!INCLUDE[vsPreLong](../sharepoint/includes/vsprelong-md.md)].  
...
#### <a name="to-create-a-project-that-contains-a-bdc-model"></a>Vytvoření projektu, který obsahuje model služby BDC  
...
#### <a name="to-add-data-access-classes-to-the-project"></a>Přidání tříd pro přístup k datům do projektu  
...
2.  Přidáte připojení k ukázkovou databázi AdventureWorks serveru SQL.  
     ...
     Další informace najdete v tématu [přidat či upravit připojení (Microsoft SQL Server)](http://msdn.microsoft.com/en-us/fa400910-26c3-4df7-b9d1-115e688b4ea3).  
...
#### <a name="to-remove-the-default-entity-from-the-model"></a>Odebrání výchozí entity z modelu  
...
#### <a name="to-add-a-specific-finder-method"></a>Přidání konkrétní vyhledávací metody  
...
#### <a name="to-add-a-finder-method"></a>Přidání vyhledávací metody  
