...
---
# <a name="deploying-publishing-and-upgrading-sharepoint-solution-packages"></a>Nasazení, publikování a upgradování balíčků řešení služby SharePoint
...
> [!NOTE]  
>  V současné době mohou být publikovány pouze řešení v izolovaném prostoru na vzdálených serverech služby SharePoint. Další informace najdete v tématu [v izolovaném prostoru aspekty řešení](../sharepoint/sandboxed-solution-considerations.md).  
  
## <a name="deploying-publishing-and-upgrading"></a>Nasazení, publikování a upgradování  
...
## <a name="deploying-packages"></a>Nasazení balíčků  
...
## <a name="customizing-the-deployment-process"></a>Přizpůsobení procesu nasazení  
...
|Žádné aktivační|Tuto konfiguraci nasazení spustí stejný postup jako výchozí konfiguraci, ale přeskočí krok aktivace.|  
 ...
 Můžete také přidat příkazy, pomocí před a po nasazení. Další informace najdete v tématu [postupy: nastavení příkazů nasazení služby SharePoint](../sharepoint/how-to-set-sharepoint-deployment-commands.md).  
  
## <a name="publishing-packages-to-a-remote-or-local-server"></a>Publikování balíčků do vzdáleného nebo místního serveru  
...
### <a name="upgrading-published-packages"></a>Upgrade publikované balíčky  
