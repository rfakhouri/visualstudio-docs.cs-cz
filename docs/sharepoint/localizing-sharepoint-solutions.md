...
ms.locfileid: "35237767"
---
# <a name="localizing-sharepoint-solutions"></a>Lokalizace řešení služby SharePoint

Příprava aplikace tak, aby bylo možné po celém světě proces se označuje jako lokalizace. Lokalizace je překlad prostředků do konkrétní jazykové verze. Další informace najdete v tématu [Globalizing a lokalizace aplikací](../ide/globalizing-and-localizing-applications.md). Toto téma poskytuje přehled o tom, jak lokalizace řešení služby SharePoint.

O lokalizaci řešení, odeberte pevně řetězce z kódu a je abstraktní do zdrojových souborů. Soubor prostředků je [!INCLUDE[TLA2#tla_xml](../sharepoint/includes/tla2sharptla-xml-md.md)]– na základě soubor s příponou RESX. Soubor prostředků obsahuje přeložené verze řetězce použité v řešení. Další informace najdete v tématu [prostředky v aplikacích](http://go.microsoft.com/fwlink/?LinkID=155844).
...
## <a name="localizing-visual-studio-sharepoint-solutions"></a>Lokalizace řešení služby SharePoint v sadě Visual Studio
...
### <a name="localizing-features"></a>Lokalizace funkce
...
### <a name="localizing-aspx-page-markup"></a>Lokalizace značek ASPX stránky
...
```
 ...
 Další informace najdete v tématu [postupy: lokalizace značek ASPX](../sharepoint/how-to-localize-aspx-markup.md).
