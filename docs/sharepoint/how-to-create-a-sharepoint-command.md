...
## <a name="deploying-the-command"></a>Příkaz nasazení  
 K nasazení příkaz, zahrnují sestavení příkazu ve stejné [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)] balíček rozšíření (VSIX) s sestavení rozšíření, která pomocí příkazu. Musíte taky přidat položku pro příkaz sestavení v souboru extension.vsixmanifest. Další informace najdete v tématu [nasazení rozšíření pro nástroje služby SharePoint v sadě Visual Studio](../sharepoint/deploying-extensions-for-the-sharepoint-tools-in-visual-studio.md).  
