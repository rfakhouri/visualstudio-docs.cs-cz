...
1.  Otevřete web služby SharePoint pomocí webového prohlížeče, třeba http://*systémový název*/SitePages/Home.aspx.  
...
5.  Po vytvoření webu, přejděte v prohlížeči zpět na hlavní stránku http://*systémový název*/SitePages/Home.aspx.  
...
8.  Přejděte zpět na první podřízený http://*SystemName*/columntest1/default.aspx.  
...
4.  Na **zadejte web a úroveň zabezpečení pro ladění** stránky, zadejte [!INCLUDE[TLA2#tla_url](../sharepoint/includes/tla2sharptla-url-md.md)] pro druhý podřízeného webu služby SharePoint, který jste vytvořili dříve. Přidejte nová vlastní pole položek, http://*systémový název*/columntest2 tento podřízený web.  
