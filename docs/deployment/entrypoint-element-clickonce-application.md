...
| Atribut | Popis |
|--------------| - |
| `file` | Povinný parametr. Místní reference na sestavení po spuštění pro [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] aplikace. Tato hodnota nemůže obsahovat lomítko (/) nebo zpětné lomítko (\\) oddělovače cest. |
