---
title: 'Postupy: Změna jazyka publikování pro aplikaci ClickOnce | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
...
Při publikování [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] aplikace, uživatelské rozhraní zobrazí během instalace výchozí nastavení jazykové verze vývojového počítače. Při publikování lokalizovaných aplikace, musíte zadat jazykovou verzi odpovídající lokalizované verzi. To je dáno `Publish language` vlastnost pro váš projekt.  
  
 `Publish language` Vlastnost lze nastavit **možnosti publikování** dialogové okno, přístupný z **publikovat** stránky **Návrhář projektu**.  
...
5.  V **možnosti publikování** dialogové okno pole, vyberte jazyk a jazykovou verzi z **jazyka publikování** rozevíracího seznamu a pak klikněte na tlačítko **OK**.  
