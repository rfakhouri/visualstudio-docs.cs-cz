...
* Projekt ASP.NET, ASP.NET Core, .NET Core nebo Node.js. Pokud ještě nemáte projekt, vyberte níže uvedené možnosti:
  * ASP.NET: Postupujte podle [rychlý start: Vytvoření vaší první webové aplikace ASP.NET Core pomocí sady Visual Studio](../../ide/quickstart-aspnet-core.md), nebo použijte **souboru** > **nový projekt**vyberte **Visual C#**   >  **.NET core**a pak vyberte **webové aplikace ASP.NET Core**. Po zobrazení výzvy vyberte **webové aplikace (Model-View-Controller)** šablonu, ujistěte se, že **bez ověřování** je vybrané a pak vyberte **OK**.
