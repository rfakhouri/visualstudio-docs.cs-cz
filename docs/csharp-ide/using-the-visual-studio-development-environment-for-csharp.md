---
title: "Použití vývojového prostředí sady Visual Studio pro jazyk C# | Microsoft Docs"
ms.custom: 
ms.date: 02/17/2017
ms.reviewer: 
ms.suite: 
...
Integrované vývojové prostředí (IDE) sady Visual Studio je kolekce nástroje pro vývoj, které jsou k dispozici prostřednictvím společného uživatelského rozhraní. Některé tyto nástroje jsou sdíleny s jinými [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] jazyky a jiné, jako je například kompilátor jazyka C# jsou jedinečné pro Visual C#. Toto téma obsahuje odkazy na nejdůležitější nástroje jazyka Visual C#.  
...
|[Visual C# IntelliSense](../ide/visual-csharp-intellisense.md)|Obsahuje odkazy na témata, které popisují Visual C# – konkrétní funkce, jako je automatické generování a kódu technologie IntelliSense pro naposledy použité členy.|  
...
|[Generování kódu (C#)](../csharp-ide/code-generation-csharp.md)|Obsahuje seznam nástrojů pro generování kódu, které pro vás bude zapisovat části kódu.|  
...
|[Dotfuscator Community Edition (CE)](../ide/dotfuscator/index.md)|Vysvětluje, jak nastavit a začít používat bezplatnou preemptivní ochranu - Dotfuscatoru Community Edition k ochraně sestavení .NET z zpětnou a neoprávněnému použití (například neoprávněným ladění).|  
  
## <a name="see-also"></a>Viz také  
 [C#](/dotnet/csharp/csharp)   
 [Začínáme s C#](/dotnet/csharp/getting-started/getting-started-with-csharp)   
