...
ms.locfileid: "62997138"
---
# <a name="create-uml-modeling-projects-and-diagrams"></a>Vytváření projektů a diagramů pomocí modelování UML

Od verze Visual Studio 2017, návrhářů UML byly odebrány ze sady Visual Studio. Další informace najdete v tomto [blogový příspěvek](https://devblogs.microsoft.com/devops/uml-designers-have-been-removed-layer-designer-now-supports-live-architectural-analysis/).
