...
|Šíří změny prostředky, jako jsou jiné rozšíření sady Visual Studio mimo úložiště.|Zobrazit [obslužné rutiny události šířící změny mimo Model](../modeling/event-handlers-propagate-changes-outside-the-model.md).|
