...
## <a name="in-this-section"></a>V této části
 ...
 [Postupy: Změnit Namespace jazyka specifického pro doménu](../modeling/how-to-change-the-namespace-of-a-domain-specific-language.md) kód vygenerujete z DSL má obor názvů, které jste nastavili při inicializaci vašeho řešení, ale můžete ji později změnit.
