...
- K popisu architektury systému a byl kód zachován konzistentní s návrhem, vytváření diagramů závislostí a ověření kódu proti tyto diagramy.

- K popisu třídy, struktury, vytvoření diagramů tříd.

Tyto nástroje také umožňují snadněji komunikovat s lidmi, které jsou součástí vašeho projektu.
