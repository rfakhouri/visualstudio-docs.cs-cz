 ...
 **Vytvořte soubor klíče se silným názvem** výchozí možnost je vytvořit nový klíč k podepsání vašeho DSL sestavení.

 **Použít existující složitý název klíče** tuto možnost použijte, pokud chcete integrovat váš DSL jiné sestavení.
