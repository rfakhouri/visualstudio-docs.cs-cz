...
Pokud [váš server sestavení](http://msdn.microsoft.com/Library/788443c3-0547-452e-959c-4805573813a9) běží na počítači, na kterém [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] není nainstalovaná, zkopírujte následující soubory do počítače sestavení z vývojového počítače. Nahraďte nejnovější čísla verzí pro "*".
...
Visual Studio makra, například $ (SolutionDir), nefungují v nástroji MSBuild. Místo toho můžete použít vlastnosti projektu.
