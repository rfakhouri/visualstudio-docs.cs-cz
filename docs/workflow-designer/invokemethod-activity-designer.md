...
|<xref:System.Activities.Statements.InvokeMethod.MethodName%2A>|True|Název metody, která se má volat, když aktivita provede. Vyvolání metody musí být deklarována jako **veřejné**. Tuto vlastnost lze upravit na plochu návrháře. Toto je povinná vlastnost.|
...
|<xref:System.Activities.Statements.InvokeMethod.RunAsynchronously%2A>|True|Určuje, zda je volána metoda asynchronně. Výchozí hodnota je **False**.|
