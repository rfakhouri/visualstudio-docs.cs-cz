 ...
 **Přepínač < T\>**  Návrhář aktivity se používá k vytvoření a konfigurace <xref:System.Activities.Statements.Switch%601> aktivity v [!INCLUDE[wfd1](../workflow-designer/includes/wfd1_md.md)].  
