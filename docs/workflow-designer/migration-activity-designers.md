---
title: Návrháře aktivit migrace | Microsoft Docs
ms.date: 11/04/2016
ms.topic: reference
...
## <a name="in-this-section"></a>V tomto oddílu  
 [Zprostředkovatel komunikace s objekty](../workflow-designer/interop-activity-designer.md)  
 Slouží k vytvoření a konfigurace <xref:System.Activities.Statements.Interop> aktivity.  
