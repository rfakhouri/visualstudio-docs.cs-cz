...
- [Ručně identifikovat stávajícího prostředí Python](../python/managing-python-environments-in-visual-studio.md#manually-identify-an-existing-environment)