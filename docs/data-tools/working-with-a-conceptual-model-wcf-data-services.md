---
title: Práce s konceptuálního modelu (služby WCF Data Services) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
Pokud používáte konceptuální model k popisu dat v databázi, se můžete dotazovat data prostřednictvím vašich objektů místo nutnosti překladu přepínat mezi schéma databáze a objektový model.  
 ...
 Konceptuální modely můžete použít s aplikace služby WCF Data Services. Následující témata ukazují, jak dotazovat data prostřednictvím konceptuálního modelu.  
