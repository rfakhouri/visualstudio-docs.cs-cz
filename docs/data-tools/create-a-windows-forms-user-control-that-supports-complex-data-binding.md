...
4. Název projektu **ComplexControlWalkthrough**a potom zvolte **OK**. 
...
4.  Vyberte **ComplexDataGridView** ze seznamu **související ovládací prvky** v **možnosti přizpůsobení uživatelského rozhraní dat** dialogové okno.  
  
5.  Klikněte na šipku rozevíracího seznamu `Customers` tabulky a vyberte **ComplexDataGridView** ze seznamu ovládacího prvku.  
