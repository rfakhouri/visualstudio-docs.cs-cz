---
title: Přidávání kódu do datových sad v n vrstvé aplikace
ms.date: 11/04/2016
ms.topic: conceptual
dev_langs:
- VB
...
ms.locfileid: "65458480"
---
# <a name="add-code-to-datasets-in-n-tier-applications"></a>Přidávání kódu do datových sad v n vrstvé aplikace
