---
title: "Jeden nebo více objektů vybraných databázi vrátit schématu, která neodpovídá schématu cílové třídy | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Jeden nebo více objektů vybraných databáze vrátí schématu, která neodpovídá schématu cílové třídy. Nic se přidal do návrháře.  
 ...
 Při přetažení databázové objekty na existujících tříd entit, se musí shodovat s daty vrácenými objektem databáze schéma cílové třídy entity. Ověřte, že je vybraný objekt správné databázi a, třídy správné entita je cílem.  
