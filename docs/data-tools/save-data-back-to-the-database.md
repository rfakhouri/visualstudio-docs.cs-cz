...
## <a name="two-stage-updates"></a>Dvoufázová aktualizace  
 ...
 ![Visual Basic datovou sadu aktualizací](../data-tools/media/vbdatasetupdates.gif "vbDatasetUpdates")  
Aktualizace dvoustupňový proces a roli DataRowVersion v úspěšné aktualizaci  
