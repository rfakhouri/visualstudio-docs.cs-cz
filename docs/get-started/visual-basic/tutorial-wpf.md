...
1. V **nový projekt** dialogového okna, vyberte **nainstalováno** > **jazyka Visual Basic** > **Windows Desktop** kategorie a pak vyberte **aplikace WPF (.NET Framework)** šablony. Pojmenujte projekt **HelloWPFApp**.
