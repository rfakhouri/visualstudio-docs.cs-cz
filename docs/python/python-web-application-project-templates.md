---
title: "Webové aplikace šablony pro jazyk Python v sadě Visual Studio | Microsoft Docs"
...
Microsoft Azure Cloud Services *nemá* podporu `requirements.txt` souboru. [Azure cloud service projekty](python-azure-cloud-service-project-template.md) podrobnosti.
