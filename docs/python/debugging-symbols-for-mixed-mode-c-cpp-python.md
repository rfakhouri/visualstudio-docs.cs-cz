---
title: Symboly pro ladění ve smíšeném režimu Python/C++ | Microsoft Docs
description: Jak Visual Studio poskytuje schopnost načíst symboly pro dokončení C++ ve smíšeném režimu a Python ladění.
ms.custom: ''
ms.date: 07/12/2017
ms.reviewer: ''
ms.suite: ''
