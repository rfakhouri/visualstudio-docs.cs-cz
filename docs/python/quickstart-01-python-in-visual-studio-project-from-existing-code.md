---
title: Rychlý start - vytvořit projekt Python z existujícího kódu
description: Tento rychlý start vytvoříte projekt sady Visual Studio pro jazyk Python ze složky, pomocí vhodného šablony.
ms.date: 05/07/2018
