---
title: Rychlý start – vytvoření projektu Pythonu z existujícího kódu
description: V tomto rychlém startu vytvoříte projekt sady Visual Studio pro jazyk Python z existující složky, pomocí vhodné šablony.
ms.date: 12/06/2018
