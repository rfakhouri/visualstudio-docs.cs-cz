...
Formát, ve kterém je zobrazená hodnota v lze změnit **sledovat** okno použití specifikátorů formátu.  
 ...
 Můžete také použít specifikátory formátu v **Immediate** okně **příkaz** okno a to i v systému windows zdroje. Pokud přesunutí ukazatele myši na výrazu v těchto windows, zobrazí se v datového tipu výsledek. Popis dat zobrazení odráží specifikátor formátu.  
...
|**Ná**|Potlačí adresa paměti ukazatele na objekt.|\<umístění >, {člen = hodnota...}|{{člen = hodnota...}|  
...
|RC|Příznak okno – třída|0x0010|WC_DEFAULTCHAR|  
