...
#### <a name="parameters"></a>Parametry  
 ppenum  
 [out] Vrátí [idiaenumsegments –](../../debugger/debug-interface-access/idiaenumsegments.md) objekt, který obsahuje duplicitní enumerátor. Se neduplikují segmentů, pouze enumerátor.  
