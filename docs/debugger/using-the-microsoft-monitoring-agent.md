...
1.  Ujistěte se, že:  
    ...
    -   Webový server je spuštěn [podporované verze Internetové informační služby (IIS)](http://technet.microsoft.com/en-us/library/dn465154.aspx).  
