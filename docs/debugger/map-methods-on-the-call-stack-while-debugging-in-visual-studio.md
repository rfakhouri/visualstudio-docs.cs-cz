...
##  <a name="AddRelatedCode"></a> Přidání souvisejících kódu do mapy
 Nyní máte k dispozici mapu - co dále? Pokud pracujete s Visual C# nebo Visual Basic, přidejte položky, jako je například pole, vlastnosti a jiných metod pro sledování, co se děje v kódu.
...
## <a name="see-also"></a>Viz také
 [Mapování závislostí napříč vaším řešením](../modeling/map-dependencies-across-your-solutions.md) [mapuje použití kódu k ladění aplikací](../modeling/use-code-maps-to-debug-your-applications.md) [najít potenciálních problémů pomocí kódu mapování analyzátorů](../modeling/find-potential-problems-using-code-map-analyzers.md) [Procházet a uspořádání map kódu](../modeling/browse-and-rearrange-code-maps.md)