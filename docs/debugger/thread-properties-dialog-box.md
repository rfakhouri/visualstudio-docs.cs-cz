---
title: Dialogové okno vlastností vláken | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
 ...
 **Obecné** karta je kartě jenom zobrazit. V operačních systémech Windows 98 a systém Windows 95 se zobrazí upravenou verzi na této kartě.  
  
## <a name="in-this-section"></a>V tomto oddílu  
 [Karta Obecné, dialogové okno Vlastnosti přístup z více vláken](../debugger/general-tab-thread-properties-dialog-box.md)  
 Další informace o vybrané vlákno pomocí tohoto dialogového okna.  
