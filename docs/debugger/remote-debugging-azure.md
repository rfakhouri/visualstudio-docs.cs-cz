...
Tato příručka vysvětluje, jak nastavit a konfigurace aplikace Visual Studio ASP.NET Core, nasaďte ji do služby IIS pomocí Azure a připojení vzdáleného ladicího programu ze sady Visual Studio.
...
1. Vytvoření nové aplikace ASP.NET Core.
