---
title: Zobrazení snímků pomocí zpětného kroku IntelliTrace
...
ms.locfileid: "46495752"
---
# <a name="view-snapshots-using-intellitrace-step-back-in-visual-studio"></a>Zobrazení snímků pomocí zpětného kroku IntelliTrace v sadě Visual Studio
