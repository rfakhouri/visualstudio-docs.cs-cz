---
title: 'Kurz: Ladění nativního a spravovaného kódu | Microsoft Docs'
description: Zjistěte, jak ladit nativní knihovny DLL z aplikací .NET Core nebo rozhraní .NET Framework
ms.custom: ''
ms.date: 04/27/2018
