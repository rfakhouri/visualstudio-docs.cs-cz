        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Techniky ladění a související nástroje</h3>
                    </div>
                </div>
            </div>
        </div>
...
<h2>Začínáme s ladicím programem</h2>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Ladění aplikací v jazyce Visual Basic</h3>
                    </div>
                </div>
            </div>
        </div>
...
<h2>Seznamte se blíž s ladicím programem</h2>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Další informace o zarážkách</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Přístup k rozhraní ladění SDK</h3>
                    </div>
                </div>
            </div>
        </div>
