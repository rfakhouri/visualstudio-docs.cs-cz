...
2. Klikněte na tlačítko **F11** několikrát, dokud se nezobrazí pozastavení v ladicím programu `Circle.Draw` metody v editoru kódu. Podívejte se na **zásobník volání** okna.
