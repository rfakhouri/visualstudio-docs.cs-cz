...
## <a name="members"></a>Členové
 SCC_MSG_RTN_CANCEL vrátit ze zpětného volání k označení zrušit.

 SCC_MSG_RTN_OK vrátit ze zpětného volání, abyste mohli pokračovat.

 SCC_MSG_INFO zpráva je informační.

 Zpráva SCC_MSG_WARNING je upozornění.

 Zpráva SCC_MSG_ERROR se o chybu.

 Zpráva SCC_MSG_STATUS je určená pro stavový řádek.

 Ne SCC_MSG_DOCANCEL textu. Vrátí IDE `SCC_MSG_RTN_OK` nebo `SCC_MSG_RTN_CANCEL`.

 SCC_MSG_STARTCANCEL spustí a zrušení smyčky.

 SCC_MSG_STOPCANCEL ukončí smyčku Storno.
