...
## <a name="in-this-section"></a>V tomto oddílu
 [Upozornění portu](../../extensibility/debugger/notifying-the-port.md) vysvětluje, co se stane po spuštění programu a port, který obdrží oznámení.

 [Připojení po spuštění](../../extensibility/debugger/attaching-after-a-launch.md) dokumentů při relaci ladění je připraven k DE připojit k programu.
