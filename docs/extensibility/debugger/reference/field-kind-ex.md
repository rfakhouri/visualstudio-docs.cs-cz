...
Pole FIELD_KIND_EX_NONE neobsahuje rozšířeného typu.

FIELD_TYPE_EX_METHODVAR pole obsahuje proměnnou metody.

FIELD_TYPE_EX_CLASSVAR pole obsahuje proměnné třídy.
