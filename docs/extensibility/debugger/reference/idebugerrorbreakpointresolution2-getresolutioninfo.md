...
ms.locfileid: "31112347"
---
# <a name="idebugerrorbreakpointresolution2getresolutioninfo"></a>IDebugErrorBreakpointResolution2::GetResolutionInfo
Získá informace o chybě rozlišení zarážek.  
...
#### <a name="parameters"></a>Parametry  
 `dwFields`  
 [v] Kombinace příznaků z [BPERESI_FIELDS](../../../extensibility/debugger/reference/bperesi-fields.md) výčet, který určit, které pole `pErrorResolutionInfo` mají doplnit.  
  
 `pErrorResolutionInfo`  
 [ve out] [BP_ERROR_RESOLUTION_INFO](../../../extensibility/debugger/reference/bp-error-resolution-info.md) struktura, která obsahuje popis zarážek řešení.  
  
## <a name="return-value"></a>Návratová hodnota  
 V případě úspěchu vrátí `S_OK`, jinak vrátí kód chyby.  
  
## <a name="example"></a>Příklad  
 Následující příklad implementuje tuto metodu pro jednoduchou `CDebugErrorBreakpointResolution` objekt, který zveřejňuje [IDebugErrorBreakpointResolution2](../../../extensibility/debugger/reference/idebugerrorbreakpointresolution2.md) rozhraní.  
