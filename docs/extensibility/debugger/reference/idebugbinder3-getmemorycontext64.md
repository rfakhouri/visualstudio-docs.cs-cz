...
Převede na objekt umístění nebo adresu paměti 64-bit paměti kontextu.  
...
#### <a name="parameters"></a>Parametry  
 `pField`  
 [v] [IDebugField](../../../extensibility/debugger/reference/idebugfield.md) , který popisuje objekt, který chcete najít. Pokud `NULL`, pak použít `dwConstant` místo.  
  
 `uConstant`  
 [v] Adresa paměti 64-bit, jako je například 0x50000000.  
