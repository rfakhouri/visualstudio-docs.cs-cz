...
Načte adresu v rámci funkci, která představuje posun daném řádku.  
...
#### <a name="parameters"></a>Parametry  
 `pAddress`  
 [v] Adresa, která představuje funkce.  
  
 `dwLine`  
 [v] Posun od začátku funkce řádku.  
  
 `ppNewAddress`  
 [out] Novou adresu, která představuje řádku posun od začátku funkce.  
