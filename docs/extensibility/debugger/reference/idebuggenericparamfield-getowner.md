...
Načte typ nebo metoda vlastník této obecný parametr.  
...
#### <a name="parameters"></a>Parametry  
 `ppOwner`  
 [out] Vrátí [IDebugField](../../../extensibility/debugger/reference/idebugfield.md) objektu, který vlastní tento obecný parametr.  
