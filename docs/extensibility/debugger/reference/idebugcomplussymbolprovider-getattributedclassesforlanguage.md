...
Načte tříd pomocí zadaného atributu, které jsou implementované v zadané programovací jazyk.  
...
#### <a name="parameters"></a>Parametry  
 `guidLanguage`  
 [v] Jedinečný identifikátor pro jazyk.  
  
 `pstrAttribute`  
 [v] Řetězec atributu.  
  
 `ppEnum`  
 [out] Vrátí výčet třídy atributů.  
