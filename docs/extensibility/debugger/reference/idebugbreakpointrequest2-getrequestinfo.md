...
ms.locfileid: "31105811"
---
# <a name="idebugbreakpointrequest2getrequestinfo"></a>IDebugBreakpointRequest2::GetRequestInfo
Získá informace o požadavku zarážek, která popisuje tuto žádost zarážek.  
...
#### <a name="parameters"></a>Parametry  
 `dwFields`  
 [v] Kombinace příznaků z [BPREQI_FIELDS](../../../extensibility/debugger/reference/bpreqi-fields.md) výčet, který určuje, která pole v `pBPRequestInfo` parametr mají doplnit.  
  
 `pBPRequestInfo`  
 [out] Určuje, [BP_REQUEST_INFO](../../../extensibility/debugger/reference/bp-request-info.md) struktury pro vyplnění popis zarážek požadavku.  
