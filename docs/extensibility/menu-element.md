...
|Řetězce|Povinný parametr. Zobrazit [Strings – element](../extensibility/strings-element.md). Podřízené `ButtonText` element musí být definován.|
