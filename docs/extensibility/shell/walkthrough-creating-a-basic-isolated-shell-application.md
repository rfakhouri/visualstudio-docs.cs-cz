...
## <a name="prerequisites"></a>Požadavky  
 Chcete-li provést tento postup, je nutné nainstalovat sadu Visual Studio SDK. Další informace najdete v tématu [Visual Studio SDK](../visual-studio-sdk.md). Pokud chcete nasadit izolované prostředí, musíte taky použít redistribuovatelného balíčku Visual Studio Shell (Izolovaná).  
...
> [!NOTE]
>  Funkce identifikátory GUID Visual Studio, najdete v tématu [identifikátory GUID nástroje Visual Studio funkce balíčků](package-guids-of-visual-studio-features.md).  
