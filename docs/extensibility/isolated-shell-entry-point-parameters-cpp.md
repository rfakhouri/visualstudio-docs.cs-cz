...
Při spuštění aplikace z Visual Studia založený na prostředí, zavolá vstupní bod spuštění z prostředí sady Visual Studio. Následující nastavení může být přepsána ve volání vstupní bod spuštění prostředí. Popis jednotlivých nastaveních najdete v tématu [. Soubory Pkgdef](../extensibility/modifying-the-isolated-shell-by-using-the-dot-pkgdef-file.md).  
