...
![Visual Studio víceúrovňové projectflavor grafika](../../extensibility/internals/media/vs_multilevelprojectflavor.gif)
...
![Obrázek zařízení Extender automaticky Flavor projektu VS](../../extensibility/internals/media/vs_projectflavorautoextender.gif)
