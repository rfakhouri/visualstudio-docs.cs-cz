...
### [Registrace služby starší verze jazyka2](registering-a-legacy-language-service2.md)
...
### [Architektura balíčku VSPackage správy zdrojového kódu](source-control-vspackage-architecture.md)
