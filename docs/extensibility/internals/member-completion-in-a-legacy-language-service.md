...
ms.locfileid: "31134029"
---
# <a name="member-completion-in-a-legacy-language-service"></a>Dokončení člen ve službě jazyk starší verze
...
-   <xref:Microsoft.VisualStudio.Package.IScanner> Skener zjistí znak dokončení člen a nastaví tokenu aktivační událost s <xref:Microsoft.VisualStudio.Package.TokenTriggers> pro tento znak.  
...
### <a name="the-token-trigger"></a>Token aktivační události  
 <xref:Microsoft.VisualStudio.Package.TokenTriggers> Aktivační událost zahájí volání <xref:Microsoft.VisualStudio.Package.Source.Completion%2A> metodu <xref:Microsoft.VisualStudio.Package.Source> – třída a <xref:Microsoft.VisualStudio.Package.Source.Completion%2A> analyzátor pomocí důvodu analýzy pak volá metodu, <xref:Microsoft.VisualStudio.Package.ParseReason> (pokud token aktivační událost také obsaženy <xref:Microsoft.VisualStudio.Package.TokenTriggers> příznak, z důvodu analýzy je <xref:Microsoft.VisualStudio.Package.ParseReason> který spojuje výběr členů a zvýraznění závorek).  
...
## <a name="enabling-support-for-member-completion"></a>Povolení podpory pro dokončení člena  
 ...
 Pokud skener vrátí tokenu aktivační událost <xref:Microsoft.VisualStudio.Package.TokenTriggers>a analyzátor jazyka vrátí seznam hodnot deklarace a pak se zobrazí seznam dokončení členů.  
  
## <a name="supporting-member-completion-in-the-scanner"></a>Podpora dokončení člen v skeneru  
 Skeneru musí být schopen zjistit znak dokončení člen a nastavte tokenu aktivační událost <xref:Microsoft.VisualStudio.Package.TokenTriggers> při analýze tento znak.  
...
## <a name="supporting-member-completion-in-the-parser"></a>Podpora člen dokončení analyzátoru  
