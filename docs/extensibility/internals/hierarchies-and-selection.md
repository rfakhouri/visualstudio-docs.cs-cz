...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Popisuje, jak funkce dostupné v [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] je založena na aktuálním kontextu výběr a celkové IDE kontextu uživatele.  
