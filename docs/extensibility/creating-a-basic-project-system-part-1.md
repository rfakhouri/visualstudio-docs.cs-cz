...
2.  Kopírování *AssemblyInfo.cs* soubor *vlastnosti* složku *Projects\SimpleProject* složky.  
...
6.  V **vlastnosti** okno, nastaveno **akce sestavení** z *AssemblyInfo.cs*, *Program.cs*, *SimpleProject.ico* , a *SimpleProject.myproj* k **obsahu**a nastavte jejich **zahrnout do VSIX** vlastností **True**.  
...
5.  Přidat atribut GUID k `SimpleProjectFactory` třídy. Hodnota atributu je nový objekt factory projektu GUID.  
