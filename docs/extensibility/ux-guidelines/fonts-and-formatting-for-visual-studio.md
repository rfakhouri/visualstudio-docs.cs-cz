...
> [!NOTE]
> Než použijete schéma formátování, ujistěte se, jsou následující pokyny v [styl textu](../../extensibility/ux-guidelines/fonts-and-formatting-for-visual-studio.md#BKMK_TextStyle). **
...
**Použití:** (vzácného) jedinečné obchodní značku uživatelského rozhraní
 ...
 **Zobrazí se jako:** 28 pt Segoe UI Light **použít pro:** názvy velkých podpis dialogového okna, hlavní části sestavy
 ...
 **Zobrazí se jako:** 18 bodů Segoe UI Semilight **použít pro:** podnadpisů, názvy v dialogových oknech malé a střední
 ...
 **Zobrazí se jako:** 14 bodů Segoe UI **použít pro:** nadpisy oddílů v dokumentu a uživatelského rozhraní nebo sestavy
 ...
 **Zobrazí se jako:** 12 bodů Segoe UI **použít pro:** menší podpoložek v signatuře dialogových oken a dokumentů a uživatelského rozhraní
 ...
 **Zobrazí se jako:** 11 bodů Segoe UI **použít pro:** části záhlaví v dialogových oknech podpis, top uzly ve stromovém zobrazení, svislého tabulátoru navigace
 ...
 **Zobrazí se jako:** tučné 9 pt Segoe UI **použít pro:** popisky a podnadpisy v dialogových oknech podpis, sestavy a dokumentu a uživatelského rozhraní
...
|||
|-|-|
|**Použití:**<br /><br /> -Větší záhlaví v dialogových oknech podpis<br />– Nadpis hlavní sestava<br /><br /> **Proveďte:**<br /><br /> -Používejte velká písmena<br />-Vždy používejte lehký<br /><br /> **Ne:**<br /><br /> – Použijte pro uživatelské rozhraní než podpis uživatelského rozhraní<br />-Tučného písma, kurzívy nebo tučné, kurzíva<br />-Použití textu<br />– Použijte v oknech nástrojů|**Zobrazí se jako:** 28 pt Segoe UI Light<br /><br /> **Vizuální příklad:**<br /><br /> ![Příklad písmo prostředí 310 % &#43; světla záhlaví](../../extensibility/ux-guidelines/media/0202-a_ef310.png "0202 a_EF310")|
