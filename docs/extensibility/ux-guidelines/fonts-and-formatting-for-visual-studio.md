 ...
 **Zobrazí se jako:** 34 pt Segoe UI Light **použít pro:** (vzácného) jedinečné značky uživatelského rozhraní, jako je třeba v aplikaci Visual Studio 2017 úvodní stránky
