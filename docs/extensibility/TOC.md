...
#[Otevření složky](open-folder.md)
##[Pracovní prostory](workspaces.md)
##[Kontexty souborů](workspace-file-contexts.md)
##[Indexování](workspace-indexing.md)
##[Jazykové služby](workspace-language-services.md)
##[Sestavení](workspace-build.md)
