...
## <a name="language-services-and-the-core-editor"></a>Jazykové služby a základní editor
 ...
 ![Obrázek modelu služby jazyka](../extensibility/media/vslanguageservicemodel.gif "vsLanguageServiceModel") základní jazyk a editor objektů služby
