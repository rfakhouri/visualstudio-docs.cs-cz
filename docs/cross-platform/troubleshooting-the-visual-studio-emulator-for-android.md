---
title: Řešení potíží s Visual Studio Emulator for Android | Dokumentace Microsoftu
ms.custom: ''
ms.date: 11/04/2016
...
-   Ve Správci technologie Hyper-V otevřete Správce virtuálních přepínačů a zkontrolujte, zda máte dvě síťové přepínače; Ověřte, že první z nich je interní přepínač a druhý je externí.  
     ...
     Pokud je nastavení správné a používáte Windows 10, je pokusit [přeinstalovat síťová zařízení pomocí příkazu -d netcfg](http://windows.microsoft.com/en-us/windows-10/fix-network-connection-issues) (část 6).  
...
-   Odebrat nebo zakázat ovladačů jiných výrobců nebo software, který může být zasahovala do virtuální sítě.  
    ...
    2.  Pro adaptér vEthernet (interní Port Windows Phone Emulator interní přepínač Ethernet) vyberte **vlastnosti** v místní nabídce.  
         ...
         ![Virtuální adaptér používá Hyper&#45;V](../cross-platform/media/android_emu_virtual_adapter.png "Android_Emu_Virtual_Adapter")  
