...
ms.locfileid: "39251618"
---
# <a name="cross-platform-mobile-development-examples"></a>Příklady vývoj mobilních řešení napříč platformami
...
-   [Ukázka knihovny pro Android libstdcpp testu](https://code.msdn.microsoft.com/test-libstdcpp-Android-00b548f5)  
 ...
 Chcete-li sestavit ukázku, stiskněte **F7**, nebo na panelu nabídek zvolte položky **sestavení**, **sestavit řešení**.