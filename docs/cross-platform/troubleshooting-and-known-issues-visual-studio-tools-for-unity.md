...
Zkontrolujte, že skript, který používáte správně načíst nebo použít aktuální scény Unity. Ukončení sady Visual Studio a Unity potom odstraňte všechny vygenerované soubory (*.csproj, *.sln) a na celou složku knihovny.
