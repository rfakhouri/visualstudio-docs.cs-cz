 ...
 **Zadejte umístění pro publikování této aplikace**  
 Povinný parametr. Umístění pro publikování je adresář, ve kterém **Průvodce publikováním** zkopíruje soubory řešení, jako je například manifesty, sestavení, dočasný certifikát a dalších souborů ze sestavení. Musíte mít přístup pro zápis do tohoto adresáře.  
