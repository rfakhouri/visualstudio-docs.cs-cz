---
title: "Práce s položkami pošty | Microsoft Docs"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="working-with-mail-items"></a>Práce s položkami pošty
  <xref:Microsoft.Office.Interop.Outlook.MailItem> Třída obsahuje metody a vlastnosti, které můžete používat k provádění úloh s e-mailových zpráv.  
  
|Úloha|Postup|  
|----------|---------------|  
|Vytvořte e-mailové zprávy.|[Postupy: vytváření položek e-mailu prostřednictvím kódu programu](../vsto/how-to-programmatically-create-an-e-mail-item.md)|  
...
|Reakce na nové e-mailové zprávy pomocí vlastní akce.|[Postupy: prostřednictvím kódu programu provádění akcí po přijetí e-mailové zprávy](../vsto/how-to-programmatically-perform-actions-when-an-e-mail-message-is-received.md)|  
...
|Přidání příloh|[Postupy: programové připojení souborů k položkám e-mailu aplikace Outlook](../vsto/how-to-programmatically-attach-files-to-outlook-e-mail-items.md)|  
