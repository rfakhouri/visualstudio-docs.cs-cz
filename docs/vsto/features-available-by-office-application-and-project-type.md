...
|Doplňků VSTO|Excel<br /><br /> InfoPath (InfoPath 2013 a InfoPath 2010 pouze)<br /><br /> Outlook<br /><br /> PowerPoint<br /><br /> Project<br /><br /> Visio<br /><br /> Word<br /><br /> Excel|  
...
|Vystavení objektu v doplňku VSTO pro jiné řešení pro Microsoft Office.|Add-in projekty VSTO.|[Volání kódu v doplňcích VSTO z jiných řešení pro systém Office](../vsto/calling-code-in-vsto-add-ins-from-other-office-solutions.md)|  
