---
title: "Návod: Změna mezipaměti Data v sešitu na serveru | Microsoft Docs"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="walkthrough-changing-cached-data-in-a-workbook-on-a-server"></a>Návod: Změna dat uložených v mezipaměti sešitu na serveru
...
## <a name="changing-data-in-the-cached-dataset-by-using-the-console-application"></a>Změna dat v datové sady v mezipaměti pomocí konzolové aplikace  
...
10. V **Průzkumníku řešení**, klikněte pravým tlačítkem myši **DataWriter** projektu, přejděte na **ladění**a potom klikněte na **spustit novou instanci**.  
     ...
     Konzolové aplikace zobrazí zprávy při čtení datové sady v mezipaměti do místní datové sady, upraví ceny produktů v místní datové sady a uloží nové hodnoty do datové sady v mezipaměti. Stisknutím klávesy ENTER zavřete aplikaci.  
