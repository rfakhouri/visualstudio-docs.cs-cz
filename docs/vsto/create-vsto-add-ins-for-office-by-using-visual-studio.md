...
-   [Vývoj pro Office s portál pro vývojáře sady Visual Studio](http://go.microsoft.com/fwlink/?LinkId=123844) obsahuje odkazy na informace o produktu, ukázky kódu, videa a komunitní zdroje o přizpůsobení aplikace Office jako součást řešení pomocí sady Visual Studio .  
...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Poskytuje informace o tom, jak automatizovat aplikaci Microsoft Office project a vytvoření projektu doplňků VSTO.  
 ...
 Obsahuje odkazy na podrobné informace o primární spolupracující sestavení Office, manifesty, prvky uživatelského rozhraní a chybové zprávy.  
  
 [Řízené reference &#40;vývoj pro Office v sadě Visual Studio&#41;](../vsto/managed-reference-office-development-in-visual-studio.md)  
 Poskytuje odkazy na informace o rozhraní API obory názvů a typy, které se používají v Office projektů cílených [!INCLUDE[net_v40_short](../sharepoint/includes/net-v40-short-md.md)]. Referenční dokumentace rozhraní API o obory názvů a typy, které se používají v projektech Office cílených na rozhraní .NET Framework 3.5, najdete v následující části odkaz v dokumentaci k sadě Visual Studio 2008: [2007 – systém managed–referenčníinformace](http://go.microsoft.com/fwlink/?LinkId=160658).  
...
## <a name="related-sections"></a>Související oddíly  
 ...
 Poskytuje informace o obchodních aplikací Office (OBAs) a jak sestavit je pomocí platforma systému Office.  
 ...
 Obsahuje odkazy na témata, které vysvětlují, jak můžete pomocí sady Visual Studio pro návrh, vývoj, ladění a nasazení webových aplikací, webové služby XML a tradiční klientské aplikace.  
  
 [Rozhraní .NET framework programování v sadě Visual Studio](http://msdn.microsoft.com/en-us/f3f63195-82c6-48e8-a4a0-612810e7d093)  
