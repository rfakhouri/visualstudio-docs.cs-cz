...
## <a name="creating-a-new-word-document-project"></a>Vytvoření nového projektu dokumentu aplikace Word  
...
## <a name="creating-the-xml-data-file"></a>Vytvoření datového souboru XML  
...
## <a name="creating-an-xml-schema"></a>Vytvoření schématu XML  
...
## <a name="attaching-the-xml-schema-to-the-document"></a>Schéma XML se připojuje k dokumentu  
...
## <a name="adding-a-custom-xml-part-to-the-document"></a>Přidání součástí vlastní kód XML do dokumentů  
...
## <a name="binding-the-content-controls-to-elements-in-the-custom-xml-part"></a>Vytvoření vazby ovládacích prvků obsahu na elementů v rámci vlastní kód XML  
...
## <a name="running-your-code-when-the-document-is-opened"></a>Spuštění si kód při dokumentu je otevřen.  
...
9. Název souboru **EmployeeControls.docx.zip**.  
     ...
     **EmployeeControls.docx** uložení ve formátu Open XML. Přejmenováním tento dokument s příponou názvu souboru .zip, můžete zkontrolovat obsah dokumentu. Další informace o Open XML, najdete v článku na technické [představení (2007) formáty Office Open XML soubor](http://msdn.microsoft.com/en-us/96018532-f62c-4da7-bbff-16b96a483fbf).  
...
-   Všechny dostupné ovládací prvky obsahu použijte k vytvoření šablony. Další informace najdete v tématu [návod: vytváření šablony pomocí pomocí ovládacích prvků obsahu](../vsto/walkthrough-creating-a-template-by-using-content-controls.md).  
...
-   Použití ovládacích prvků obsahu s ochrana částí dokumentu. Další informace najdete v tématu [postupy: ochrana částí z dokumentů pomocí ovládacích prvků obsahu](../vsto/how-to-protect-parts-of-documents-by-using-content-controls.md).  
