---
title: 'Postupy: Přidávání položky ke kontaktům aplikace Outlook prostřednictvím kódu programu'
ms.date: 02/02/2017
ms.topic: conceptual
dev_langs:
- VB
...
ms.locfileid: "62967706"
---
# <a name="how-to-programmatically-add-an-entry-to-outlook-contacts"></a>Postupy: Přidávání položky ke kontaktům aplikace Outlook prostřednictvím kódu programu
  Tento příklad vytvoří nový kontakt a zadá data do nového kontaktu.
