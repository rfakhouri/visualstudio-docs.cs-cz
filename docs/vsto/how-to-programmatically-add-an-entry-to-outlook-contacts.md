---
title: "Postupy: přidávání ke kontaktům aplikace Outlook prostřednictvím kódu programu položku | Microsoft Docs"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="how-to-programmatically-add-an-entry-to-outlook-contacts"></a>Postupy: Přidání položky ke kontaktům aplikace Outlook prostřednictvím kódu programu
