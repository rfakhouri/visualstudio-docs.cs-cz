...
## <a name="document-level-walkthroughs"></a>Návody na úrovni dokumentu  
 ...
 Ukazuje, jak vytvořit základní přizpůsobení úrovni dokumentu pro aplikaci Word.  
  
 [Návod: Vkládání textu do dokumentu z podokna akcí](../vsto/walkthrough-inserting-text-into-a-document-from-an-actions-pane.md)  
 Ukazuje, jak přidat text do dokumentu aplikace Word, když uživatelé zadají text v ovládacích prvcích v podokně Akce.  
 ...
 Demonstruje postup vytvoření vazby dat k ovládacím prvkům v podokně Akce. Ovládací prvky ukazují záznamů master/detail relace mezi tabulkami v databázi serveru SQL Server.  
 ...
 Ukazuje, jak pomocí zaškrtávacích políček v dokumentu aplikace Word můžete změnit formátování.  
 ...
 Ukazuje, jak vytvořit místní nabídky, který slouží k formátování textu v záložce.  
 ...
 Ukazuje, jak volat kód do vlastního nastavení sestavení z kód VBA v dokumentu.  
 ...
 Ukazuje, jak pomocí ovládacích prvků obsahu k vytvoření obsahu strukturovaných a opakovaně použitelné šablony aplikace Word.  
...
## <a name="application-level-walkthroughs"></a>Návody na úrovni aplikace  
 ...
 Ukazuje, jak vytvořit základní Add-in VSTO pro Word.  
 ...
 Ukazuje, jak vytvořit vlastní pásu karet pomocí XML popisovač souboru v doplňku VSTO.  
