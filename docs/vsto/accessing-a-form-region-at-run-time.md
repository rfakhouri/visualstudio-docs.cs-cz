...
### <a name="imported-form-regions"></a>Oblasti formuláře importované  
 ...
 Další informace o tom, jak vytvořit vlastnosti v jazyce C# najdete v tématu [postupy: deklarování a použití číst zapsat vlastnosti &#40; C &#35; Průvodce programováním &#41; ](/dotnet/csharp/programming-guide/classes-and-structs/how-to-declare-and-use-read-write-properties).  
