---
title: 'Postupy: Správa rozložení ovládacích prvků v podoknech akcí | Microsoft Docs'
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
> [!NOTE]  
>  Když uživatel změní za běhu v podokně Akce, můžete nastavit ovládací prvky ke změně velikosti se v podokně Akce. Můžete použít <xref:System.Windows.Forms.Control.Anchor%2A> vlastností ovládacího prvku Windows Forms do ovládacích prvků ukotvení do podokna akce. Další informace najdete v tématu [postupy: ukotvení ovládacích prvků Windows Forms](/dotnet/framework/winforms/controls/how-to-anchor-controls-on-windows-forms).  
