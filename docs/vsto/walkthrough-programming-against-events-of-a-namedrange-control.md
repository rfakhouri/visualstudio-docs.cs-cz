...
1.  Vytvoření projektu sešitu aplikace Excel s názvem **Moje rozsah událostí s názvem**. Ujistěte se, že **vytvoříte nový textový dokument** je vybrána. Další informace najdete v tématu [postupy: vytvoření Office projekty v sadě Visual Studio](../vsto/how-to-create-office-projects-in-visual-studio.md).  
...
## <a name="add-text-and-named-ranges-to-the-worksheet"></a>Přidat text a pojmenované oblasti na listu  
...
## <a name="add-code-to-respond-to-the-beforedoubleclick-event"></a>Přidejte kód reagovat na událost BeforeDoubleClick  
...
## <a name="add-code-to-respond-to-the-change-event"></a>Přidejte kód reagovat na událost změny  
...
## <a name="add-code-to-respond-to-the-selectionchange-event"></a>Přidejte kód reagovat na SelectionChange – událost  
