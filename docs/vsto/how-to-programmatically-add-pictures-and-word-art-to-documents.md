...
## <a name="adding-a-picture-at-design-time"></a>Přidání obrázku v době návrhu  
...
## <a name="adding-a-picture-at-run-time"></a>Přidání obrázku za běhu  
...
## <a name="adding-wordart-at-design-time"></a>Přidání WordArt v době návrhu  
...
## <a name="adding-wordart-at-run-time"></a>Přidání WordArt za běhu  
