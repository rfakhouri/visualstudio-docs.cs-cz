 ...
 **Platí pro:** informace v tomto tématu se vztahují na projekty na úrovni dokumentu a projekty doplňku VSTO pro Excel, PowerPoint a Word. Další informace najdete v tématu [dostupné funkce podle aplikace a projekt typu Office](../vsto/features-available-by-office-application-and-project-type.md).  
  
> [!NOTE]  
>  Visual Studio můžete také do mezipaměti datové objekty v přizpůsobeních na úrovni dokumentu. Tato funkce se liší od vlastní části XML, i když jsou některé podobnosti. Další informace najdete v tématu [mezipaměti data v přizpůsobeních na úrovni dokumentu](../vsto/cached-data-in-document-level-customizations.md).  
  
## <a name="understand-custom-xml-parts"></a>Pochopení vlastní části XML  
 ...
 Soubor XML formáty povolení aplikace pro práci s dokumenty způsoby, které nejsou možné ve starších formátech binárního souboru (například *.xls*, *PPT*, a *.doc*). Všechny aplikace, který může číst archivy ZIP můžete zkontrolovat a změnit obsah dokumentů, i když není nainstalována aplikace Microsoft Office.  
...
-   [Vytvářet dokumenty Wordu 2007 pomocí formáty Open XML](http://msdn.microsoft.com/en-us/59a46f4e-5a5a-4dac-86e5-7dfd43330766)  
...
### <a name="modify-xml-parts-while-the-office-application-is-running"></a>Úprava částí XML je spuštěna aplikace Office  
...
## <a name="bind-custom-xml-parts-to-word-content-controls"></a>Vlastní části XML vazby na ovládací prvky obsahu aplikace Word  
