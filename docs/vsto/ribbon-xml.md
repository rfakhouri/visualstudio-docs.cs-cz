...
## <a name="add-a-ribbon-xml-item-to-a-project"></a>Přidání položek pásu karet (XML) do projektu  
...
-   Soubor kódu pásu karet. Tento soubor obsahuje *pásu karet třída*. Tato třída má název, který jste zadali pro **pásu karet (XML)** položky v **přidat novou položku** dialogové okno. Aplikace Microsoft Office pomocí instance této třídy načíst vlastní pás karet. Podrobnosti najdete v tématu [pásu karet referenci třídy](#RibbonExtensionClass) dál v tomto tématu.  
  
 Ve výchozím nastavení, tyto soubory přidat vlastní skupinu a **doplňky** karty na pásu karet.  
  
## <a name="display-the-custom-ribbon-in-a-microsoft-office-application"></a>Vlastní pás karet zobrazit v aplikaci Microsoft Office  
 Po přidání **pásu karet (XML)** položku do projektu, je nutné přidat kód do **ThisAddin**, **ThisWorkbook**, nebo **ThisDocument** – třída přepsání, která `CreateRibbonExtensibilityObject` metodu a vrátí XML karet třídy pro aplikace Office.  
  
 Následující kód například přepsání `CreateRibbonExtensibilityObject` metodu a vrátí XML karet třídy s názvem MyRibbon.  
  
 [!code-csharp[Trin_Ribbon_Custom_Tab_XML#1](../vsto/codesnippet/CSharp/Trin_Ribbon_Custom_Tab_XML_O12/ThisAddIn.cs#1)]
 [!code-vb[Trin_Ribbon_Custom_Tab_XML#1](../vsto/codesnippet/VisualBasic/Trin_Ribbon_Custom_Tab_XML_O12/ThisAddIn.vb#1)]  
  
## <a name="define-the-behavior-of-the-custom-ribbon"></a>Zadejte chování vlastní pás karet  
...
>  Outlook vyžaduje další krok. Další informace najdete v tématu [přizpůsobení pásu karet pro aplikaci Outlook](../vsto/customizing-a-ribbon-for-outlook.md).  
 ...
 Návod, jak automatizovat aplikace na pásu karet najdete v tématu [návod: vytvoření vlastní karty pomocí kódu XML pásu karet](../vsto/walkthrough-creating-a-custom-tab-by-using-ribbon-xml.md).  
...
|`OnLoad`|Přiřadí <xref:Microsoft.Office.Core.IRibbonControl> parametru `Ribbon` pole. Aplikace Microsoft Office volat tuto metodu v případě, že načtete vlastní pás karet. Toto pole můžete použít k dynamicky aktualizovat vlastní pás karet. Další informace najdete v tématu technického článku [přizpůsobení pásu karet Office (2007) uživatelského rozhraní pro vývojáře (část 1 ze 3)](http://msdn.microsoft.com/en-us/a4fd6d18-d4a8-4e64-bd89-f437208573d3).|  
