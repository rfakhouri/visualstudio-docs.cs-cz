...
## <a name="objects-created-when-schemas-are-attached-to-excel-workbooks"></a>Objekty vytvořené při schémata jsou připojené do sešitů aplikace Excel  
...
## <a name="objects-created-when-schema-elements-are-mapped-to-excel-worksheets"></a>Objekty vytvořené při prvky schématu jsou namapované na listech aplikace Excel  
...
### <a name="office-mapped-schemas-and-the-visual-studio-data-sources-window"></a>Office namapované schémata a okna zdroje dat Visual Studio  
