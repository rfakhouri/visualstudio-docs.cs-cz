---
title: Změny požadované pro projekty Office migrovat na rozhraní .NET Framework 4, 4.5
ms.date: 02/02/2017
ms.topic: conceptual
dev_langs:
- VB
...
## <a name="update-the-prerequisites-for-deployment"></a>Předpoklady pro nasazení aktualizace
 ...
 Další informace o aktualizaci požadavky pro nasazení na počítačích koncových uživatelů najdete v tématu [jak: Instalace požadovaných součástí na počítačích koncových uživatelů, které spouštějí řešení Office](https://msdn.microsoft.com/74dd2c52-838f-4abf-b2b4-4d7b0c2a0a98).
