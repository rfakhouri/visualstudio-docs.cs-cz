...
|Získání kolekce souborů nedávno použité sešitu.|[Postupy: Vytváření seznamů naposledy použitých souborů sešitů prostřednictvím kódu programu](../vsto/how-to-programmatically-list-recently-used-workbook-files.md)|  
