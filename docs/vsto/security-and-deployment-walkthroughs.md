---
title: "Zabezpečení a návody pro nasazení | Microsoft Docs"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
## <a name="deployment-topics"></a>Témata týkající se nasazení  
 ...
 Poskytuje informace o tom, jak používat **Průvodci publikováním** nebo **publikovat** stránky v Návrháři projektu publikování řešení pro systém Office.  
 ...
 Popisuje kroky pro nasazení na server služby SharePoint.  
  
 [Postupy: Instalace řešení ClickOnce Office](http://msdn.microsoft.com/en-us/14702f48-9161-4190-994c-78211fe18065)  
 Popisuje kroky pro instalaci řešení pro systém Office tak, že spustíte instalační program, který je generován během procesu publikování. otevření souboru manifestu nasazení; nebo otevírání přizpůsobené dokumentu nebo sešitu.  
  
 [Postupy: instalace požadovaných součástí na koncové uživatele počítačů ke spouštění řešení pro systém Office](http://msdn.microsoft.com/en-us/74dd2c52-838f-4abf-b2b4-4d7b0c2a0a98)  
 ...
 Popisuje, jak nakonfigurovat typ MIME pro manifest nasazení v Internetové informační služby (IIS).  
  
 [Postupy: aktualizovat řešení nasazené Office](http://msdn.microsoft.com/en-us/be96db53-b6ea-46ab-b8d9-b76b098b3b13)  
 Poskytuje informace o tom, jak aktualizovat řešení Office s použitím **Průvodci publikováním**.  
