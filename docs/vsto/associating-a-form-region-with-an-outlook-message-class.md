...
# <a name="associate-a-form-region-with-an-outlook-message-class"></a>Přidružení oblasti formuláře k třídě zpráv aplikace Outlook
  Můžete určit, které aplikace Microsoft Office Outlook položky zobrazení oblasti formuláře ve přidružení oblasti formuláře k třídě zpráv každé položky. Například pokud se chcete připojit oblasti formuláře k dolnímu okraji položku e-mailu, můžete přidružit oblasti formuláře s `IPM.Note` třída zprávy.  
...
## <a name="understand-outlook-message-classes"></a>Pochopení tříd zpráv aplikace Outlook  
...
### <a name="use-the-new-outlook-form-region-wizard"></a>Použijte Průvodce novou oblasti formuláře aplikace Outlook  
 ...
 Standardní zprávy třídy nejsou k dispozici, pokud oblasti formuláře je určena k nahrazení celého formuláře nebo výchozí stránka formuláře. Můžete zadat názvy tříd standardní zprávy pouze pro formuláře přidá novou stránku do formuláře nebo které se připojují k dolnímu okraji formuláře. Další informace najdete v tématu [postupy: přidání oblasti formuláře do projektu doplněk aplikace Outlook](../vsto/how-to-add-a-form-region-to-an-outlook-add-in-project.md).  
...
### <a name="apply-class-attributes"></a>Použití atributů – třída  
...
-   Pokud oblasti formuláře nahradí celý formulář nebo výchozí stránka s formuláře nebudou obsahovat názvy tříd standardní zpráv. Můžete zadat názvy tříd standardní zprávy pouze pro formuláře přidá novou stránku do formuláře nebo které se připojují k dolnímu okraji formuláře. Další informace najdete v tématu [postupy: přidání oblasti formuláře do projektu doplněk aplikace Outlook](../vsto/how-to-add-a-form-region-to-an-outlook-add-in-project.md).  
...
## <a name="see-also"></a>Viz také  
 ...
 [Přehled tříd název formuláře a zpráv](http://msdn.microsoft.com/library/office/ff867629.aspx)   
