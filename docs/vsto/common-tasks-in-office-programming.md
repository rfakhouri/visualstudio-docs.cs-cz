...
-   [Úkoly vlastního nastavení uživatelské rozhraní](#ui).  
  
-   [Automatizace úloh v aplikaci Excel](#excel).  
  
-   [Aplikace Word automatizace úloh](#word).  
  
-   [Data úlohy](#data).  
  
-   [Úlohy správy serverové dokumentu](#server).  
...
-   [Postupy: formátování řádků listů obsahujících zvolené buňky prostřednictvím kódu programu změnit](../vsto/how-to-programmatically-change-formatting-in-worksheet-rows-containing-selected-cells.md).  
