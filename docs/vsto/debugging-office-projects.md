...
## <a name="display-exceptions"></a>Zobrazit výjimky
 ...
 Ve výchozím nastavení Visual Studio také nemá zobrazení Just-In-Time chyby ladění projektů Office; Můžete ale povolit tuto funkci tak, aby se zobrazí chyby, které jsou vyvolány. Další informace najdete v tématu [Just-In-Time ladění v sadě Visual Studio](../debugger/just-in-time-debugging-in-visual-studio.md).
