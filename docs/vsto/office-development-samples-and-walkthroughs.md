...
# <a name="office-development-samples-and-walkthroughs"></a>Ukázky a návody k vývoji pro systém Office
 ...
 Informace o zabezpečení aplikací najdete v tématu [zabezpečení řešení pro systém Office](../vsto/securing-office-solutions.md).  
...
|[Návody pro práci s aplikací Word](../vsto/walkthroughs-using-word.md)|Obsahuje podrobné pokyny, které poskytují úvod do nástroje pro vývoj pro Office v sadě Visual Studio a pomoci pro ilustraci, jak integrovat Word do Office.|  
|[Návody pro práci s aplikací Excel](../vsto/walkthroughs-using-excel.md)|Obsahuje podrobné pokyny, které poskytují úvod do nástroje pro vývoj pro Office v sadě Visual Studio a pomoci pro ilustraci, jak integrovat aplikace Excel do Office.|  
|[Data v návody řešení Office](../vsto/data-in-office-solutions-walkthroughs.md)|Obsahuje podrobné pokyny, které ukazují, jak pracovat s daty v řešení.|  
|[Návody pro přizpůsobení uživatelského rozhraní sady Office](../vsto/office-ui-customization-walkthroughs.md)|Obsahuje podrobné pokyny, které ilustrují, jak můžete přizpůsobit uživatelské rozhraní (UI) aplikace Microsoft Office.|  
|[Zabezpečení a návody pro nasazení](../vsto/security-and-deployment-walkthroughs.md)|Obsahuje podrobné pokyny, které ilustrují, jak můžete nastavit zásady zabezpečení pro povolení spuštění řešení, a jak můžete nasadit řešení.|  
...
|[Běžné úlohy při programování pro Office](../vsto/common-tasks-in-office-programming.md)|Uvádí nejčastější dotazy k programování s vývoj pro Office v sadě Visual Studio a nabízí odkazy na témata, která pomůžou řešit běžné problémy.|  
|[Návrh a vytváření řešení pro systém Office](../vsto/designing-and-creating-office-solutions.md)|Obsahuje odkazy na informace o tom, jak vytvářet řešení systému Microsoft Office a o roli sestavení v řešení.|  
|[Přehled podokna akcí](../vsto/actions-pane-overview.md)|Poskytuje přehled v podokně úloh na úrovni dokumentu volat v podokně Akce.|  
