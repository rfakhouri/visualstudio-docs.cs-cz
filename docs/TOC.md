...
#### [Používání integrovaného vývojového prostředí pro Visual Basic...](vb-ide/refactoring-vb.md)
#### [Refaktoring, generování kódu a rychlé akce](ide/refactoring-code-generation-quick-actions.md)
...
#### [Pohyb v kódu](ide/navigating-code.md)
...
##### [Jazyk a zásady formátování rozhraní .NET pro EditorConfig](ide/editorconfig-code-style-settings-reference.md)
##### [Zásady vytváření názvů rozhraní .NET pro EditorConfig](ide/editorconfig-naming-conventions.md)
...
##### [Navrhování a zobrazování tříd a typů](ide/class-designer/TOC.md)
...
#### [Vytváření úvodních sad](ide/how-to-create-starter-kits.md)
