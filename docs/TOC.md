...
## [Python v sadě Visual Studio...](python/vs-tutorial-01-01.md)
...
###### Rychlé akce pro C#
####### [Generování třídy / typu](ide/reference/generate-class-type-csharp.md)
####### [Generování metody](ide/reference/generate-method-csharp.md)
####### [Generování pole / vlastnosti / místní funkce](ide/reference/generate-field-property-local-csharp.md)
####### [Generování konstruktoru](ide/reference/generate-constructor-csharp.md)
####### [Generování přepisu](ide/reference/generate-override-csharp.md)
####### [Generování přepisů metod Equals a GetHashCode](ide/reference/generate-overrides-csharp.md)
####### [Generování komentářů k dokumentaci XML](ide/reference/generate-xml-documentation-comments-csharp.md)
####### [Implementace abstraktní třídy](ide/reference/implement-abstract-class-csharp.md)
####### [Implementace rozhraní](ide/reference/implement-interface-csharp.md)
####### [Přidání místní proměnné](ide/reference/introduce-local-variable-csharp.md)
###### Rychlé akce pro Visual Basic
####### [Generování třídy / typu](ide/reference/generate-class-type-vb.md)
####### [Generování metody](ide/reference/generate-method-vb.md)
####### [Generování pole / vlastnosti / místní funkce](ide/reference/generate-field-property-local-vb.md)
####### [Generování konstruktoru](ide/reference/generate-constructor-vb.md)
####### [Generování přepisu](ide/reference/generate-override-vb.md)
####### [Generování komentářů k dokumentaci XML](ide/reference/generate-xml-documentation-comments-vb.md)
####### [Implementace abstraktní třídy](ide/reference/implement-abstract-class-vb.md)
####### [Implementace rozhraní](ide/reference/implement-interface-vb.md)
####### [Přidání místní proměnné](ide/reference/introduce-local-variable-vb.md)
#### [Refaktorování kódu](ide/refactoring-in-visual-studio.md)
##### Refaktoring pro C#
###### [Změna podpisu metody](ide/reference/change-method-signature-csharp.md)
###### [Převedení metody Get na vlastnost](ide/reference/convert-get-method-to-property-csharp.md)
###### [Zapouzdření pole](ide/reference/encapsulate-field-csharp.md)
###### [Extrahování rozhraní](ide/reference/extract-interface-csharp.md)
###### [Extrahování metody](ide/reference/extract-method-csharp.md)
###### [Vložená dočasná proměnná](ide/reference/inline-temporary-variable-csharp.md)
###### [Přesunutí deklarace do blízkosti odkazu](ide/reference/move-declaration-near-reference-csharp.md)
###### [Přesunutí typu do odpovídajícího souboru](ide/reference/move-type-to-matching-file-csharp.md)
###### [Odebrání nedosažitelného kódu](ide/reference/remove-unreachable-code-csharp.md)
###### [Přejmenovat](ide/reference/rename-csharp.md)
###### [Synchronizace typu a názvu souboru](ide/reference/sync-type-and-file-csharp.md)
##### Refactoring pro Visual Basic
###### [Změna podpisu metody](ide/reference/change-method-signature-vb.md)
###### [Zapouzdření pole](ide/reference/encapsulate-field-vb.md)
###### [Extrahování rozhraní](ide/reference/extract-interface-vb.md)
###### [Extrahování metody](ide/reference/extract-method-vb.md)
###### [Vložená dočasná proměnná](ide/reference/inline-temporary-variable-vb.md)
###### [Přesunutí typu do odpovídajícího souboru](ide/reference/move-type-to-matching-file-vb.md)
...
##### [Návod: Podpora včasného testování s funkcí Generování před využitím](ide/walkthrough-test-first-support-with-the-generate-from-usage-feature.md)
...
## [Šablony projektů a položek](ide/creating-project-and-item-templates.md)
