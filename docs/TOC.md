...
## [Řešení problémů s instalací](install/troubleshooting-installation-issues.md)
...
### [Pohyb v integrovaném vývojovém prostředí](ide/how-to-move-around-in-the-visual-studio-ide.md)
...
##### [Přidání odkazů pomocí nástroje NuGet versus sady SDK rozšíření](ide/adding-references-using-nuget-versus-an-extension-sdk.md)
...
#### [Správa podepsání sestavení a manifestu](ide/managing-assembly-and-manifest-signing.md)
...
#### [Podpora 64bitových aplikací](ide/visual-studio-ide-64-bit-support.md)
...
####### [Referenční informace k fragmentům kódu C#](ide/visual-csharp-code-snippets.md)
####### [Referenční informace k fragmentům kódu C++](ide/visual-cpp-code-snippets.md)
...
####### [Řešení problémů s fragmenty kódu](ide/troubleshooting-snippets.md)
...
###### [Konverze mezi cyklem for a příkazem foreach](ide/reference/convert-for-loop-to-foreach.md)
###### [Konverze mezi metodou a vlastností Get](ide/reference/convert-get-method-to-property.md)
###### [Konverze dotazu LINQ na příkaz foreach](ide/reference/convert-linq-to-foreach.md)
...
###### [Použití explicitního typu](ide/reference/convert-var-to-explicit-type.md)
...
###### [Zobrazení a úpravy kódu s použitím funkce Náhled definice](ide/how-to-view-and-edit-code-by-using-peek-definition-alt-plus-f12.md)
...
##### [Zobrazení adres URL jako odkazů](ide/reference/how-to-display-urls-as-links-in-the-editor.md)
...
#### [Přizpůsobení posuvníku](ide/how-to-track-your-code-by-customizing-the-scrollbar.md)
#### [Nastavení záložek v kódu](ide/setting-bookmarks-in-code.md)
#### [Nalezení historie kódu pomocí CodeLensu](ide/find-code-changes-and-other-history-with-codelens.md)
...
#### [Kopírování elementů diagramu tříd do dokumentu Microsoft Office](ide/class-designer/how-to-copy-class-diagram-elements-to-a-microsoft-office-document.md)
...
### [Zabezpečené aplikace](ide/securing-applications.md)
### [Zajištění zabezpečení](ide/maintaining-security.md)
...
## [Program zlepšování sady Visual Studio na základě zkušeností uživatelů](ide/visual-studio-experience-improvement-program.md)
