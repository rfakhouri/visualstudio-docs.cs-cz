...
Zatížení vědecké zpracování dat a analytické aplikace uvedené v instalačním programu sady Visual Studio spojuje tři jazyky a jejich odpovídajících runtime distribuce:
