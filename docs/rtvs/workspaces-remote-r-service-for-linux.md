...
Vzdálená služba R pro Linux je aktuálně zabalené jako démon rtvs. Démon je podporované a otestovat Ubuntu 16.04, 16.10 plochy LTS, serveru a subsystému Windows pro spuštění Ubuntu Linux. Hromadným Toto téma obsahuje pokyny pro nastavení vzdálené služby R na tyto různými systémy.
