...
Teď můžete interaktivně zápisu R kód, který zpracovává `InputDataSet` dataframe podle potřeby. Nezapomeňte, že můžete právě vyberte v editoru kódu jazyka R a odeslat ho do [interaktivních okna](interactive-repl.md) stisknutím kláves Ctrl + Enter.
