---
title: "Postupy: přepínání mezi zobrazeními a Editor souborů XML | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
4.  Přetáhněte `USAddress` uzlu z Průzkumník schématu XML na zobrazení grafu. Klikněte pravým tlačítkem myši `USAddress` uzel v zobrazení grafu a vyberte **zobrazit v zobrazení obsahu modelu** v místní nabídce.  
  
     Zobrazení obsahu modelu s detaily o `USAddress` uzel se objeví.  
  
5.  Přejděte do zobrazení spustit z modelu zobrazení obsahu pomocí panelu nástrojů klikněte na tlačítko Start zobrazení na panelu nástrojů XSD.  
  
6.  Pro přepínání mezi zobrazeními pomocí klávesových zkratek, stiskněte kombinaci kláves CTRL + 1 pro spuštění zobrazení, kombinace kláves CTRL + 2 pro zobrazení grafu a kombinace kláves CTRL + 3 pro zobrazení obsahu modelu.  
