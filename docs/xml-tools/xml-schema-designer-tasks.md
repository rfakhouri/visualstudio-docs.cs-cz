---
title: Úlohy Návrhář schématu XML | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-general
...
---
# <a name="xml-schema-designer-tasks"></a>Úlohy Návrhář schématu XML
Tato část popisuje provádění běžných úloh s nástroji Návrhář schématu XML.  
  
## <a name="in-this-section"></a>V tomto oddílu  
 [Postupy: Vytvoření a úprava souboru XSD](../xml-tools/how-to-create-and-edit-an-xsd-schema-file.md)  
 Popisuje postup vytvoření nového souboru schématu XML (XSD) a pak přidejte obsah do soubor XSD.  
 ...
 Vysvětluje, jak přidat uzly, kteří jsou zvýrazněni v Průzkumníku schématu XML jako výsledky hledání – klíčové slovo do pracovního prostoru.  
  
 [Postupy: Přepínání mezi zobrazeními a editorem XML](../xml-tools/how-to-switch-between-views-and-the-xml-editor.md)  
 Ukazuje, jak přepínat mezi zobrazení Návrhář schématu XML a Editor souborů XML.  
 ...
 Vysvětluje, jak přidat uzly do pracovního prostoru Návrhář schématu XML z Průzkumníka schématu XML.  
 ...
 Ukazuje, jak přidat globální uzly do pracovního prostoru ze zobrazení spustit.  
 ...
 Popisuje, jak prozkoumat uzly pomocí zobrazení obsahu modelu.  
 ...
 Popisuje postup zobrazení schéma spojené s literál XML.  
 ...
 Popisuje, jak vytisknout diagram zobrazení grafu zobrazení nebo zobrazení obsahu modelu.  
  
 [Ukázkové soubory XSD](../xml-tools/sample-xsd-files.md)  
 Obsahuje výpis kódu pro ukázkové XSD dokumenty, které se používají v příkladech úloh.  
