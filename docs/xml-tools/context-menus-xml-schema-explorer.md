...
ms.locfileid: "57526487"
---
# <a name="context-menus-xml-schema-explorer"></a>Kontextové nabídky (Průzkumník schémat XML)

Místní nabídka je nabídka, která se zobrazí, když kliknete pravým tlačítkem na libovolnou položku. Následující položky místní nabídky jsou používány k provádění specifické pro schéma vyhledávání a další operace.
