---
title: "Ukázkový soubor XSD: Zakoupit pořadí schématu | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="sample-xsd-file-purchase-order-schema"></a>Ukázkový soubor XSD: Nákupu pořadí schématu
Následující soubor XSD se používá v různých příklady v dokumentaci k Návrhář schématu XSD. Tento soubor je schéma pořadí nákupu.  
