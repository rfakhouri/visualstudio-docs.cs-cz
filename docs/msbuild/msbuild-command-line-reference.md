...
|------------|----------------|-----------------|  
|– Nápověda|/? or -h|Zobrazit informace o využití. Následující příkaz je příklad:<br /><br /> `msbuild.exe -?`|  
