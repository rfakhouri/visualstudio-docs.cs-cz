...
1. Otevřít Visual Studio a vytvořte projekt.
    ...
    V horním řádku nabídek zvolte **Soubor** > **Nový** > **Projekt**. V levém podokně **nový projekt** dialogového okna rozbalte **Visual C#**   >  **Windows Desktop**, klikněte na tlačítko **aplikace Windows Forms (. Rozhraní .NET Framework)**. Klikněte na tlačítko **OK**.

    V **název** zadejte `BuildApp`. Zadejte **umístění** pro řešení, například *D:\\*. Přijměte výchozí hodnoty pro **vytvořit adresář pro řešení** (vybrané), **přidat do správy zdrojových kódů** (nevybráno), a **název řešení** (**BuildApp**).
    ::: moniker-end
...
**Použití speciálních znaků v úloha zprávy**
...
**Prozkoumat položky typu hodnoty**
...
**Chcete zahrnout a vyloučit položky**
...
**Prozkoumat dobře známé metadat**
...
**Chcete-li transformovat pomocí metadat položky**
