...
Nemohli jsme ve vašich nápadů pro zlepšení našich produktů a dokumentaci. Nelze vždy odpovíte identifikovatelné, ale nemůžeme budete Ujistěte se, že váš názor získá správné osobě nebo týmu.  

## <a name="i-want-to-report-a-problem-with-visual-studio"></a>Chci ohlásit problém s Visual Studio  
 Pokud používáte problémy pomocí sady Visual Studio, například dojde k chybě, pomalá výkonu, neočekávanému chování a tak dál, nahlaste problém do us pomocí **nahlásit problém** nástroj. Jednoduše klikněte na ikonu zpětné vazby vedle **QuickLaunch**, nebo zvolte **nápovědy &#124; Odeslat zpětnou vazbu &#124; Nahlásit problém** z hlavní nabídky. Další informace najdete v tématu [postup nahlásit problém s Visual Studio 2017](how-to-report-a-problem-with-visual-studio-2017.md).  
...
## <a name="i-want-to-make-a-suggestion-about-visual-studio-features"></a>Chcete navrhnout zlepšení o funkcích nástroje Visual Studio  
 Pokud je něco, co můžeme dělat líp, dejte nám vědět! Zvolte **poskytují zlepšení** navrhnout funkce nebo změňte týmu Visual Studio. Návrh, který se budou automaticky odeslány do [UserVoice](https://visualstudio.uservoice.com) kde ostatním hlasovat pro ni.  
...
Možnosti podpory sady Visual Studio najdete v tématu naše [podporu přehled](https://www.visualstudio.com/vs/support/) stránky.
...
Pro větší organizace, které vyžadují spravovanou podporu přímo od společnosti Microsoft, jsou k dispozici smlouvy prostřednictvím různých nabídek programu Premier Support. Další informace najdete v tématu [prvotřídní podporu služby společnosti Microsoft](http://go.microsoft.com/fwlink/?LinkId=258223).  
...
## <a name="i-want-to-get-involved-in-the-developer-community"></a>Chci zapojení do komunity vývojářů  
 Pokud chcete sdílet s jinými vývojáři otázky a odpovědi, můžete použít [Visual Studio Community vývojáře](https://developercommunity.visualstudio.com/index.html) lokality, [fórech MSDN](http://social.msdn.microsoft.com/Forums/home), nebo [StackOverflow](http://stackoverflow.com/). Můžete také zobrazit kódu z jiných vývojáři a sdílet vlastní příklady na [ukázky kódu vývojáře](http://code.msdn.microsoft.com/) a [webu CodePlex](http://www.codeplex.com/) weby. A v neposlední řadě, lze sdílet svoje znalosti reagovat na připomínky zákazníků v sekci komentáře na libovolné stránce Visual Studio na [docs.microsoft.com](https://docs.microsoft.com/visualstudio/).

## <a name="i-want-to-help-improve-the-visual-studio-documentation"></a>Chci pomoci vylepšit dokumentaci k sadě Visual Studio  
  Použijte prosím naše tlačítko zpětnou vazbu (**byly užitečné tuto stránku?**) v dolní části stránky. Toto tlačítko můžete najít na všechny stránky naší dokumentaci. Pokud hledáte odpověď a nelze ji najít, řekněte nám, co informace, které hledáte. (Alternativně můžete přidat zpětnou vazbu na všechny stránky sady Visual Studio na [docs.microsoft.com](https://docs.microsoft.com/visualstudio/) pomocí sekci komentáře.)
