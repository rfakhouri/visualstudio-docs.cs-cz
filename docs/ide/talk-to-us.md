...
Pokud používáte problémy pomocí sady Visual Studio, například dojde k chybě, pomalá výkonu, neočekávanému chování a tak dál, nahlaste problém do us pomocí **nahlásit problém** nástroj. Jednoduše klikněte na ikonu zpětné vazby vedle **Snadné spuštění**, nebo zvolte **pomoci** > **odeslat zpětnou vazbu** > **nahlásit problém** z řádku nabídek. Visual Studio nahlásí tyto potíže k [komunity vývojářů](https://developercommunity.visualstudio.com). Další informace najdete v tématu [postup nahlásit problém s Visual Studio 2017](how-to-report-a-problem-with-visual-studio-2017.md).
...
Visual Studio informace podpory najdete v tématu [cyklus životnosti podpory & obsluhy](/visualstudio/productinfo/vs-servicing-vs) stránky.

Další produkty společnosti Microsoft a služby najdete v tématu [podporu společnosti Microsoft](http://go.microsoft.com/fwlink/?LinkID=99019) online nápovědu.
...
Pokud chcete sdílet s jinými vývojáři otázky a odpovědi, můžete použít [Visual Studio Community vývojáře](https://developercommunity.visualstudio.com) lokality, [fórech MSDN](http://social.msdn.microsoft.com/Forums/home), nebo [StackOverflow](http://stackoverflow.com/). Můžete také zobrazit kódu z jiných vývojáři a sdílet vlastní příklady na [ukázky kódu vývojáře](http://code.msdn.microsoft.com/) lokality.
...
* [Komunity vývojářů](https://developercommunity.visualstudio.com)
