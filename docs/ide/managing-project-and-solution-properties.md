...
Informace o vlastnostech projektů C++, naleznete v tématu [práce s vlastnostmi projektu (C++)](/cpp/build/working-with-project-properties). Další informace o vlastnostech jazyka JavaScript naleznete v tématu [stránky vlastností, JavaScript](../ide/reference/property-pages-javascript.md).
