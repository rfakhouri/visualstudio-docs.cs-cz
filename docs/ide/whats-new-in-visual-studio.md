...
Všechny rozšíření, které si stáhnout, když jste přihlášení je přidán do seznamu jako **Roamované & nainstalován** a je součástí vašeho seznamu roamingu, která umožňuje přístup k němu z libovolného počítače.
