...
Informace o vytváření aplikací pro obousměrných jazyků v sadě Visual Studio najdete v tématu [vytvářet aplikace pro arabština a hebrejština](creating-applications-in-bi-directional-languages.md).
