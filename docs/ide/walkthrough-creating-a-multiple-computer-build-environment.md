...
-   Licencovanou kopii Visual Studio Ultimate, Visual Studio Premium nebo Visual Studio Professional  
  
-   Kopie rozhraní .NET Framework 4.5.1, kterou si můžete stáhnout z [Visual Studio](http://www.microsoft.com/visualstudio/eng/downloads#d-additional-software) webu.  
...
#### <a name="to-install-software-on-the-computers"></a>K instalaci softwaru v počítačích  
...
##  <a name="CopyingFiles"></a>Kopírování souborů z hostitelského počítače k počítači sestavení  
...
2.  Zkopírujte následující rekurzivní složky z hostitelského počítače do počítače, sestavení:  
    ...
    -   11.0\Common7\Tools\ProjectComponents\ %ProgramFiles%\Microsoft visual Studio  
...
3.  Zkopírujte tyto soubory do počítače sestavení z hostitelského počítače:  
    ...
    -   11.0\Common7\IDE\msobj110.dll %ProgramFiles%\Microsoft visual Studio  
  
    -   11.0\Common7\IDE\mspdb110.dll %ProgramFiles%\Microsoft visual Studio  
  
    -   11.0\Common7\IDE\mspdbcore.dll %ProgramFiles%\Microsoft visual Studio  
  
    -   11.0\Common7\IDE\mspdbsrv.exe %ProgramFiles%\Microsoft visual Studio  
  
    -   11.0\Common7\IDE\msvcdis110.dll %ProgramFiles%\Microsoft visual Studio  
  
    -   11.0\Common7\Tools\makehm.exe %ProgramFiles%\Microsoft visual Studio  
  
    -   11.0\Common7\Tools\VCVarsQueryRegistry.bat %ProgramFiles%\Microsoft visual Studio  
  
    -   11.0\Common7\Tools\vsvars32.bat %ProgramFiles%\Microsoft visual Studio  
...
##  <a name="CreatingRegistry"></a>Vytváření nastavení registru  
...
#### <a name="to-copy-assemblies-from-the-host-computer-and-install-them-on-the-build-computer"></a>Zkopírujte sestavení z hostitelského počítače a nainstalujete je v počítači sestavení  
...
1.  Zkopírujte následující sestavení z hostitelského počítače do počítače, sestavení. Vzhledem k tomu, že se nainstalují do mezipaměti GAC, nezávisle na tom, kde je umístěna v počítači sestavení.  
    ...
    -   11.0\Common7\IDE\PublicAssemblies\Microsoft.VisualStudio.VCProjectEngine.dll %ProgramFiles%\Microsoft visual Studio  
...
##  <a name="CreatingForSourceControl"></a>Vytváření prostředí pro sestavení tak, aby je bylo možné zkontrolovat do správy zdrojového kódu  
...
#### <a name="to-create-a-build-environment-that-can-be-checked-into-source-control"></a>Chcete-li vytvořit prostředí sestavení, které jde zkontrolovat do správy zdrojového kódu  
...
3.  Když jsou soubory vložili ve skladu %, proveďte tyto změny:  
    ...
    -   V % Depot%\MSBuild\Microsoft.Cpp\v4.0\v110\Microsoft.CPP.Targets \Microsoft.Cpp.InvalidPlatforms.targets\\, \Microsoft.cppbuild.targets\\a \Microsoft.CppCommon.targets\\, změňte všechny instance z  
         ...
         AssemblyFile = "Microsoft.Build.CppTasks.Common.v110.dll$ (VCTargetsPath11)".  
