...
1. V **Průzkumníku řešení**, otevřete místní nabídku pro projekt, který chcete změnit a potom vyberte **vlastnosti**.
    ...
    ![Vlastnosti Průzkumníka řešení sady Visual Studio](../ide/media/vs_slnexplorer_properties.png)

1. V levém sloupci **vlastnosti** okně zvolte **aplikace** kartě.

    ![Karta Visual Studio aplikace vlastnosti aplikace](../ide/media/vs_slnexplorer_properties_applicationtab.png)
