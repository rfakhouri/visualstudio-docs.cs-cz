...
Pro testování, Visual Studio nabízí testování, IntelliTest, zátěže a testování výkonu a další jednotky. Chcete-li získat další informace o ladění proces sady Visual Studio, najdete v části [prohlídka funkce ladicího programu](../debugger/debugger-feature-tour.md). Další informace o testování najdete v tématu [testovacích nástrojů](https://www.visualstudio.com/vs/testing-tools/). Další informace o zvýšení výkonu aplikací, najdete v části [profilace prohlídka funkce](../profiling/profiling-feature-tour.md).  
...
Následující obrázek ukazuje tak, abyste získali visual Přehled sady Visual Studio, Visual Studio s otevřít projekt spolu s několika okna klíče nástrojů, které budou s největší pravděpodobností používat:  
 ...
 - [Team Explorer](https://www.visualstudio.com/docs/connect/work-team-explorer) slouží ke sledování pracovní položky a sdílet s ostatními kódu pomocí technologie pro řízení verzí, jako třeba [Git](https://git-scm.com/) a [Team Foundation verze ovládacího prvku (TFVC)] (https://www.visualstudio.com/docs/tfvc/overview) .  
...
Můžete spravovat vašeho zdrojového kódu v hostované všechny zprostředkovatele, včetně Githubu úložiště Git. Nebo použijte [Visual Studio Team Services (VSTS)](https://www.visualstudio.com/team-services/) ke správě kód společně se chyby a pracovní položky pro celý projekt. V tématu [začít pracovat s Git a Team Services](https://www.visualstudio.com/en-us/docs/git/gitquickstart-vs2017) Další informace o správě úložiště Git v sadě Visual Studio pomocí Team Explorer.  Visual Studio má také další funkce integrované zdroj ovládacího prvku. Další informace o nich najdete v tématu [nové funkce Git v nástroji Visual Studio 2017 (blog)](https://blogs.msdn.microsoft.com/visualstudioalm/2017/03/06/new-git-features-in-visual-studio-2017/).  
...
Další informace o sadě Visual Studio Team Services najdete v tématu [Visual Studio Team Services](https://www.visualstudio.com/team-services/). Další informace o Team Foundation Server najdete v tématu [Team Foundation Server](https://www.visualstudio.com/products/tfs-overview-vs).  
