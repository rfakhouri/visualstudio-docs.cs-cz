---
title: "Použití Visual Studio Help Viewer tabulky obsahu | Microsoft Docs"
ms.custom: 
ms.date: 11/02/2017
ms.reviewer: 
ms.suite: 
...
#### <a name="to-synchronize-the-toc-with-the-topic-window"></a>Chcete-li synchronizace obsahu s okně tématu  
