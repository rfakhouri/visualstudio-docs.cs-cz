...
Vztah dědičnosti, můžete najít, pokud existuje, mezi základní typ a jeho odvozených typů v diagramu tříd v Návrháři tříd. Chcete-li vytvořit vztah dědičnosti, pokud žádný neexistuje, mezi dvěma typy, přečtěte si téma [postupy: vytvoření dědičnosti mezi typy](how-to-create-inheritance-between-types.md).  
