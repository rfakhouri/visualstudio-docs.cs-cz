...
> [!NOTE]
>  Přidružení relace může být reprezentován jako člen vlastnost nebo pole. Chcete-li změnit notace členů notace přidružení, musí mít jeden typ členem jiného typu. Notace přidružení změnit na notace členů, existují dva typy musí být připojen přidružení čára. Další informace najdete v tématu [postupy: vytvoření přidružení mezi typy](how-to-create-associations-between-types.md). Pokud projekt obsahuje více diagramů tříd, změny, které provedete způsob diagram zobrazuje přidružení vztahy ovlivňují jenom tento diagram. Změnit způsob jiný diagram zobrazuje přidružení vztahů, otevřete nebo zobrazit tento diagram a proveďte tyto kroky.  
