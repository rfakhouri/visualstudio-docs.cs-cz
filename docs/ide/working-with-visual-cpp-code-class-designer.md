...
-   Došlo k pokusu o vyřešení typu. Typ může být v projektu nebo sestavení, které není na něj odkazovat z projektu, který obsahuje diagramu tříd. Chcete-li opravit tuto chybu, přidejte odkaz na projekt nebo sestavení, které obsahuje typ. Další informace najdete v tématu [Správa odkazů v projektu](../ide/managing-references-in-a-project.md).  
...
## <a name="see-also"></a>Viz také  
 ...
 [Visual C++ definice TypeDef v Návrháři tříd](../ide/visual-cpp-typedefs-in-class-designer.md)
