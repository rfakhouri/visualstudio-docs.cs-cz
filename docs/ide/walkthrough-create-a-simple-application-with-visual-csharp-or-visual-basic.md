...
#### <a name="create-the-wpf-project"></a>Vytvoření projektu WPF
...
2.  Vyberte šablonu aplikace WPF Visual C# nebo Visual Basicu výběrem v levém podokně **nainstalovaná** > **Visual C#** > **Windows klasický desktopový**, třeba, a pak vyberete **aplikace WPF (rozhraní .NET Framework)** v prostředním podokně.  Název projektu `HelloWPFApp` v dolní části **nový projekt** dialogové okno.
...
#### <a name="clean-the-solution-files-and-build-a-release-version"></a>Vyčistěte soubory řešení a sestavení prodejní verzi
