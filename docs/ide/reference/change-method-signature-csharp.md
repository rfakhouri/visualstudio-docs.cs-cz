---
title: Refaktorovat podpis metody v jazyce C# | Microsoft Docs
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
1. Zvýrazněte nebo umístěte kurzor text do název metody k úpravě nebo jeden z jeho použití:
   ...
   ![Zvýrazněný kód](media/changesignature-highlight-cs.png)
...
1. Když skončíte, stiskněte **OK** tlačítko provést změny.
   ...
   ![Podpis výsledek změny](media/changesignature-result-cs.png)
