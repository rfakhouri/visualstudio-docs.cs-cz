---
title: "Přejmenujte název souboru tak, aby odpovídaly typu C# v sadě Visual Studio | Microsoft Docs"
ms.custom: 
ms.date: 02/27/2017
ms.reviewer: 
ms.suite: 
...
1. Zvýrazněte nebo umístěte kurzor text do název typu synchronizovat:
   ...
   ![Zvýrazněný kód](media/synctype-highlight-cs.png)
...
1. Dále proveďte jednu z následujících akcí:
   ...
   * **Myš**
   ...
   ![Vložené výsledek](media/synctype-result-cs.png)
