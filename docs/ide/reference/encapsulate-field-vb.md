---
title: Refaktorovat pole na vlastnost v jazyce Visual Basic | Microsoft Docs
ms.custom: 
ms.date: 12/14/2016
ms.reviewer: 
ms.suite: 
...
1. Zvýrazněte nebo umístěte kurzor text do název pole, která má být zapouzdřena:
   ...
   ![Zvýrazněný kód](media/encapsulate-highlight-vb.png)
...
1. Dále proveďte jednu z následujících akcí:
   ...
   **Pro zapouzdření polí (ale stále můžete do pole)** | Zapouzdří pole s vlastností, ale nechá nezměněný všechny použití pole
   ...
   ![Zapouzdření vlastnost výsledek](media/encapsulate-result-vb.png)
