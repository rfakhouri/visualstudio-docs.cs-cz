---
title: "Extrahování metody v jazyce C# | Microsoft Docs"
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
1. Zvýrazněte kód extrahovat:
   ...
   ![Zvýrazněný kód](media/extractmethod-highlight-cs.png)
...
1. Dále proveďte jednu z následujících akcí:
   ...
   * **Myš**
   ...
   ![Přejmenujte – metoda](media/extractmethod-rename-cs.png)
