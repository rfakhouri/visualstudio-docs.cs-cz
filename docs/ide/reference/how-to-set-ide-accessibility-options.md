---
title: "Postupy: nastavení možnosti usnadnění přístupu IDE | Microsoft Docs"
ms.custom: 
ms.date: 08/22/2017
ms.reviewer: 
ms.suite: 
...
### <a name="changing-the-colors-used-in-the-ide"></a>Změna barvy používané v prostředí IDE  
...
2.  Zvolte **písma a barev** z **prostředí** složky.  
...
#### <a name="to-modify-the-buttons-displayed-text"></a>Chcete-li na tlačítko Upravit zobrazený text  
