...
**Možnost striktní jednotlivých upozornění.**

**Upozornění konfigurace** části **kompilace stránky** má nastavení, které odpovídají tři podmínky, které způsobí chybu kompilace při `Option Strict` na. Tato nastavení jsou následující:
