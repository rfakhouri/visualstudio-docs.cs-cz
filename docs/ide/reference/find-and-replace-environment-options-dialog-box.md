---
title: "Najít a nahradit, prostředí, dialogové okno Možnosti | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
 ...
 **Automaticky vyplňte najít prováděl text v editoru**  
 Vyberte tuto možnost, chcete-li vložit text na žádné straně editoru aktuální kurzor do **najít** pole při výběru všech zobrazení **najít a nahradit** okna z **upravit**  nabídky. Zrušte tuto možnost, chcete-li použít poslední vzor hledání z předchozí hledání, jako **najít** řetězec.  
