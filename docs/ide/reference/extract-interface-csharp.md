---
title: "Extrahování rozhraní v jazyce C# | Microsoft Docs"
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
1. Zvýrazněte název třídy provést akci na nebo umístěte kurzor text právě někde v názvu třídy.
   ...
   ![Zvýrazněný kód](media/extractinterface-highlight-cs.png)
...
1. V **extrahování rozhraní** dialogu, který se zobrazí, zadejte informace o výzva: ![extrahování rozhraní](media/extractinterface-dialog-cs.png)
   | Pole | Popis |
   | --- | --- |
...
1. Click **OK**.
   ...
   ![Výsledná třída](media/extractinterface-class-cs.png)
   ![výsledné rozhraní](media/extractinterface-interface-cs.png)
