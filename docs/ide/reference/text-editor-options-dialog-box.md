...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Vysvětluje, jak změnit editor písma a barev.  
 ...
 Vysvětluje, jak formátu adresy URL, aby se zobrazovaly jako odkazy.  
  
 [Nastavení možností editoru pro konkrétní jazyk](../../ide/reference/setting-language-specific-editor-options.md)  
 Vysvětluje, jak nastavit možnosti editoru, které platí pouze pro jeden jazyk vývoj.  
  
 [Možnosti, textový Editor, obecné](../../ide/reference/options-text-editor-general.md)  
 Vysvětluje možnosti Obecné editoru.  
 ...
 Vysvětluje C/C++ pokročilé možnosti.  
 ...
 Vysvětluje možnosti JavaScript IntelliSense.  
