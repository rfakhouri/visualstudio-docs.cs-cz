---
title: Klávesové zkratky (program Help Viewer) | Microsoft Docs
ms.custom: ''
ms.date: 11/02/2017
ms.technology:
- vs-help-viewer
...
V Prohlížeč nápovědy můžete přejít pomocí klávesové zkratky v následující tabulce:  
  
|Oblast|Klávesová zkratka|Akce|  
|----------|---------------|------------|  
|Obecná aplikace|Místo|Použít místo Enter kdekoli kromě v polích upravit.|  
|Obecná aplikace|F1|Otevření nápovědy o aktuální element uživatelského rozhraní.|  
|Obecná aplikace|F11|Přepínání mezi zobrazení na celou obrazovku a běžného zobrazení.|  
|Panel nástrojů|Backspace<br /><br /> -NEBO-<br /><br /> ALT + Šipka doleva|Zobrazte na předchozí stránku.|  
|Panel nástrojů|ALT + Šipka doprava|Zobrazí na další stránku.|  
|Panel nástrojů|Alt + Home|Zobrazí nápovědu kontrolor domovské stránce.|  
...
|Téma|Klávesová zkratka nabídky<br /><br /> NEBO<br /><br /> SHIFT + F10|Zobrazení místní nabídky pro aktuální element uživatelského rozhraní.|  
...
|Téma|CTRL + Tab|Přepínání mezi kartami zleva doprava.|  
|Téma|Ctrl + Shift + Tab|Přepínání mezi kartami zprava doleva.|  
...
|Téma|Ctrl + Shift + symbol plus|Zvýšit přiblížení 10 %.|  
|Téma|CTRL + symbol mínus|Zmenšení přiblížení 10 %.|  
|Téma|CTRL + 0 (nula).|Změňte zvětšení na 100 %.|  
|Index|Tabulátor|Přesun zaměření z – klíčové slovo položka seznamu – klíčové slovo.|  
|Index|CTRL + K|Přepínat mezi zobrazující položky, které obsahují – klíčové slovo, které zadáte a zadejte položky, které začínají klíčové slovo, které jste.|  
|Oblíbené položky|Ctrl + Shift + Del|Vymažte historii procházení.|  
|Oblíbené položky|del|Odstraňte zadané položky.|  
|Oblíbené položky|CTRL + N|Vytvořte složku v rámci oblíbených položek.|  
...
|Najít|Enter|Změna výběru na další položku.|  
|Najít|Shift + Enter|Změňte fokus na předchozí položky.|  
...
|CTRL + L|Obnovit rozložení Prohlížeč nápovědy k výchozí rozložení a zavřete všechny karty tématu.|  
|CTRL + Tab|První klávesu dává zaměření **Výběr karty** nabídky. Další klávesu provede aktivaci na položku horní nabídce a následné stisknutí kláves fokus se položek nabídky v pořadí od shora dolů. Pokud položku nabídky má právě fokus, provádí klávesy Enter, které položky aktivní karty.|  
|Ctrl + Shift + Tab|První klávesu dává zaměření **Výběr karty** nabídky. Další klávesu provede aktivaci na nejnižší položku nabídky a následné stisknutí kláves fokus se položek nabídky v pořadí odshora dolů. Pokud položku nabídky má právě fokus, provádí klávesy Enter, které položky aktivní karty.|  
...
|Tabulátor|Změnit zaměření **cestu v místním úložišti** textové pole.|  
|Tabulátor|Změnit zaměření **přesunout...**  tlačítko.|  
|ALT + V|Otevřete **přesunout obsahu** dialogové okno.|  
|Ctrl + Alt + F|Změnit zaměření **filtru dokumentaci** textové pole.|  
|Tabulátor|Změna výběru do seznamu dokumentaci.|  
|Šipka nahoru a Šipka dolů|Vyhledejte v dokumentaci k seznamu.|  
|Místo|Přidat položku, kterou chcete **změny čekající na zpracování** seznamu.|  
|Tabulátor|Změnit zaměření **změny čekající na zpracování** seznamu.|  
|Šipka nahoru a Šipka dolů|Posuňte **změny čekající na zpracování** seznamu.|  
