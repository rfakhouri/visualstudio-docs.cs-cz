...
2.kliknutím v **aktivní konfigurace řešení** vyberte  **\<nový... \>**.
  
3 ve **novou konfiguraci řešení** dialogové okno, název novou konfiguraci `Test`, Kopírovat nastavení z existující konfiguraci ladění a potom zvolte **OK** tlačítko.
...
5 v **nová platforma řešení** dialogovém okně vyberte **x64**a nemusíte kopírovat nastavení z x86 platformy.
...
2. v řádku nabídek zvolte **zobrazení**, **stránky vlastností**.
  
     The **Project Designer** opens.
  
3 zvolte **sestavení** stránky a pak na **potlačení upozornění** zadejte číslo upozornění **0168**.
...
2.Kliknutím zvolte **projekty a řešení** kategorie a potom vyberte **sestavit a spustit** stránky.
  
3 ve **výstup sestavení projektu MSBuild podrobností** vyberte **normální**a potom zvolte **OK** tlačítko.
...
2.Kliknutím zvolte **zkompilovat** stránky.
  
3 ve **konfigurace** vyberte **verze**.
...
2.Kliknutím zvolte **sestavení** stránky.
