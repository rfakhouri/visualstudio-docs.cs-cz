...
ms.locfileid: "42670949"
---
# <a name="usedcommands-element"></a>UsedCommands – element
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [usedcommands – Element](https://docs.microsoft.com/visualstudio/extensibility/usedcommands-element).  
