...
## <a name="getting-started"></a>Začínáme  
 ...
 [Přidání opravy kódu názorný postup: Poskytují uživatelům opravy pro analyzátor problémů](https://msdn.microsoft.com/magazine/dn904670.aspx)  
