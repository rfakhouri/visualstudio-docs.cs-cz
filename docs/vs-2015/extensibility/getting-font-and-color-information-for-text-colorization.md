...
Nejnovější verzi tohoto tématu můžete najít v [získávání písmo a barvy informace pro barevné zvýraznění textu](https://docs.microsoft.com/visualstudio/extensibility/getting-font-and-color-information-for-text-colorization).  
