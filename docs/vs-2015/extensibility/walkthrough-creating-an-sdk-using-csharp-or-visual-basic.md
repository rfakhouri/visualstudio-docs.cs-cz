...
Nejnovější verzi tohoto tématu můžete najít v [návod: vytvoření sady SDK pomocí jazyka C# nebo Visual Basic](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-creating-an-sdk-using-csharp-or-visual-basic).  
