...
Nejnovější verzi tohoto tématu můžete najít v [trvalé uložení vlastnosti položky projektu](https://docs.microsoft.com/visualstudio/extensibility/persisting-the-property-of-a-project-item).  
