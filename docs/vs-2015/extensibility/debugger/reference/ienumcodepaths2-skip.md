---
title: IEnumCodePaths2::Skip | Dokumentace Microsoftu
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "42672361"
---
# <a name="ienumcodepaths2skip"></a>IEnumCodePaths2::Skip
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [IEnumCodePaths2::Skip](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumcodepaths2-skip).  
