...
## <a name="terms"></a>Podmínky  
 ...
 dwCorType  
 Základní typ vrácené hodnoty. Jedná se o hodnotu z `CorElementType` definované ve výčtu [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] souboru comimage_flags sady SDK.  
