...
ms.locfileid: "42669276"
---
# <a name="symbol-provider-interfaces"></a>Rozhraní poskytovatele symbolů
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [rozhraní poskytovatele symbolů](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/symbol-provider-interfaces).  
