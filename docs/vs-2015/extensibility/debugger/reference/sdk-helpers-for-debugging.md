...
ms.locfileid: "42673834"
---
# <a name="sdk-helpers-for-debugging"></a>Pomocníci sad SDK pro ladění
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [Pomocníci sad SDK pro ladění](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/sdk-helpers-for-debugging).  
