---
title: IDebugExpressionEvaluator2::SetCorPath | Dokumentace Microsoftu
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "42628722"
---
# <a name="idebugexpressionevaluator2setcorpath"></a>IDebugExpressionEvaluator2::SetCorPath
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [IDebugExpressionEvaluator2::SetCorPath](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugexpressionevaluator2-setcorpath).  
  
Nastavuje cestu ke common language runtime (CLR) načten v ladicím programu.  
...
#### <a name="parameters"></a>Parametry  
 `pcstrCorPath`  
 [in] Cesta k modulu CLR je načten v ladicím programu.  
