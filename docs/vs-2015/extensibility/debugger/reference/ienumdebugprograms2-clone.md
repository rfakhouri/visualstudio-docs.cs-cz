...
ms.locfileid: "42667159"
---
# <a name="ienumdebugprograms2clone"></a>IEnumDebugPrograms2::Clone
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [IEnumDebugPrograms2::Clone](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugprograms2-clone).  
