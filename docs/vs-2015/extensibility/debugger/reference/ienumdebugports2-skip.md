...
ms.locfileid: "42666100"
---
# <a name="ienumdebugports2skip"></a>IEnumDebugPorts2::Skip
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [IEnumDebugPorts2::Skip](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugports2-skip).  
