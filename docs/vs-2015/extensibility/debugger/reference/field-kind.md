...
ms.locfileid: "42668544"
---
# <a name="fieldkind"></a>FIELD_KIND
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [FIELD_KIND](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/field-kind).  
