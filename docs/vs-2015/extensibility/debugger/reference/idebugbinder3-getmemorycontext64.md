...
ms.locfileid: "42666632"
---
# <a name="idebugbinder3getmemorycontext64"></a>IDebugBinder3::GetMemoryContext64
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [IDebugBinder3::GetMemoryContext64](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugbinder3-getmemorycontext64).  
