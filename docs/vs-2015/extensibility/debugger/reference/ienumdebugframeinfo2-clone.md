...
ms.locfileid: "42631621"
---
# <a name="ienumdebugframeinfo2clone"></a>IEnumDebugFrameInfo2::Clone
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [IEnumDebugFrameInfo2::Clone](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugframeinfo2-clone).  
