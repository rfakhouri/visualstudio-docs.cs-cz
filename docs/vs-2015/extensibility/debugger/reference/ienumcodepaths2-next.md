...
ms.locfileid: "42666631"
---
# <a name="ienumcodepaths2next"></a>IEnumCodePaths2::Next
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [IEnumCodePaths2::Next](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumcodepaths2-next).  
