...
Nejnovější verzi tohoto tématu můžete najít v [IEnumDebugProcesses2::GetCount](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugprocesses2-getcount).  
