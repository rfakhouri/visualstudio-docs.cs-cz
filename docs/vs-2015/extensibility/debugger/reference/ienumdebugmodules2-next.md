...
ms.locfileid: "42672445"
---
# <a name="ienumdebugmodules2next"></a>IEnumDebugModules2::Next
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [IEnumDebugModules2::Next](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugmodules2-next).  
