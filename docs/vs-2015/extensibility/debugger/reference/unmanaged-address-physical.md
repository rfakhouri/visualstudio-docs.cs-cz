...
ms.locfileid: "42671406"
---
# <a name="unmanagedaddressphysical"></a>UNMANAGED_ADDRESS_PHYSICAL
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [UNMANAGED_ADDRESS_PHYSICAL](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/unmanaged-address-physical).  
