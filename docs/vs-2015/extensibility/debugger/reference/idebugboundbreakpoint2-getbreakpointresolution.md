...
Nejnovější verzi tohoto tématu můžete najít v [IDebugBoundBreakpoint2::GetBreakpointResolution](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugboundbreakpoint2-getbreakpointresolution).  
