...
ms.locfileid: "42667099"
---
# <a name="ienumdebugprocesses2clone"></a>IEnumDebugProcesses2::Clone
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [IEnumDebugProcesses2::Clone](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugprocesses2-clone).  
