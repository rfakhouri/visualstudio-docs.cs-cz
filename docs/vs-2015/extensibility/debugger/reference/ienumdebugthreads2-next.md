...
ms.locfileid: "42672364"
---
# <a name="ienumdebugthreads2next"></a>IEnumDebugThreads2::Next
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [IEnumDebugThreads2::Next](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumdebugthreads2-next).  
