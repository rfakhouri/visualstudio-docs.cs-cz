...
Nejnovější verzi tohoto tématu můžete najít v [IDebugCoreServer3::GetServerName](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugcoreserver3-getservername).  
