...
ms.locfileid: "42665899"
---
# <a name="event-sources-visual-studio-sdk"></a>Zdroje událostí (Visual Studio SDK)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [zdroje událostí (Visual Studio SDK)](https://docs.microsoft.com/visualstudio/extensibility/debugger/event-sources-visual-studio-sdk).  
