...
ms.locfileid: "42667544"
---
# <a name="creating-a-breakpoint"></a>Vytvoření zarážky
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [vytvořením zarážky](https://docs.microsoft.com/visualstudio/extensibility/debugger/creating-a-breakpoint).  
