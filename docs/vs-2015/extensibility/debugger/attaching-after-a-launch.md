...
Nejnovější verzi tohoto tématu můžete najít v [připojení po spuštění](https://docs.microsoft.com/visualstudio/extensibility/debugger/attaching-after-a-launch).  
