...
ms.locfileid: "42672171"
---
# <a name="taskstateexecuted-field"></a>TASK_STATE_EXECUTED – pole
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [task_state_executed – pole](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-executed-field).  
