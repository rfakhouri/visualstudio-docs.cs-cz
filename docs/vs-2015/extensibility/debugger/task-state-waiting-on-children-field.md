...
ms.locfileid: "42675311"
---
# <a name="taskstatewaitingonchildren-field"></a>TASK_STATE_WAITING_ON_CHILDREN – pole
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [task_state_waiting_on_children – pole](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-waiting-on-children-field).  
