...
ms.locfileid: "42633134"
---
# <a name="implementing-an-expression-evaluator"></a>Implementace vyhodnocovače výrazů
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [implementace vyhodnocovače výrazů](https://docs.microsoft.com/visualstudio/extensibility/debugger/implementing-an-expression-evaluator).  
