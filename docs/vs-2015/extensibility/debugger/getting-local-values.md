...
ms.locfileid: "42631367"
---
# <a name="getting-local-values"></a>Načtení místních hodnot
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [načítání lokální hodnoty](https://docs.microsoft.com/visualstudio/extensibility/debugger/getting-local-values).  
