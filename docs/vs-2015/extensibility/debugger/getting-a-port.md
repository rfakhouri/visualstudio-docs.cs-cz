...
ms.locfileid: "42666112"
---
# <a name="getting-a-port"></a>Získání portu
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [získání portu](https://docs.microsoft.com/visualstudio/extensibility/debugger/getting-a-port).  
