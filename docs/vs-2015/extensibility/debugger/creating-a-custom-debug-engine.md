...
ms.locfileid: "42627487"
---
# <a name="creating-a-custom-debug-engine"></a>Vytvoření vlastního ladicího stroje
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [vlastní Debug Engine vytvoření](https://docs.microsoft.com/visualstudio/extensibility/debugger/creating-a-custom-debug-engine).  
