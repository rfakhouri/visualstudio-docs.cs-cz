...
ms.locfileid: "42679447"
---
# <a name="debugger-concepts"></a>Koncepty ladicího programu
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [koncepty ladicího programu](https://docs.microsoft.com/visualstudio/extensibility/debugger/debugger-concepts).  
