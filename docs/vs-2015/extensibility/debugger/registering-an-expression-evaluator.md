...
Nejnovější verzi tohoto tématu můžete najít v [registrace vyhodnocovače výrazů](https://docs.microsoft.com/visualstudio/extensibility/debugger/registering-an-expression-evaluator).  
