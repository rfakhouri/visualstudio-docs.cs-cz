...
ms.locfileid: "42671239"
---
# <a name="evaluating-a-watch-expression"></a>Vyhodnocení výrazu kukátka
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [vyhodnocení výrazu kukátka](https://docs.microsoft.com/visualstudio/extensibility/debugger/evaluating-a-watch-expression).  
