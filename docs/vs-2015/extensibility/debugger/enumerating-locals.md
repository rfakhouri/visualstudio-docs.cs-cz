...
ms.locfileid: "42672895"
---
# <a name="enumerating-locals"></a>Vytváření výčtů pro místní hodnoty
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [výčet místních hodnot](https://docs.microsoft.com/visualstudio/extensibility/debugger/enumerating-locals).  
