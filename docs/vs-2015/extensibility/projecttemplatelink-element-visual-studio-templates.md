...
Nejnovější verzi tohoto tématu můžete najít v [ProjectTemplateLink – Element (šablony sady Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/projecttemplatelink-element-visual-studio-templates).  
