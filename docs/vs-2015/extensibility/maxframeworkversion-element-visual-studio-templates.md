...
Nejnovější verzi tohoto tématu můžete najít v [maxframeworkversion – Element (šablony sady Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/maxframeworkversion-element-visual-studio-templates).  
