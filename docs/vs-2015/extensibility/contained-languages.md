...
ms.locfileid: "42671079"
---
# <a name="contained-languages"></a>Omezením jazyky
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)] 

Nejnovější verzi tohoto tématu můžete najít v [jazyky obsažené](https://docs.microsoft.com/visualstudio/extensibility/contained-languages).  
