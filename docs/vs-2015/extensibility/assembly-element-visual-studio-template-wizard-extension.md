...
Nejnovější verzi tohoto tématu můžete najít v [Assembly – Element (Visual Studio rozšíření Průvodce pro šablony)](https://docs.microsoft.com/visualstudio/extensibility/assembly-element-visual-studio-template-wizard-extension).  
