...
ms.locfileid: "42672901"
---
# <a name="keybindings-element"></a>KeyBindings – element
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [keybindings – Element](https://docs.microsoft.com/visualstudio/extensibility/keybindings-element).  
