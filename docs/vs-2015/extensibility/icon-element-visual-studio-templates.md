...
ms.locfileid: "42673171"
---
# <a name="icon-element-visual-studio-templates"></a>Element ikony (šablony sady Visual Studio)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [Icon – Element (šablony sady Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/icon-element-visual-studio-templates).  
