...
ms.locfileid: "42672406"
---
# <a name="changing-the-text-of-a-menu-command"></a>Změna textu příkazu nabídky
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [Změna textu příkazu nabídky](https://docs.microsoft.com/visualstudio/extensibility/changing-the-text-of-a-menu-command).  
