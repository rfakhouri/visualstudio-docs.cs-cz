...
ms.locfileid: "42675884"
---
# <a name="opening-a-dynamic-tool-window"></a>Otevření dynamického panelu nástrojů
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [otevření dynamického panelu nástrojů](https://docs.microsoft.com/visualstudio/extensibility/opening-a-dynamic-tool-window).  
