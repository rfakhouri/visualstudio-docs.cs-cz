...
ms.locfileid: "42668860"
---
# <a name="installing-an-isolated-shell-application"></a>Instalace aplikací izolovaného prostředí
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [instalace izolované aplikační prostředí](https://docs.microsoft.com/visualstudio/extensibility/installing-an-isolated-shell-application).  
