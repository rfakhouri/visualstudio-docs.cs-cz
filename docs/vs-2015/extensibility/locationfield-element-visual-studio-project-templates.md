...
Nejnovější verzi tohoto tématu můžete najít v [locationfield – Element (šablony projektů Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/locationfield-element-visual-studio-project-templates).  
