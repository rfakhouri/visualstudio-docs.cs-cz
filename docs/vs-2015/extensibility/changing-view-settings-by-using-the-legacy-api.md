...
Nejnovější verzi tohoto tématu můžete najít v [Změna nastavení zobrazení pomocí starší verze rozhraní API](https://docs.microsoft.com/visualstudio/extensibility/changing-view-settings-by-using-the-legacy-api).  
