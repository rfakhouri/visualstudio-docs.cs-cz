...
Nejnovější verzi tohoto tématu můžete najít v [služba jazyka a editoru Rozšiřovací body](https://docs.microsoft.com/visualstudio/extensibility/language-service-and-editor-extension-points).  
