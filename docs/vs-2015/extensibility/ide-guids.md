...
ms.locfileid: "42667727"
---
# <a name="ide-guids"></a>Identifikátory GUID integrovaného vývojového prostředí
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [identifikátory GUID integrovaného vývojového prostředí](https://docs.microsoft.com/visualstudio/extensibility/ide-guids).  
...
## <a name="component-selector-page-guids"></a>Identifikátory GUID stránky výběr součástí  
