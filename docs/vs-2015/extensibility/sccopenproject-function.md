...
ms.locfileid: "42671175"
---
# <a name="sccopenproject-function"></a>SccOpenProject – funkce
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [sccopenproject – funkce](https://docs.microsoft.com/visualstudio/extensibility/sccopenproject-function).  
