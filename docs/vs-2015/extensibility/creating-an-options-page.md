...
ms.locfileid: "48880243"
---
# <a name="creating-an-options-page"></a>Vytvoření stránky Možnosti
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [vytvoření stránky možnosti](https://docs.microsoft.com/visualstudio/extensibility/creating-an-options-page).  
