...
ms.locfileid: "42672216"
---
# <a name="project-configuration-object"></a>Objekt konfigurace projektu
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [objekt konfigurace projektu](https://docs.microsoft.com/visualstudio/extensibility/internals/project-configuration-object).  
