...
ms.locfileid: "42669960"
---
# <a name="project-property-user-interface"></a>Uživatelské rozhraní vlastností projektu
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [uživatelské rozhraní vlastností projektu](https://docs.microsoft.com/visualstudio/extensibility/internals/project-property-user-interface).  
