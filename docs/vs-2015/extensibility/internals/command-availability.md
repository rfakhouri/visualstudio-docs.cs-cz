...
ms.locfileid: "42674504"
---
# <a name="command-availability"></a>Dostupnost příkazu
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [dostupnost příkazu](https://docs.microsoft.com/visualstudio/extensibility/internals/command-availability).  
