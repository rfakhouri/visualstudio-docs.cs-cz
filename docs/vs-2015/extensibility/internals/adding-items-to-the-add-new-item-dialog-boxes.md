...
Nejnovější verzi tohoto tématu můžete najít v [přidání položky, které chcete přidat novou položku dialogových oknech](https://docs.microsoft.com/visualstudio/extensibility/internals/adding-items-to-the-add-new-item-dialog-boxes).  
