...
Nejnovější verzi tohoto tématu můžete najít v [postupy: vygenerování informací registru pro instalační program](https://docs.microsoft.com/visualstudio/extensibility/internals/how-to-generate-registry-information-for-an-installer).  
