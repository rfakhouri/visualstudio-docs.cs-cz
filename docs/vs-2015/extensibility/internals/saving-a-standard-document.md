...
ms.locfileid: "42671905"
---
# <a name="saving-a-standard-document"></a>Uložení standardního dokumentu
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [ukládání standardní dokumentu](https://docs.microsoft.com/visualstudio/extensibility/internals/saving-a-standard-document).  
