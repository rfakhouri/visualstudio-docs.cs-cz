...
ms.locfileid: "42682052"
---
# <a name="image-library-viewer"></a>Prohlížeč knihovny obrázků
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [prohlížeč knihovny obrázků](https://docs.microsoft.com/visualstudio/extensibility/internals/image-library-viewer).  
