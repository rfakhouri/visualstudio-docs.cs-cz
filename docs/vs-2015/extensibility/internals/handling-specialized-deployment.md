...
ms.locfileid: "42671449"
---
# <a name="handling-specialized-deployment"></a>Zpracování specializovaného nasazení
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [zpracování specializovaná nasazení](https://docs.microsoft.com/visualstudio/extensibility/internals/handling-specialized-deployment).  
