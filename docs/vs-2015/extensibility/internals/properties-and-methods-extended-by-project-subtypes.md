...
Nejnovější verzi tohoto tématu můžete najít v [vlastnosti a metody rozšířené prostřednictvím podtypů projektů](https://docs.microsoft.com/visualstudio/extensibility/internals/properties-and-methods-extended-by-project-subtypes).  
