...
ms.locfileid: "42696304"
---
# <a name="saving-a-custom-document"></a>Uložení vlastního dokumentu
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [uložení dokumentu vlastní](https://docs.microsoft.com/visualstudio/extensibility/internals/saving-a-custom-document).  
