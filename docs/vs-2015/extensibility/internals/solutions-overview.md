...
ms.locfileid: "42668948"
---
# <a name="solutions-overview"></a>Přehled řešení
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [přehled řešení](https://docs.microsoft.com/visualstudio/extensibility/internals/solutions-overview).  
