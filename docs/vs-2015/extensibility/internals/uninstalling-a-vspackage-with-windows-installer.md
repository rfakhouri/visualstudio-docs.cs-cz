...
Nejnovější verzi tohoto tématu můžete najít v [odinstalace balíčku VSPackage pomocí Windows instalační program, který](https://docs.microsoft.com/visualstudio/extensibility/internals/uninstalling-a-vspackage-with-windows-installer).  
