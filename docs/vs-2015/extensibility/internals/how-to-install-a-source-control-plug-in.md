...
ms.locfileid: "42668637"
---
# <a name="how-to-install-a-source-control-plug-in"></a>Postupy: Instalace modulu Plug-in správy zdrojového kódu
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [postupy: Instalace modulu Plug-in zdrojového ovládacího prvku](https://docs.microsoft.com/visualstudio/extensibility/internals/how-to-install-a-source-control-plug-in).  
