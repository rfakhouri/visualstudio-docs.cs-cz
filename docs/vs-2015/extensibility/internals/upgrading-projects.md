...
ms.locfileid: "42633853"
---
# <a name="upgrading-projects"></a>Upgrade projektů
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [upgrade projektů](https://docs.microsoft.com/visualstudio/extensibility/internals/upgrading-projects).  
