...
ms.locfileid: "42670457"
---
# <a name="creating-options-pages"></a>Vytvoření stránek Možnosti
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [vytváření stránek možnosti](https://docs.microsoft.com/visualstudio/extensibility/internals/creating-options-pages).  
