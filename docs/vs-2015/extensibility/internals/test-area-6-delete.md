...
ms.locfileid: "42683260"
---
# <a name="test-area-6-delete"></a>Testovací oblast 6: Odstranění
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [testovací oblast 6: odstranění](https://docs.microsoft.com/visualstudio/extensibility/internals/test-area-6-delete).  
