...
ms.locfileid: "42673274"
---
# <a name="properties-display-grid"></a>Zobrazení mřížky okna Vlastnosti
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [zobrazení mřížky okna vlastnosti](https://docs.microsoft.com/visualstudio/extensibility/internals/properties-display-grid).  
