...
Nejnovější verzi tohoto tématu můžete najít v [testovací oblast 4: vrátit se změnami](https://docs.microsoft.com/visualstudio/extensibility/internals/test-area-4-check-in).  
