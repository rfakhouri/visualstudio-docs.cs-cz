...
ms.locfileid: "42686671"
---
# <a name="how-to-create-a-vsct-file"></a>Postupy: vytvoření. Soubor Vsct
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [postupy: vytvoření. Soubor Vsct](https://docs.microsoft.com/visualstudio/extensibility/internals/how-to-create-a-dot-vsct-file).  
