...
ms.locfileid: "42668542"
---
# <a name="delayed-document-loading"></a>Odložené načtení dokumentu
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [zpožděné načítání dokumentu](https://docs.microsoft.com/visualstudio/extensibility/internals/delayed-document-loading).  
