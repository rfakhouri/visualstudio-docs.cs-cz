...
ms.locfileid: "54754009"
---
# <a name="command-routing-in-vspackages"></a>Směrování příkazů v balíčcích VSPackage
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Příkaz se směruje do [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] na základě kontextu, ve kterém je spuštěn. Z pasivního počáteční kontextu se směruje do globální kontext.  
