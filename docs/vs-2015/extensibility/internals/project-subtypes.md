...
ms.locfileid: "42667513"
---
# <a name="project-subtypes"></a>Podtypy projektů
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [podtypů projektů](https://docs.microsoft.com/visualstudio/extensibility/internals/project-subtypes).  
