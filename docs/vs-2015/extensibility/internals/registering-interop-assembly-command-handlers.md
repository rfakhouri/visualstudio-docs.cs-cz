...
Nejnovější verzi tohoto tématu můžete najít v [registrace zprostředkovatele komunikace s objekty sestavení obslužné rutiny příkazů](https://docs.microsoft.com/visualstudio/extensibility/internals/registering-interop-assembly-command-handlers).  
