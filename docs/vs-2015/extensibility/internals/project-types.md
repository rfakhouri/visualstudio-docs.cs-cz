...
ms.locfileid: "42675347"
---
# <a name="project-types"></a>Typy projektů
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [typy projektů](https://docs.microsoft.com/visualstudio/extensibility/internals/project-types).  
