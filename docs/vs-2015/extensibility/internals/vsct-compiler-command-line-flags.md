...
ms.locfileid: "42683252"
---
# <a name="vsct-compiler-command-line-flags"></a>Příznaky příkazového řádku pro kompilátor VSCT
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [příznaky příkazového řádku kompilátoru VSCT](https://docs.microsoft.com/visualstudio/extensibility/internals/vsct-compiler-command-line-flags).  
...
## <a name="command-line-parameters"></a>Parametry příkazového řádku  
 Chcete-li zobrazit základní VSCT pomoc od [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] **příkaz** okno, přejděte na *cestu instalace sady Visual Studio SDK*\VisualStudioIntegration\Tools\Bin\ složky a typ:  
