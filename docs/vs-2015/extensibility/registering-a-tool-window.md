...
ms.locfileid: "42670669"
---
# <a name="registering-a-tool-window"></a>Registrace panelu nástrojů
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [registrace panelu nástrojů](https://docs.microsoft.com/visualstudio/extensibility/registering-a-tool-window).  
