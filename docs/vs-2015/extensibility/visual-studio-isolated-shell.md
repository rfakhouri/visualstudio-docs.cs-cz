...
ms.locfileid: "42678728"
---
# <a name="visual-studio-isolated-shell"></a>Izolované prostředí sady Visual Studio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [izolované prostředí sady Visual Studio](https://docs.microsoft.com/visualstudio/extensibility/visual-studio-isolated-shell).  
