...
ms.locfileid: "42676134"
---
# <a name="how-to-provide-a-service"></a>Postupy: poskytování služby
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [postupy: poskytování služby](https://docs.microsoft.com/visualstudio/extensibility/how-to-provide-a-service).  
