...
Nejnovější verzi tohoto tématu můžete najít v [CustomDataSignature – Element (šablony sady Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/customdatasignature-element-visual-studio-templates).  
