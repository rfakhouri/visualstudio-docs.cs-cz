...
ms.locfileid: "42667652"
---
# <a name="layout-for-visual-studio"></a>Rozložení pro sadu Visual Studio
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [rozložení pro sadu Visual Studio](https://docs.microsoft.com/visualstudio/extensibility/ux-guidelines/layout-for-visual-studio).  
...
## <a name="see-also"></a>Viz také  
 ...
 [Dialogová okna (Windows)](https://msdn.microsoft.com/library/windows/desktop/dn742499\(v=vs.85\).aspx)
