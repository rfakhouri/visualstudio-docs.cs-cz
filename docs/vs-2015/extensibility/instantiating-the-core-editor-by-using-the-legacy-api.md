...
Nejnovější verzi tohoto tématu můžete najít v [vytvoření instance Core pomocí editoru pomocí starší verze rozhraní API](https://docs.microsoft.com/visualstudio/extensibility/instantiating-the-core-editor-by-using-the-legacy-api).  
