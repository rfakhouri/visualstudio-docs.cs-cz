...
Nejnovější verzi tohoto tématu můžete najít v [vytváření ovládacího prvku Windows Forms panel nástrojů](https://docs.microsoft.com/visualstudio/extensibility/creating-a-windows-forms-toolbox-control).  
