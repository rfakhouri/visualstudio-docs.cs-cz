...
ms.locfileid: "42667562"
---
# <a name="sccinitialize-function"></a>SccInitialize – funkce
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [sccinitialize – funkce](https://docs.microsoft.com/visualstudio/extensibility/sccinitialize-function).  
