...
Nejnovější verzi tohoto tématu můžete najít v [určení popisovačů souborů pro přípony názvů souborů](https://docs.microsoft.com/visualstudio/extensibility/specifying-file-handlers-for-file-name-extensions).  
