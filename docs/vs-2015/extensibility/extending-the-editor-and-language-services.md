...
|[Návod: Osnova](../extensibility/walkthrough-outlining.md)|Ukazuje, jak přidat sbalení pro konkrétní druhy složené závorky.|  
...
|[MEF (Managed Extensibility Framework)](https://msdn.microsoft.com/library/6c61b4ec-c6df-4651-80f1-4854f8b14dde)|Poskytuje informace o Managed Extensibility Framework (MEF).|  
