...
### [Návod: Osnova](walkthrough-outlining.md)
...
#### [Postupy: Otevření editorů pro konkrétní projekt](how-to-open-project-specific-editors.md)
...
### [Návod: Přidání vlastního souboru XAML na úvodní stránku](walkthrough-adding-custom-xaml-to-the-start-page.md)
...
### [Návod: Ukládání uživatelských nastavení na úvodní stránce](walkthrough-saving-user-settings-on-a-start-page.md)
