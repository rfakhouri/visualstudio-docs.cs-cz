...
ms.locfileid: "42674664"
---
# <a name="getting-project-properties"></a>Načtení vlastností projektu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [získání vlastnosti projektu](https://docs.microsoft.com/visualstudio/extensibility/getting-project-properties).  
