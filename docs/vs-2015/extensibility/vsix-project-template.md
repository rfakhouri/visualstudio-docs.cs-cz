...
ms.locfileid: "42675053"
---
# <a name="vsix-project-template"></a>Šablona projektu VSIX
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [šablonou projektu VSIX](https://docs.microsoft.com/visualstudio/extensibility/vsix-project-template).  
