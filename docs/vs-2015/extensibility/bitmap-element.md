...
ms.locfileid: "42627891"
---
# <a name="bitmap-element"></a>Bitmap – element
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [rastrový obrázek Element](https://docs.microsoft.com/visualstudio/extensibility/bitmap-element).  
