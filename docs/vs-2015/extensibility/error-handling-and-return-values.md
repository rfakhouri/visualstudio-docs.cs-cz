...
ms.locfileid: "42675262"
---
# <a name="error-handling-and-return-values"></a>Zpracování chyb a návratových hodnot
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [zpracování chyb a vracet hodnoty](https://docs.microsoft.com/visualstudio/extensibility/error-handling-and-return-values).  
