...
ms.locfileid: "42672307"
---
# <a name="vsix-extension-schema-20-reference"></a>VSIX Extension Schema 2.0 – referenční informace
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [VSIX Extension Schema 2.0 referenční informace](https://docs.microsoft.com/visualstudio/extensibility/vsix-extension-schema-2-0-reference).  
