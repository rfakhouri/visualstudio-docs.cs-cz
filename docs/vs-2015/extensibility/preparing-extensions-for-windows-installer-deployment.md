...
Nejnovější verzi tohoto tématu můžete najít v [Příprava rozšíření pro Windows Installer nasazení](https://docs.microsoft.com/visualstudio/extensibility/preparing-extensions-for-windows-installer-deployment).  
