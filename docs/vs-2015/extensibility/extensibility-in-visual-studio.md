...
## <a name="create-your-own-sdks"></a>Vytvoření vlastní sady SDK
 Zjistěte, jak vytvořit balíček a nasadit vlastní sady SDK pro platformu a rozšíření: [Vytváření a Software Development Kit](../extensibility/creating-a-software-development-kit.md).
...
## <a name="azure-sdk"></a>Azure SDK
 Zjistěte, jak povolit Azure SDK: [Povolení sady Azure SDK](../extensibility/enabling-the-azure-sdk.md).
