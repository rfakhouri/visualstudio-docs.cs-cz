...
Nejnovější verzi tohoto tématu můžete najít v [– nejčastější dotazy: převádění doplňků na rozšíření VSPackage](https://docs.microsoft.com/visualstudio/extensibility/faq-converting-add-ins-to-vspackage-extensions).  
