...
ms.locfileid: "42670032"
---
# <a name="loading-vspackages"></a>Načítání rozšíření VSPackages
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [načítání rozšíření VSPackages](https://docs.microsoft.com/visualstudio/extensibility/loading-vspackages).  
