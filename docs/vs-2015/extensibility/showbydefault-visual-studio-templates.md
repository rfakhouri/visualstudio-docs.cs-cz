...
Nejnovější verzi tohoto tématu můžete najít v [ShowByDefault (šablony sady Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/showbydefault-visual-studio-templates).  
