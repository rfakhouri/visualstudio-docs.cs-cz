...
ms.locfileid: "42627876"
---
# <a name="sccpopulatelist-function"></a>SccPopulateList – funkce
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [sccpopulatelist – funkce](https://docs.microsoft.com/visualstudio/extensibility/sccpopulatelist-function).  
