...
Nejnovější verzi tohoto tématu můžete najít v [návod: použití klávesové zkratky s rozšířením editoru](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-using-a-shortcut-key-with-an-editor-extension).  
