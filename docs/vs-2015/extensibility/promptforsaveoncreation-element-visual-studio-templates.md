...
Nejnovější verzi tohoto tématu můžete najít v [PromptForSaveOnCreation – Element (šablony sady Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/promptforsaveoncreation-element-visual-studio-templates).  
