...
ms.locfileid: "42668822"
---
# <a name="buttons-element"></a>Buttons – element
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [Buttons – Element](https://docs.microsoft.com/visualstudio/extensibility/buttons-element).  
