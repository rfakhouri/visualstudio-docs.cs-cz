...
Nejnovější verzi tohoto tématu můžete najít v [vytvoření grafického doplňku zobrazení, příkazů a nastavení](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-creating-a-view-adornment-commands-and-settings-column-guides).  
...
```  
 ...
 Většina tento kód jenom vytvoří a analyzuje nastavení formátu: "RGB (\<int >,\<int >,\<int >) \<int >, \<int >;...".  Celých čísel na konci je založen na jedničce sloupce, ve kterém chcete vodítka sloupců.  Rozšíření vodítka sloupců zachytí všechna nastavení v řetězci hodnotu jedno nastavení.  
...
## <a name="see-also"></a>Viz také  
 ...
 [Rozšíření pro Editor a služeb jazyka](../extensibility/extending-the-editor-and-language-services.md)   
