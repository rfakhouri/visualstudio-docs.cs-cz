...
Nejnovější verzi tohoto tématu můžete najít v [postupy: použití pravidla na základě kontextu uživatelského rozhraní pro rozšíření sady Visual Studio](https://docs.microsoft.com/visualstudio/extensibility/how-to-use-rule-based-ui-context-for-visual-studio-extensions).  
...
1.  Nastavit zarážku <xref:Microsoft.VisualStudio.Shell.Package.Initialize%2A> metody.  
  
2.  Sestavení TestPackage a spusťte ladění.  
  
3.  Vytvoření projektu nebo některou aplikaci otevřete.  
  
4.  Vyberte libovolný soubor s příponou jinou než .config. By neměl být zarážka dosažena.  
