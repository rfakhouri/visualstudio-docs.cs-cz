...
ms.locfileid: "42628234"
---
# <a name="sccqueryinfo-function"></a>SccQueryInfo – funkce
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [sccqueryinfo – funkce](https://docs.microsoft.com/visualstudio/extensibility/sccqueryinfo-function).  
