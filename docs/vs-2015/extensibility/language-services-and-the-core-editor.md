...
ms.locfileid: "42696272"
---
# <a name="language-services-and-the-core-editor"></a>Jazykové služby a základní Editor
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [jazykové služby a základní Editor](https://docs.microsoft.com/visualstudio/extensibility/language-services-and-the-core-editor).  
