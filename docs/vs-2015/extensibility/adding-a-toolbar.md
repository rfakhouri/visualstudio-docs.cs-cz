...
ms.locfileid: "42672934"
---
# <a name="adding-a-toolbar"></a>Přidání panelu nástrojů
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [přidání panelu nástrojů](https://docs.microsoft.com/visualstudio/extensibility/adding-a-toolbar).  
