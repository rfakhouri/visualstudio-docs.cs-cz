...
ms.locfileid: "42667051"
---
# <a name="getting-started-with-the-vsix-project-template"></a>Začínáme se šablonou projektu VSIX
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [Začínáme s šablonou projektu VSIX](https://docs.microsoft.com/visualstudio/extensibility/getting-started-with-the-vsix-project-template).  
