...
ms.locfileid: "42674253"
---
# <a name="creating-an-extension-with-a-vspackage"></a>Vytváření rozšíření pomocí VSPackage
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [vytváření rozšíření pomocí VSPackage](https://docs.microsoft.com/visualstudio/extensibility/creating-an-extension-with-a-vspackage).  
