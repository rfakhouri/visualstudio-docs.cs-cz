...
Nejnovější verzi tohoto tématu můžete najít v [výběr šablony řešení jazyka specifického pro doménu](https://docs.microsoft.com/visualstudio/modeling/choosing-a-domain-specific-language-solution-template).  
