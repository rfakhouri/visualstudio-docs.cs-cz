...
ms.locfileid: "42669528"
---
# <a name="properties-of-port-shapes"></a>Vlastnosti obrazců portů
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [vlastnosti obrazců portů](https://docs.microsoft.com/visualstudio/modeling/properties-of-port-shapes).  
