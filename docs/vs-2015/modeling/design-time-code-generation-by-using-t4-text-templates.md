...
Nejnovější verzi tohoto tématu můžete najít v [vytvoření kódu v době návrhu pomocí textových šablon T4](https://docs.microsoft.com/visualstudio/modeling/design-time-code-generation-by-using-t4-text-templates).  
