...
Nejnovější verzi tohoto tématu můžete najít v [definování příkazu nabídky v diagramu modelování](https://docs.microsoft.com/visualstudio/modeling/define-a-menu-command-on-a-modeling-diagram).  
