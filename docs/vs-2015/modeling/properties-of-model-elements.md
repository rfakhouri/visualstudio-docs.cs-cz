...
ms.locfileid: "42674885"
---
# <a name="properties-of-model-elements"></a>Vlastnosti elementů modelu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [vlastnosti elementů modelu](https://docs.microsoft.com/visualstudio/modeling/properties-of-model-elements).  
