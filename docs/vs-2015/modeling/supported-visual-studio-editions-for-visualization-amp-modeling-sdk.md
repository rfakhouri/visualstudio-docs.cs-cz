---
title: Verze Visual Studia podporované pro vizualizaci &amp; Modeling SDK | Dokumentace Microsoftu
ms.custom: ''
ms.date: 2018-06-30
...
Nejnovější verzi tohoto tématu můžete najít v [podporované edice sady Visual Studio pro vizualizaci &amp; Modeling SDK](https://docs.microsoft.com/visualstudio/modeling/supported-visual-studio-editions-for-visualization-amp-modeling-sdk).  
  
Toto jsou seznamy edice sady Visual Studio, které jsou podporovány [!INCLUDE[dsl](../includes/dsl-md.md)] v prostředí pro vytváření a nasazení. Další informace o těchto vydáních najdete v tématu Microsoft [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] [středisko pro vývojáře](http://go.microsoft.com/fwlink/?LinkId=75628).  
