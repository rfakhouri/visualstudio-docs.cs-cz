...
ms.locfileid: "42668963"
---
# <a name="defining-shapes-and-connectors"></a>Definování obrazců a konektorů
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [definování obrazců a konektorů](https://docs.microsoft.com/visualstudio/modeling/defining-shapes-and-connectors).  
