...
ms.locfileid: "42629851"
---
# <a name="display-a-uml-model-on-diagrams"></a>Zobrazení modelu UML v diagramech
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [zobrazení modelu UML v diagramech](https://docs.microsoft.com/visualstudio/modeling/display-a-uml-model-on-diagrams).  
