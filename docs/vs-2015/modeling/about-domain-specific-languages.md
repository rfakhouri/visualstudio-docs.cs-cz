...
ms.locfileid: "42672203"
---
# <a name="about-domain-specific-languages"></a>O jazycích specifických pro konkrétní domény
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [o jazycích specifických pro doménu](https://docs.microsoft.com/visualstudio/modeling/about-domain-specific-languages).  
