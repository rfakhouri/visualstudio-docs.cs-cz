...
ms.locfileid: "42627996"
---
# <a name="getting-started-with-domain-specific-languages"></a>Začínáme s jazyky specifickými pro doménu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [Začínáme s jazyky specifickými pro doménu](https://docs.microsoft.com/visualstudio/modeling/getting-started-with-domain-specific-languages).  
