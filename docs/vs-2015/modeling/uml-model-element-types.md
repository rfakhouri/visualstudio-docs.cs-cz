...
ms.locfileid: "42677360"
---
# <a name="uml-model-element-types"></a>Typy prvků modelu UML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [typy prvků modelu UML](https://docs.microsoft.com/visualstudio/modeling/uml-model-element-types).  
