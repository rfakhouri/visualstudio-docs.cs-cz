...
## <a name="compileroptions-attribute"></a>Atribut compilerOptions  
 ...
 Platné hodnoty:  
 Všechny platné parametry kompilátoru. Další informace najdete v tématu [jazyka C# možnosti kompilátoru seřazené podle kategorie](https://msdn.microsoft.com/library/96437ecc-6502-4cd3-b070-e9386a298e83) a [jazyka Visual Basic možnosti kompilátoru seřazené podle kategorie](https://msdn.microsoft.com/library/fbe36f7a-7cfa-4f77-a8d4-2be5958568e3).  
