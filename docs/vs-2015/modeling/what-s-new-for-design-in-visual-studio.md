...
##  <a name="VersionSupport"></a> Podporované verze pro nástroje architektury a modelování  
 Visual Studio je k dispozici v několika verzích. Ne všechny tyto poskytovat podporu pro architektury a nástroje pro modelování. V následující tabulce jsou uvedeny dostupnost jednotlivých nástrojích.  
  
|**Funkce**|**Enterprise**|**Professional**|**Community**|**Express**|  
|-----------------|--------------------|----------------------|-------------------|-----------------|  
|**Mapy kódu**|Ano|Viz Poznámka: (1)|-|-|  
...
|**Klonování kódu**|Ano|-|-|-|  
 ...
 Poznámka: (1): Podporuje pouze pro čtení map kódu, filtrování mapy kódu, přidání nové obecné uzly a vytvoření nového orientovaného grafu z výběru.
