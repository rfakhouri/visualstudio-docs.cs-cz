...
ms.locfileid: "42628034"
---
# <a name="uml-component-diagrams-guidelines"></a>Diagramy komponent UML: Pokyny
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [diagramy komponent UML: pokyny](https://docs.microsoft.com/visualstudio/modeling/uml-component-diagrams-guidelines).  
