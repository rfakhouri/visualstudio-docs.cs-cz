...
Nejnovější verzi tohoto tématu můžete najít v [vytvoření jazyka specifického pro doménu Windows Forms-Based](https://docs.microsoft.com/visualstudio/modeling/creating-a-windows-forms-based-domain-specific-language).  
