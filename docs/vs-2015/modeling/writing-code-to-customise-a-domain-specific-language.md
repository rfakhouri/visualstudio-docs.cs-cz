...
Nejnovější verzi tohoto tématu můžete najít v [psaní kódu pro úpravu jazyka specifického pro doménu specifického](https://docs.microsoft.com/visualstudio/modeling/writing-code-to-customise-a-domain-specific-language).  
