...
|[Definování omezení ověřování pro modely UML](../modeling/define-validation-constraints-for-uml-models.md)|ValidationContext|Můžete definovat pravidla, která vám pomohou Ujistěte se, že model odpovídá zadaným omezením ověření.|  
