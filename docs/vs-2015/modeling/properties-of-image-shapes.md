...
ms.locfileid: "42676916"
---
# <a name="properties-of-image-shapes"></a>Vlastnosti obrazových obrazců
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [vlastnosti obrazových obrazců](https://docs.microsoft.com/visualstudio/modeling/properties-of-image-shapes).  
