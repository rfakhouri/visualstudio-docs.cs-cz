...
ms.locfileid: "42666530"
---
# <a name="navigate-relationships-with-the-uml-api"></a>Procházení vztahů pomocí rozhraní API UML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [procházení vztahů pomocí rozhraní API UML](https://docs.microsoft.com/visualstudio/modeling/navigate-relationships-with-the-uml-api).  
