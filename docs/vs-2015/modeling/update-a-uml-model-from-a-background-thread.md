...
ms.locfileid: "42675933"
---
# <a name="update-a-uml-model-from-a-background-thread"></a>Aktualizace modelu UML z vlákna na pozadí
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [aktualizace modelu UML z vlákna na pozadí](https://docs.microsoft.com/visualstudio/modeling/update-a-uml-model-from-a-background-thread).  
