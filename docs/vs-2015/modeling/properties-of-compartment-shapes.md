...
ms.locfileid: "42627485"
---
# <a name="properties-of-compartment-shapes"></a>Vlastnosti obrazců prostoru
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [vlastnosti obrazců prostoru](https://docs.microsoft.com/visualstudio/modeling/properties-of-compartment-shapes).  
