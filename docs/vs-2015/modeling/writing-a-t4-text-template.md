...
ms.locfileid: "42667720"
---
# <a name="writing-a-t4-text-template"></a>Tvorba textové šablony T4
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [vytvoření textové šablony T4](https://docs.microsoft.com/visualstudio/modeling/writing-a-t4-text-template).  
...
```  
 ...
 Seznam maker naleznete v tématu [běžné Macros for Build Commands and Properties](http://msdn.microsoft.com/library/239bd708-2ea9-4687-b264-043f1febf98b).  
