...
ms.locfileid: "42667060"
---
# <a name="navigating-and-updating-a-model-in-program-code"></a>Navigace v modelu a aktualizace modelu v kódu programu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [navigace a aktualizace modelu v programovém kódu](https://docs.microsoft.com/visualstudio/modeling/navigating-and-updating-a-model-in-program-code).  
...
## <a name="in-this-topic"></a>V tomto tématu  
 ...
 [Proveďte změny v transakci](#transaction)  
  
 [Vytváření elementů modelu](#elements)  
  
 [Vytváření vztahů propojení](#links)  
  
 [Odstranění prvků](#deleteelements)  
  
 [Odstranění vztahů propojení](#deletelinks)  
  
 [Změna uspořádání odkazy tohoto vztahu](#reorder)  
  
 [Zámky](#locks)  
  
 [Kopírování a vkládání](#copy)  
  
 [Procházení a aktualizace diagramů](#diagrams)  
...
### <a name="presentation-elements"></a>Elementy prezentace  
 ![Diagram tříd základních typů tvaru a element](../modeling/media/dslshapesandelements.png "DSLshapesAndElements")  
