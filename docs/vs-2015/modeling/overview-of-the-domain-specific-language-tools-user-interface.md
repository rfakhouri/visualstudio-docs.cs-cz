...
Nejnovější verzi tohoto tématu můžete najít v [přehled uživatelského rozhraní nástrojů jazyka specifického pro doménu](https://docs.microsoft.com/visualstudio/modeling/overview-of-the-domain-specific-language-tools-user-interface).  
