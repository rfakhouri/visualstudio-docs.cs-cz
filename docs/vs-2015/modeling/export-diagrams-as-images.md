---
title: Exportování diagramů jako obrázků | Dokumentace Microsoftu
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "42676063"
---
# <a name="export-diagrams-as-images"></a>Exportovat diagramy jako obrázky
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [exportování diagramů jako obrázků](https://docs.microsoft.com/visualstudio/modeling/export-diagrams-as-images).  
...
### <a name="to-export-an-image-as-part-of-an-automated-process"></a>Chcete-li exportovat obrázek jako součást automatizovaného procesu  
  
-   Zobrazit [diagramy UML exportovat do souborů obrázků](../modeling/export-uml-diagrams-to-image-files.md).  
