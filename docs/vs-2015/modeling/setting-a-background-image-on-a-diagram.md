...
ms.locfileid: "42668184"
---
# <a name="setting-a-background-image-on-a-diagram"></a>Nastavení obrázku pozadí v diagramu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [nastavení obrázku pozadí v diagramu](https://docs.microsoft.com/visualstudio/modeling/setting-a-background-image-on-a-diagram).  
