...
Nejnovější verzi tohoto tématu můžete najít v [jak: vyhledejte aplikaci aktualizace programově pomocí rozhraní API nasazení ClickOnce](https://docs.microsoft.com/visualstudio/deployment/how-to-check-for-application-updates-programmatically-using-the-clickonce-deployment-api).  
