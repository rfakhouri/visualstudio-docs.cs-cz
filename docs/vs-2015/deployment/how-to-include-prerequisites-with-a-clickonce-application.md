...
Nejnovější verzi tohoto tématu můžete najít v [jak: zahrnují předpokladů s aplikací ClickOnce](https://docs.microsoft.com/visualstudio/deployment/how-to-include-prerequisites-with-a-clickonce-application).  
