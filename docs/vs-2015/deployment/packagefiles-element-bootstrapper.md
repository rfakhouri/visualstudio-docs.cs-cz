...
ms.locfileid: "42668932"
---
# <a name="ltpackagefilesgt-element-bootstrapper"></a>&lt;PackageFiles&gt; – Element (zaváděcí nástroj)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [ &lt;PackageFiles&gt; – Element (zaváděcí nástroj)](https://docs.microsoft.com/visualstudio/deployment/packagefiles-element-bootstrapper).  
