...
Nejnovější verzi tohoto tématu můžete najít v [postupy: instalace předpokladů s aplikací ClickOnce](https://docs.microsoft.com/visualstudio/deployment/how-to-install-prerequisites-with-a-clickonce-application).  
