...
Nejnovější verzi tohoto tématu můžete najít v [postupy: konfigurace ClickOnce důvěřovat chování výzvy](https://docs.microsoft.com/visualstudio/deployment/how-to-configure-the-clickonce-trust-prompt-behavior).  
