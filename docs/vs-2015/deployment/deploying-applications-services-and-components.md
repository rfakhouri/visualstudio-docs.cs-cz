...
|**Nasazení aplikace nebo služby LightSwitch:** Po vytvoření aplikací a služeb OData pomocí aplikace LightSwitch, můžete je nasadit na webový server nebo do služby Microsoft Azure.|[Nasazení aplikací LightSwitch](http://msdn.microsoft.com/library/4818d933-295c-4ecc-9148-7ad9ca28dcdb)|  
|**Publikování aplikace pro SharePoint:** Publikování aplikace pro SharePoint pro Office Store nebo do katalogu aplikací pro interní organizace.|[Publikování aplikace pro SharePoint pomocí sady Visual Studio](http://msdn.microsoft.com/library/office/jj220044\(v=office.15\).aspx)|  
|**Publikování aplikace pro Office:** Publikování aplikace pro Office na Office Store nebo do katalogu aplikací pro interní organizace.|[Publikování aplikací pro Office](http://msdn.microsoft.com/library/office/fp123515.aspx)|  
|**Nasazení služby WCF:** Když nasadíte na webový server služby WCF RIA můžete používat další aplikace.|[Řešení služeb WCF RIA nasazení](http://msdn.microsoft.com/library/ff426912\(v=vs.91\).aspx)|  
|**Nasazení služby OData:** Ostatní aplikace můžou využívat služby OData, které můžete nasadit na webový server.|[Nasazení služby OData](http://msdn.microsoft.com/library/hh973447.aspx)|  
...
|**Nasazení aplikace v jazyce Visual C++:** Modul runtime Visual C++ v aplikaci můžete nasadit s použitím centrálního nasazení, místní nasazení nebo statického propojení.|[Nasazení nativních aplikací klasické pracovní plochy (Visual C++)](http://msdn.microsoft.com/library/zebw5zk9.aspx)|  
