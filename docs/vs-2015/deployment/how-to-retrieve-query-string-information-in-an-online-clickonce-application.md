...
Nejnovější verzi tohoto tématu můžete najít v [postupy: načtení informací řetězce dotazu do Online aplikace ClickOnce](https://docs.microsoft.com/visualstudio/deployment/how-to-retrieve-query-string-information-in-an-online-clickonce-application).  
