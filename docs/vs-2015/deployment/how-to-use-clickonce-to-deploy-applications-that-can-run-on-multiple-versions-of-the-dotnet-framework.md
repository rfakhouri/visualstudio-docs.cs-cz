...
Nejnovější verzi tohoto tématu můžete najít v [postupy: použití ClickOnce k nasazení aplikace, že se můžou spouštět na více verzích rozhraní .NET Framework](https://docs.microsoft.com/visualstudio/deployment/how-to-use-clickonce-to-deploy-applications-that-can-run-on-multiple-versions-of-the-dotnet-framework).  
