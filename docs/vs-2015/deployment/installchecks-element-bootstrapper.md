...
ms.locfileid: "42683359"
---
# <a name="ltinstallchecksgt-element-bootstrapper"></a>&lt;InstallChecks&gt; – Element (zaváděcí nástroj)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [ &lt;InstallChecks&gt; – Element (zaváděcí nástroj)](https://docs.microsoft.com/visualstudio/deployment/installchecks-element-bootstrapper).  
