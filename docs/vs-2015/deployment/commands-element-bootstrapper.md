...
ms.locfileid: "42670767"
---
# <a name="ltcommandsgt-element-bootstrapper"></a>&lt;Příkazy&gt; – Element (zaváděcí nástroj)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [ &lt;příkazy&gt; – Element (zaváděcí nástroj)](https://docs.microsoft.com/visualstudio/deployment/commands-element-bootstrapper).  
