...
ms.locfileid: "42670172"
---
# <a name="clickonce-application-manifest"></a>ClickOnce – manifest aplikace 
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [Manifest aplikace ClickOnce](https://docs.microsoft.com/visualstudio/deployment/clickonce-application-manifest).  
