...
Nejnovější verzi tohoto tématu můžete najít v [ &lt;assemblyIdentity&gt; – Element (nasazení ClickOnce)](https://docs.microsoft.com/visualstudio/deployment/assemblyidentity-element-clickonce-deployment).  
