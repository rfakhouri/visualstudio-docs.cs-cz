...
Nejnovější verzi tohoto tématu můžete najít v [postupy: opětovné podepsání aplikace a manifesty nasazení](https://docs.microsoft.com/visualstudio/deployment/how-to-re-sign-application-and-deployment-manifests).  
