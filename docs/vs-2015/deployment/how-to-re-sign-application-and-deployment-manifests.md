...
## <a name="re-signing-the-application-and-deployment-manifests"></a>Aplikace a nasazení opětovné podepisování manifestů  
 Tento postup předpokládá, že jste už provedli změny do souboru manifestu aplikace (.manifest). Další informace najdete v tématu [jak: Změnit vlastnosti nasazení](https://msdn.microsoft.com/66052a3a-8127-4964-8147-2477ef5d1472).  
