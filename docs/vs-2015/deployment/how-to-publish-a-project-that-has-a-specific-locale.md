...
Nejnovější verzi tohoto tématu můžete najít v [postupy: publikování projektu s konkrétním národním](https://docs.microsoft.com/visualstudio/deployment/how-to-publish-a-project-that-has-a-specific-locale).  
