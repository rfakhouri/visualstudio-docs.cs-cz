...
ms.locfileid: "42666119"
---
# <a name="clickonce-reference"></a>Referenční dokumentace technologie ClickOnce
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [referenční dokumentace technologie ClickOnce](https://docs.microsoft.com/visualstudio/deployment/clickonce-reference).  
