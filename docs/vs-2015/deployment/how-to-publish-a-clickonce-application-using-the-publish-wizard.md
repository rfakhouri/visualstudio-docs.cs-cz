...
Nejnovější verzi tohoto tématu můžete najít v [postupy: publikování aplikace ClickOnce pomocí Průvodce publikováním](https://docs.microsoft.com/visualstudio/deployment/how-to-publish-a-clickonce-application-using-the-publish-wizard).  
