...
ms.locfileid: "42678712"
---
# <a name="ltfilegt-element-clickonce-application"></a>&lt;soubor&gt; – Element (aplikace ClickOnce)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [ &lt;souboru&gt; – Element (aplikace ClickOnce)](https://docs.microsoft.com/visualstudio/deployment/file-element-clickonce-application).  
