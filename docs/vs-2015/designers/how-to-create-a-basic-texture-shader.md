...
ms.locfileid: "42685082"
---
# <a name="how-to-create-a-basic-texture-shader"></a>Postupy: Vytvoření shaderu základní textury
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [postupy: vytvoření shaderu základní textury](https://docs.microsoft.com/visualstudio/designers/how-to-create-a-basic-texture-shader).  
