...
ms.locfileid: "42676951"
---
# <a name="working-with-shaders"></a>Práce se shadery
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [práce se shadery](https://docs.microsoft.com/visualstudio/designers/working-with-shaders).  
