...
ms.locfileid: "42672107"
---
# <a name="l2dbformxamlcs-source-code"></a>Zdrojový kód L2DBForm.XAML.cs
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [zdrojový kód L2DBForm.xaml.cs](https://docs.microsoft.com/visualstudio/designers/l2dbform-xaml-cs-source-code).  
