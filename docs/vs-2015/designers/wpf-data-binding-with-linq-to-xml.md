...
ms.locfileid: "42673420"
---
# <a name="wpf-data-binding-with-linq-to-xml"></a>Datová vazba WPF s LINQ to XML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [vazby dat k WPF s LINQ to XML](https://docs.microsoft.com/visualstudio/designers/wpf-data-binding-with-linq-to-xml).  
