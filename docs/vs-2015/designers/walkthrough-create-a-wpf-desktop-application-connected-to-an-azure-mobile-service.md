...
Nejnovější verzi tohoto tématu můžete najít v [návod: vytvoření aplikace WPF plochy připojené k mobilní službě Azure](https://docs.microsoft.com/visualstudio/designers/walkthrough-create-a-wpf-desktop-application-connected-to-an-azure-mobile-service).  
