...
|[Postupy: Vytvoření shaderu přechodu na základě geometrie](../designers/how-to-create-a-geometry-based-gradient-shader.md)|Ukazuje shader, který upravuje barvu podle geometrii celého objektu a použije ho k objektu.|  
