...
Nejnovější verzi tohoto tématu můžete najít v [vložení ovládacích prvků a změna jejich chování v Návrháři XAML](https://docs.microsoft.com/visualstudio/designers/insert-controls-and-modify-their-behavior-in-xaml-designer).  
