...
Nejnovější verzi tohoto tématu můžete najít v [postupy: vytvoření shaderu přechodu na základě geometrie](https://docs.microsoft.com/visualstudio/designers/how-to-create-a-geometry-based-gradient-shader).  
