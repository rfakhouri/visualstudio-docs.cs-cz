...
|||  
|-|-|  
|Chci pustit do práce …|[Návod: Moje první Desktopová aplikace WPF](../designers/walkthrough-my-first-wpf-desktop-application2.md)<br /><br /> [Návod: Vytvoření aplikace WPF plochy připojené k mobilní službě Azure](../designers/walkthrough-create-a-wpf-desktop-application-connected-to-an-azure-mobile-service.md)|  
