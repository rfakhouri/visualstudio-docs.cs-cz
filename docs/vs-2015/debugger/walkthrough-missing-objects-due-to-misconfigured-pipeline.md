...
Nejnovější verzi tohoto tématu můžete najít v [návod: chybějící objekty z důvodu chybně nakonfigurovaný kanál](https://docs.microsoft.com/visualstudio/debugger/graphics/walkthrough-missing-objects-due-to-misconfigured-pipeline).  
