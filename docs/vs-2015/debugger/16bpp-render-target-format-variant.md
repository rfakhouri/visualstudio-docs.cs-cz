...
ms.locfileid: "42669109"
---
# <a name="16bpp-render-target-format-variant"></a>Varianta 16bpp vykreslování cílového formátu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [16bpp vykreslování cílového formátu typu Variant](https://docs.microsoft.com/visualstudio/debugger/graphics/16bpp-render-target-format-variant).  
