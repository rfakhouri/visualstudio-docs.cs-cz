...
ms.locfileid: "42629048"
---
# <a name="hlsl-shader-debugger"></a>Ladicí program shaderu HLSL
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [ladicí program shaderu HLSL](https://docs.microsoft.com/visualstudio/debugger/graphics/hlsl-shader-debugger).  
