...
ms.locfileid: "42667324"
---
# <a name="debugging-web-applications-and-script"></a>Ladění webových aplikací a skriptu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [ladění webových aplikací a skriptu](https://docs.microsoft.com/visualstudio/debugger/debugging-web-applications-and-script).  
