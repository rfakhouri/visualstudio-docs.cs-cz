...
ms.locfileid: "42666342"
---
# <a name="graphics-log-document"></a>Dokument grafických protokolů
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [dokument grafických protokolů](https://docs.microsoft.com/visualstudio/debugger/graphics/graphics-log-document).  
