...
Nejnovější verzi tohoto tématu můžete najít v [ladicího programu vzorový kód pro navigaci (Xaml a C#)](https://docs.microsoft.com/visualstudio/debugger/debugger-navigation-sample-code-xaml-and-csharp).  
