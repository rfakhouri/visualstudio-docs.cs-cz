...
ms.locfileid: "42696548"
---
# <a name="how-to-write-a-visualizer"></a>Postupy: Zápis vizualizéru
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [postupy: zápis Vizualizéru](https://docs.microsoft.com/visualstudio/debugger/how-to-write-a-visualizer).  
