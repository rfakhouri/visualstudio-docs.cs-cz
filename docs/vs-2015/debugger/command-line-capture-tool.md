...
ms.locfileid: "42666436"
---
# <a name="command-line-capture-tool"></a>Nástroj příkazového řádku pro zachytávání
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [nástroj příkazového řádku pro zachycení](https://docs.microsoft.com/visualstudio/debugger/graphics/command-line-capture-tool).  
