...
ms.locfileid: "42668997"
---
# <a name="supported-code-changes-c"></a>Podporované změny kódu (C#)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [podporované změny kódu (C#)](https://docs.microsoft.com/visualstudio/debugger/supported-code-changes-csharp).  
