...
Nejnovější verzi tohoto tématu můžete najít v [postupy: spuštění pracovního procesu v rámci uživatelský účet](https://docs.microsoft.com/visualstudio/debugger/how-to-run-the-worker-process-under-a-user-account).  
