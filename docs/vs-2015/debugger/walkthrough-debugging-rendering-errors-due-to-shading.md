...
Nejnovější verzi tohoto tématu můžete najít v [návod: ladění vykreslování chyby kvůli stínování](https://docs.microsoft.com/visualstudio/debugger/graphics/walkthrough-debugging-rendering-errors-due-to-shading).  
