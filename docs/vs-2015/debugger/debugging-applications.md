...
|||  
|-|-|  
|[Ladění aplikací pro Windows Store a univerzálních aplikací pro Windows](../debugger/debugging-windows-store-and-windows-universal-apps.md)|Popisuje, jak ladit aplikace pro Windows Store a Windows Universal apps.|  
...
|[Diagnostika grafiky (ladění grafiky DirectX)](../debugger/visual-studio-graphics-diagnostics.md)|Popisuje, jak ladění grafiky DirectX.|  
|[Ladění webových aplikací a skriptu](../debugger/debugging-web-applications-and-script.md)|Popisuje, jak ladit aplikace pro Web, ASP.NET a AJAX.|  
