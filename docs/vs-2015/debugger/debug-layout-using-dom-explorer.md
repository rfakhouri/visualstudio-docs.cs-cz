...
ms.locfileid: "42673847"
---
# <a name="debug-layout-using-dom-explorer"></a>Ladění rozložení pomocí průzkumníka modelu DOM
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [ladění rozložení pomocí Průzkumníka modelu DOM](https://docs.microsoft.com/visualstudio/debugger/debug-layout-using-dom-explorer).  
