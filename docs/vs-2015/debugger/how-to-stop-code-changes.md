...
ms.locfileid: "42667501"
---
# <a name="how-to-stop-code-changes"></a>Postupy: Zastavení změn kódu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [postupy: zastavení změn kódu](https://docs.microsoft.com/visualstudio/debugger/how-to-stop-code-changes).  
