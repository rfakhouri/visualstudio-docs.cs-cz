...
ms.locfileid: "42668295"
---
# <a name="how-to-debug-injected-code"></a>Postupy: Ladění vloženého kódu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [postupy: ladění vloženého kódu](https://docs.microsoft.com/visualstudio/debugger/how-to-debug-injected-code).  
