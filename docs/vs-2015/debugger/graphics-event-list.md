...
ms.locfileid: "42629260"
---
# <a name="graphics-event-list"></a>Seznam událostí grafiky
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [seznam událostí grafiky](https://docs.microsoft.com/visualstudio/debugger/graphics/graphics-event-list).  
