...
Nejnovější verzi tohoto tématu můžete najít v [návod: chybějící objekty z důvodu vrcholu stínování](https://docs.microsoft.com/visualstudio/debugger/graphics/walkthrough-missing-objects-due-to-vertex-shading).  
