...
Nejnovější verzi tohoto tématu můžete najít v [postupy: ladění aplikace částečné důvěryhodnosti](https://docs.microsoft.com/visualstudio/debugger/how-to-debug-a-partial-trust-application).  
