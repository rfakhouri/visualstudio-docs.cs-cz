...
Nejnovější verzi tohoto tématu můžete najít v [konfigurace brány Windows Firewall pro vzdálené ladění](https://docs.microsoft.com/visualstudio/debugger/configure-the-windows-firewall-for-remote-debugging).  
