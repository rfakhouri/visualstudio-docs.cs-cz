...
ms.locfileid: "42671887"
---
# <a name="using-saved-intellitrace-data"></a>Použití dat uložených nástrojem IntelliTrace
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [použití uložených dat řešení IntelliTrace](https://docs.microsoft.com/visualstudio/debugger/using-saved-intellitrace-data).  
