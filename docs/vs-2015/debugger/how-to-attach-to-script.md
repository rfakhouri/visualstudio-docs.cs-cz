...
ms.locfileid: "42672929"
---
# <a name="how-to-attach-to-script"></a>Postupy: Připojení ke skriptu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [postupy: připojení ke skriptu](https://docs.microsoft.com/visualstudio/debugger/how-to-attach-to-script).  
