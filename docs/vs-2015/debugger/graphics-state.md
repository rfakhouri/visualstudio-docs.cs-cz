...
ms.locfileid: "42667422"
---
# <a name="graphics-state"></a>Stav grafiky
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [stav grafiky](https://docs.microsoft.com/visualstudio/debugger/graphics/graphics-state).  
