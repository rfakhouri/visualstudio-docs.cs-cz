...
Nejnovější verzi tohoto tématu můžete najít v [Začínáme se službou Diagnostika grafiky sady Visual Studio](https://docs.microsoft.com/visualstudio/debugger/graphics/getting-started-with-visual-studio-graphics-diagnostics).  
