...
ms.locfileid: "42628905"
---
# <a name="preparing-to-debug-aspnet"></a>Příprava na ladění technologie ASP.NET
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [Probíhá příprava na ladění technologie ASP.NET](https://docs.microsoft.com/visualstudio/debugger/preparing-to-debug-aspnet).  
