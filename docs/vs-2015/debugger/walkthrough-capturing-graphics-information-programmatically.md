...
Nejnovější verzi tohoto tématu můžete najít v [názorný postup: zachycení informací grafiky programově](https://docs.microsoft.com/visualstudio/debugger/graphics/walkthrough-capturing-graphics-information-programmatically).  
