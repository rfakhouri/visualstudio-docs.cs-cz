 ...
 **Skrýt Spy ++**  
 Odebere hlavního okna nástroje Spy ++ a zůstane **WindowSearch** dialogové okno viditelné nad vaší aplikace.  
  
 **Popisovač**  
 Jedinečné ID v okně hledání.  
  
 **Titulek**  
 Text v titulek okna pro hledání.  
  
 **Třída**  
 Třída v okně hledání.  
