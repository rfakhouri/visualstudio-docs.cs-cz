...
7. Klikněte na tlačítko **aktualizovat Windows app** tlačítka, která vypadá přibližně takto: ![Aktualizovat aplikaci Windows](../debugger/media/js-refresh.png "JS_Refresh"). (Nebo stisknutím klávesy F4).  
