...
ms.locfileid: "42667861"
---
# <a name="graphics-pixel-history"></a>Historie pixelů grafiky
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [historie pixelů grafiky](https://docs.microsoft.com/visualstudio/debugger/graphics/graphics-pixel-history).  
