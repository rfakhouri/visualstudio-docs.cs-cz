...
Nejnovější verzi tohoto tématu můžete najít v [hledání paměti nevracení pomocí CRT knihovny](https://docs.microsoft.com/visualstudio/debugger/finding-memory-leaks-using-the-crt-library).  
