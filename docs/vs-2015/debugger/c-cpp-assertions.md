...
ms.locfileid: "42632270"
---
# <a name="cc-assertions"></a>Kontrolní výrazy jazyka C/C++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [kontrolní výrazy jazyka C/C++](https://docs.microsoft.com/visualstudio/debugger/c-cpp-assertions).  
...
|– Makro|Výsledek|  
|-----------|------------|  
|`_ASSERT`|Pokud se zadaný výraz nevyhodnotí jako FALSE, souboru název a číslo řádku `_ASSERT`.|`_ASSERTE`|  
