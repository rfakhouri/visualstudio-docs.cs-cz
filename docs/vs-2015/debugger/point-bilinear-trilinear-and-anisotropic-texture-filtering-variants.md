...
Nejnovější verzi tohoto tématu můžete najít v [bod, bilineární, Trilinear a varianty Anisotropního filtrování textur](https://docs.microsoft.com/visualstudio/debugger/graphics/point-bilinear-trilinear-and-anisotropic-texture-filtering-variants).  
