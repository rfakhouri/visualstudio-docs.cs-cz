...
ms.locfileid: "42679496"
---
# <a name="macros-for-reporting"></a>Makra pro vytváření sestav
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [makra pro vytváření sestav](https://docs.microsoft.com/visualstudio/debugger/macros-for-reporting).  
