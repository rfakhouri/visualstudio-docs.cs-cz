...
ms.locfileid: "42696580"
---
# <a name="spy-toolbar"></a>Panel nástrojů nástroje Spy++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [panel nástrojů nástroje Spy ++](https://docs.microsoft.com/visualstudio/debugger/spy-increment-toolbar).  
