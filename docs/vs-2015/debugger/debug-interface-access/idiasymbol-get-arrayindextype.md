...
Nejnovější verzi tohoto tématu můžete najít v [idiasymbol::get_arrayindextype –](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiasymbol-get-arrayindextype).  
