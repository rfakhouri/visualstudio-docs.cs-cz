...
Nejnovější verzi tohoto tématu můžete najít v [idiainjectedsource::get_objectfilename –](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiainjectedsource-get-objectfilename).  
