...
Nejnovější verzi tohoto tématu můžete najít v [idiaenumsymbolsbyaddr::clone –](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiaenumsymbolsbyaddr-clone).  
