# [Přístup k rozhraní ladění SDK](debug-interface-access-sdk.md)
## [Začínáme](getting-started-debug-interface-access-sdk.md)
### [Přehled](overview-debug-interface-access-sdk.md)
### [Dotazování na soubor .Pdb](querying-the-dot-pdb-file.md)
## [Symboly a značky symbolů](symbols-and-symbol-tags.md)
### [Umístění symbolů](symbol-locations.md)
### [Lexikální hierarchie typů symbolů](lexical-hierarchy-of-symbol-types.md)
#### [Poznámka](annotation.md)
#### [Blok](block.md)
#### [Kompilant](compiland.md)
#### [CompilandDetails](compilanddetails.md)
#### [CompilandEnv](compilandenv.md)
#### [Vlastní (Přístup k rozhraní ladění SDK)](custom-debug-interface-access-sdk.md)
#### [Data (Přístup k rozhraní ladění SDK)](data-debug-interface-access-sdk.md)
#### [Exe](exe.md)
#### [Funkce (Přístup k rozhraní ladění SDK)](function-debug-interface-access-sdk.md)
#### [FuncDebugEnd](funcdebugend.md)
#### [FuncDebugStart](funcdebugstart.md)
#### [Popisek (Přístup k rozhraní ladění SDK)](label-debug-interface-access-sdk.md)
#### [PublicSymbol](publicsymbol.md)
#### [Převod](thunk.md)
#### [UsingNameSpace](usingnamespace.md)
### [Hierarchie tříd typů symbolů](class-hierarchy-of-symbol-types.md)
#### [ArrayType](arraytype.md)
#### [BaseClass](baseclass.md)
#### [BaseType](basetype.md)
#### [CustomType](customtype.md)
#### [Rozměr](dimension.md)
#### [Výčet (Přístup k rozhraní ladění SDK)](enum-debug-interface-access-sdk.md)
#### [Friend (Přístup k rozhraní ladění SDK)](friend-debug-interface-access-sdk.md)
#### [FunctionArgType](functionargtype.md)
#### [FunctionType](functiontype.md)
#### [ManagedType](managedtype.md)
#### [PointerType](pointertype.md)
#### [Typedef (Přístup k rozhraní ladění SDK)](typedef-debug-interface-access-sdk.md)
#### [UDT](udt.md)
#### [VTable](vtable.md)
#### [VTableShape](vtableshape.md)
## [Referenční informace](debug-interface-access-sdk-reference.md)
### [Rozhraní (Přístup k rozhraní ladění SDK)](interfaces-debug-interface-access-sdk.md)
...
### [Výčty a struktury](enumerations-and-structures.md)
#### [BasicType – výčet](basictype.md)
#### [CV_access_e – výčet](cv-access-e.md)
#### [CV_call_e – výčet](cv-call-e.md)
#### [CV_CFL_LANG – výčet](cv-cfl-lang.md)
#### [CV_CPU_TYPE_e – výčet](cv-cpu-type-e.md)
#### [CV_HREG_e – výčet](cv-hreg-e.md)
#### [DataKind – výčet](datakind.md)
#### [DiaAddressMapEntry – struktura](diaaddressmapentry.md)
#### [LocationType – výčet](locationtype.md)
#### [MemoryTypeEnum – výčet](memorytypeenum.md)
#### [NameSearchOptions – výčet](namesearchoptions.md)
#### [StackFrameTypeEnum – výčet](stackframetypeenum.md)
#### [SymTagEnum – výčet](symtagenum.md)
#### [THUNK_ORDINAL – výčet](thunk-ordinal.md)
#### [UdtKind – výčet](udtkind.md)
### [Konstanty (Přístup k rozhraní ladění SDK)](constants-debug-interface-access-sdk.md)
## [Dia2dump – ukázka](dia2dump-sample.md)
## [Dia2dump.cpp – zdrojový soubor](dia2dump-cpp-source-file.md)
