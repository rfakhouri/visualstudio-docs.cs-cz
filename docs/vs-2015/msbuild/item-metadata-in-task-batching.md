...
ms.locfileid: "42671362"
---
# <a name="item-metadata-in-task-batching"></a>Metadata položek v dávkování úloh
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [Metadata položek v dávkování úloh](https://docs.microsoft.com/visualstudio/msbuild/item-metadata-in-task-batching).  
