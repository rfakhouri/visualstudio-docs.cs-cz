...
ms.locfileid: "42669846"
---
# <a name="msbuild-batching"></a>Dávkování nástroje MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [dávkování nástroje MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-batching).  
