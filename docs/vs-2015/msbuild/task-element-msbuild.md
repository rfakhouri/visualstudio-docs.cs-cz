...
ms.locfileid: "42673025"
---
# <a name="task-element-msbuild"></a>Task – element (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [Task – Element (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/task-element-msbuild).  
