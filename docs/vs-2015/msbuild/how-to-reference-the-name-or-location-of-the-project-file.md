...
Nejnovější verzi tohoto tématu můžete najít v [postupy: odkazování na název nebo umístění souboru projektu](https://docs.microsoft.com/visualstudio/msbuild/how-to-reference-the-name-or-location-of-the-project-file).  
