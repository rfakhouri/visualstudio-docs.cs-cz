...
Nejnovější verzi tohoto tématu můžete najít v [referenční dokumentace schématu souboru projektu MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-project-file-schema-reference).  
