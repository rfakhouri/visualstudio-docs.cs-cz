...
ms.locfileid: "42668949"
---
# <a name="taskbody-element-msbuild"></a>TaskBody – element (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [taskbody – Element (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/taskbody-element-msbuild).  
