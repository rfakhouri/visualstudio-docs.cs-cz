...
ms.locfileid: "42674499"
---
# <a name="logging-in-a-multi-processor-environment"></a>Protokolování v prostředí s více procesory
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [protokolování v prostředí s více procesory](https://docs.microsoft.com/visualstudio/msbuild/logging-in-a-multi-processor-environment).  
