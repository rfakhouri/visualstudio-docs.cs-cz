...
ms.locfileid: "42674192"
---
# <a name="build-loggers"></a>Protokolovací nástroje sestavení
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [Protokolovací nástroje sestavení](https://docs.microsoft.com/visualstudio/msbuild/build-loggers).  
