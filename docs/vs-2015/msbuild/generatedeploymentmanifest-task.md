...
ms.locfileid: "42671068"
---
# <a name="generatedeploymentmanifest-task"></a>GenerateDeploymentManifest – úloha
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [generatedeploymentmanifest – úloha](https://docs.microsoft.com/visualstudio/msbuild/generatedeploymentmanifest-task).  
