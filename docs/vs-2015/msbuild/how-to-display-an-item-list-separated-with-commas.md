...
Nejnovější verzi tohoto tématu můžete najít v [postupy: zobrazení položce seznamu oddělených čárkami](https://docs.microsoft.com/visualstudio/msbuild/how-to-display-an-item-list-separated-with-commas).  
