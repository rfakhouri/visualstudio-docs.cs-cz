...
ms.locfileid: "42683189"
---
# <a name="msbuild-inline-tasks"></a>Vložené úlohy nástroje MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [vložené úlohy nástroje MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-inline-tasks).  
