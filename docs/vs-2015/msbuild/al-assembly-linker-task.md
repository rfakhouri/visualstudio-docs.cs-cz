...
|Parametr|Popis|  
|---------------|-----------------|  
|`AlgorithmID`|Volitelné `String` parametru.<br /><br /> Určuje algoritmus, který vytvoří hodnotu hash pro všechny soubory ve vícesouborovém sestavení s výjimkou souboru, který obsahuje manifest sestavení. Další informace najdete v tématu v dokumentaci `/algid` možnost [Al.exe (Linker sestavení)](https://msdn.microsoft.com/library/b5382965-0053-47cf-b92f-862860275a01).|  
|`BaseAddress`|Volitelné `String` parametru.<br /><br /> Určuje adresu, ve kterém budou načteny knihovny DLL v počítači uživatele za běhu. Aplikace se načítají rychleji při zadání základní adresy knihoven DLL, namísto dovolení operačnímu systému přemisťovat knihovny DLL v prostoru procesu. Tento parametr odpovídá možnosti propojovacího [address] v [Al.exe (Linker sestavení)](https://msdn.microsoft.com/library/b5382965-0053-47cf-b92f-862860275a01).|  
|`CompanyName`|Volitelné `String` parametru.<br /><br /> Určuje řetězec pro `Company` pole v sestavení. Další informace najdete v tématu v dokumentaci `/comp[any]` možnost [Al.exe (Linker sestavení)](https://msdn.microsoft.com/library/b5382965-0053-47cf-b92f-862860275a01).|  
|`Configuration`|Volitelné `String` parametru.<br /><br /> Určuje řetězec pro `Configuration` pole v sestavení. Další informace najdete v tématu v dokumentaci `/config[uration]` možnost [Al.exe (Linker sestavení)](https://msdn.microsoft.com/library/b5382965-0053-47cf-b92f-862860275a01).|  
|`Copyright`|Volitelné `String` parametru.<br /><br /> Určuje řetězec pro `Copyright` pole v sestavení. Další informace najdete v tématu v dokumentaci `/copy[right]` možnost [Al.exe (Linker sestavení)](https://msdn.microsoft.com/library/b5382965-0053-47cf-b92f-862860275a01).|  
|`Culture`|Volitelné `String` parametru.<br /><br /> Určuje řetězec jazykové verze přidružený k sestavení. Další informace najdete v tématu v dokumentaci `/c[ulture]` možnost [Al.exe (Linker sestavení)](https://msdn.microsoft.com/library/b5382965-0053-47cf-b92f-862860275a01).|  
|`DelaySign`|Volitelné `Boolean` parametru.<br /><br /> `true` Chcete-li umístit pouze veřejný klíč sestavení; `false` plně podepsat sestavení. Další informace najdete v tématu v dokumentaci `/delay[sign]` možnost [Al.exe (Linker sestavení)](https://msdn.microsoft.com/library/b5382965-0053-47cf-b92f-862860275a01).|  
|`Description`|Volitelné `String` parametru.<br /><br /> Určuje řetězec pro `Description` pole v sestavení. Další informace najdete v tématu v dokumentaci `/descr[iption]` možnost [Al.exe (Linker sestavení)](https://msdn.microsoft.com/library/b5382965-0053-47cf-b92f-862860275a01).|  
...
|`Title`|Volitelné `String` parametru.<br /><br /> Určuje řetězec pro `Title` pole v sestavení. Další informace najdete v tématu v dokumentaci `/title` možnost [Al.exe (Linker sestavení)](https://msdn.microsoft.com/library/b5382965-0053-47cf-b92f-862860275a01).|  
...
|`Trademark`|Volitelné `String` parametru.<br /><br /> Určuje řetězec pro `Trademark` pole v sestavení. Další informace najdete v tématu v dokumentaci `/trade[mark]` možnost [Al.exe (Linker sestavení)](https://msdn.microsoft.com/library/b5382965-0053-47cf-b92f-862860275a01).|  
|`Version`|Volitelné `String` parametru.<br /><br /> Určuje informace o verzi pro toto sestavení. Formát řetězce je *major.minor.build.revision*. Výchozí hodnota je 0. Další informace najdete v tématu v dokumentaci `/v[ersion]` možnost [Al.exe (Linker sestavení)](https://msdn.microsoft.com/library/b5382965-0053-47cf-b92f-862860275a01).|  
|`Win32Icon`|Volitelné `String` parametru.<br /><br /> Vloží soubor .ico do sestavení. Soubor .ico dává výstupnímu souboru požadovaný vzhled v Průzkumníku souborů. Tento parametr `/win32icon` možnost [Al.exe (Linker sestavení)](https://msdn.microsoft.com/library/b5382965-0053-47cf-b92f-862860275a01).|  
|`Win32Resource`|Volitelné `String` parametru.<br /><br /> Vloží prostředek systému Win32 (soubor .res) do výstupního souboru. Další informace najdete v tématu v dokumentaci `/win32res` možnost [Al.exe (Linker sestavení)](https://msdn.microsoft.com/library/b5382965-0053-47cf-b92f-862860275a01).|  
