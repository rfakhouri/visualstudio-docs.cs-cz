...
ms.locfileid: "42696545"
---
# <a name="msbuild-items"></a>Položky nástroje MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [položky nástroje MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-items).  
