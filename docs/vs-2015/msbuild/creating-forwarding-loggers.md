...
ms.locfileid: "42665950"
---
# <a name="creating-forwarding-loggers"></a>Vytváření předávajících (sekundárních) protokolovacích nástrojů
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [vytváření předávání protokolovacích nástrojů](https://docs.microsoft.com/visualstudio/msbuild/creating-forwarding-loggers).  
