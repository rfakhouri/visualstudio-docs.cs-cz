...
ms.locfileid: "42667625"
---
# <a name="item-element-msbuild"></a>Item – prvek (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [Item – Element (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/item-element-msbuild).  
