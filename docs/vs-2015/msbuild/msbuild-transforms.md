...
ms.locfileid: "42627827"
---
# <a name="msbuild-transforms"></a>Transformace nástroje MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [transformace nástroje MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-transforms).  
