...
ms.locfileid: "42676337"
---
# <a name="registerassembly-task"></a>RegisterAssembly – úloha
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [registerassembly – úloha](https://docs.microsoft.com/visualstudio/msbuild/registerassembly-task).  
