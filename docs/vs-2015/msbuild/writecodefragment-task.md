...
ms.locfileid: "42677310"
---
# <a name="writecodefragment-task"></a>WriteCodeFragment – úloha
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [writecodefragment – úloha](https://docs.microsoft.com/visualstudio/msbuild/writecodefragment-task).  
