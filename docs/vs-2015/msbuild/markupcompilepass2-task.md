...
ms.locfileid: "42679469"
---
# <a name="markupcompilepass2-task"></a>MarkupCompilePass2 – úloha
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [markupcompilepass2 – úloha](https://docs.microsoft.com/visualstudio/msbuild/markupcompilepass2-task).  
