...
ms.locfileid: "42629709"
---
# <a name="otherwise-element-msbuild"></a>Otherwise – element (MSBuild)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [jinak – Element (MSBuild)](https://docs.microsoft.com/visualstudio/msbuild/otherwise-element-msbuild).  
