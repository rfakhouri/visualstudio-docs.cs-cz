...
ms.locfileid: "42632379"
---
# <a name="msbuild-task-reference"></a>Referenční dokumentace úlohy nástroje MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [– referenční dokumentace úlohy nástroje MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-task-reference).  
