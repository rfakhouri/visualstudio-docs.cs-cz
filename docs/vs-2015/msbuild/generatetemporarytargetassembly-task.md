...
ms.locfileid: "42628821"
---
# <a name="generatetemporarytargetassembly-task"></a>GenerateTemporaryTargetAssembly – úloha
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [generatetemporarytargetassembly – úloha](https://docs.microsoft.com/visualstudio/msbuild/generatetemporarytargetassembly-task).  
