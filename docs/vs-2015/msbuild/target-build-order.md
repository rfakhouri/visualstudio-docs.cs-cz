...
ms.locfileid: "42670214"
---
# <a name="target-build-order"></a>Pořadí sestavení cílů
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [pořadí sestavení cílů](https://docs.microsoft.com/visualstudio/msbuild/target-build-order).  
