---
title: Vytváření a Správa databází a aplikací datové vrstvy v sadě Visual Studio | Dokumentace Microsoftu
ms.custom: ''
ms.date: 2018-06-30
...
Nejnovější verzi tohoto tématu můžete najít v [vytváření a Správa databází a aplikací datové vrstvy](https://docs.microsoft.com/visualstudio/data-tools/creating-and-managing-databases-and-data-tier-applications-in-visual-studio).  
