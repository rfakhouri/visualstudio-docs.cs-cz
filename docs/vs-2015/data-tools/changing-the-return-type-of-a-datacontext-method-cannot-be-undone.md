...
Nejnovější verzi tohoto tématu můžete najít v [změnu návratového typu metody DataContext nejde vrátit zpět](https://docs.microsoft.com/visualstudio/data-tools/changing-the-return-type-of-a-datacontext-method-cannot-be-undone).  
