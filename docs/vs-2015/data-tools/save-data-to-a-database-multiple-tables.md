...
ms.locfileid: "42667124"
---
# <a name="save-data-to-a-database-multiple-tables"></a>Uložení dat do databáze (více tabulek)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [ukládání dat do databáze (více tabulek)](https://docs.microsoft.com/visualstudio/data-tools/save-data-to-a-database-multiple-tables).  
