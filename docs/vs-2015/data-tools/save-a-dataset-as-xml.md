...
Nejnovější verzi tohoto tématu můžete najít v [uložení datové sady ve formátu XML](https://docs.microsoft.com/visualstudio/data-tools/save-a-dataset-as-xml).  
