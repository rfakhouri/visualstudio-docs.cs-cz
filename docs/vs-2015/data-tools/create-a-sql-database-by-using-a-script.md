...
ms.locfileid: "42629436"
---
# <a name="create-a-sql-database-by-using-a-script"></a>Vytvoření databáze SQL pomocí skriptu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [vytvoření databáze SQL pomocí skriptu](https://docs.microsoft.com/visualstudio/data-tools/create-a-sql-database-by-using-a-script).  
