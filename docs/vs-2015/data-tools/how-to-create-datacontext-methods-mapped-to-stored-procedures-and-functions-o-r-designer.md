...
Nejnovější verzi tohoto tématu můžete najít v [jak: metod vytvoření DataContext namapovaných na uložené procedury a funkce (O R Designer)](https://docs.microsoft.com/visualstudio/data-tools/how-to-create-datacontext-methods-mapped-to-stored-procedures-and-functions-o-r-designer).  
