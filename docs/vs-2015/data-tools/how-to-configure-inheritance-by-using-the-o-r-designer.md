...
Nejnovější verzi tohoto tématu můžete najít v [postupy: Konfigurace dědičnosti pomocí Návrháře relací](https://docs.microsoft.com/visualstudio/data-tools/how-to-configure-inheritance-by-using-the-o-r-designer).  
