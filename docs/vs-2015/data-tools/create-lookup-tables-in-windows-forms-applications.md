...
Nejnovější verzi tohoto tématu můžete najít v [vytváření vyhledávacích tabulek v aplikacích Windows Forms](https://docs.microsoft.com/visualstudio/data-tools/create-lookup-tables-in-windows-forms-applications).  
