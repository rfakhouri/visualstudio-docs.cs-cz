...
Nejnovější verzi tohoto tématu můžete najít v [návod: přizpůsobení vložit, aktualizovat a odstraňovat chování tříd entit](https://docs.microsoft.com/visualstudio/data-tools/walkthrough-customizing-the-insert-update-and-delete-behavior-of-entity-classes).  
