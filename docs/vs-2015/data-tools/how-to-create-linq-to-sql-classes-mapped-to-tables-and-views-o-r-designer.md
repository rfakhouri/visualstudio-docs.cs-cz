...
Nejnovější verzi tohoto tématu můžete najít v [postupy: vytvoření třídy LINQ to SQL namapovaných na tabulky a zobrazení (O R Designer)](https://docs.microsoft.com/visualstudio/data-tools/how-to-create-linq-to-sql-classes-mapped-to-tables-and-views-o-r-designer).
