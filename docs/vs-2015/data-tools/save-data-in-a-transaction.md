...
ms.locfileid: "42667198"
---
# <a name="save-data-in-a-transaction"></a>Ukládání dat do transakce
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [uložit data v rámci transakce](https://docs.microsoft.com/visualstudio/data-tools/save-data-in-a-transaction).  
