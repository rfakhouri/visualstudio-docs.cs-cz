...
ms.locfileid: "42672699"
---
# <a name="relationships-in-datasets"></a>Vztahy v datových sadách
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [vztahy v datových sadách](https://docs.microsoft.com/visualstudio/data-tools/relationships-in-datasets).  
