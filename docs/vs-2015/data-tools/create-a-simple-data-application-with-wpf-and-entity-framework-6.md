...
Nejnovější verzi tohoto tématu můžete najít v [vytvoření jednoduché datové aplikace s použitím WPF a Entity Framework 6](https://docs.microsoft.com/visualstudio/data-tools/create-a-simple-data-application-with-wpf-and-entity-framework-6).  
