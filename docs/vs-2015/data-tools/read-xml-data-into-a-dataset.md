...
ms.locfileid: "42628313"
---
# <a name="read-xml-data-into-a-dataset"></a>Načtení dat XML do datové sady
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [XML pro čtení dat do datové sady](https://docs.microsoft.com/visualstudio/data-tools/read-xml-data-into-a-dataset).  
