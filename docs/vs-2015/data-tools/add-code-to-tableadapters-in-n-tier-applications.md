...
Nejnovější verzi tohoto tématu můžete najít v [přidejte kód do prvků TableAdapters ve víceúrovňových aplikacích](https://docs.microsoft.com/visualstudio/data-tools/add-code-to-tableadapters-in-n-tier-applications).  
