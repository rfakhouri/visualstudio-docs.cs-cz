...
Nejnovější verzi tohoto tématu můžete najít v [postupy: Přidání, aktualizace nebo odebrání odkazu na datovou službu WCF](https://docs.microsoft.com/visualstudio/data-tools/how-to-add-update-or-remove-a-wcf-data-service-reference).  
