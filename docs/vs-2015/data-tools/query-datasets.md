...
ms.locfileid: "42669082"
---
# <a name="query-datasets"></a>Datové sady dotazů
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [dotazování datových sad](https://docs.microsoft.com/visualstudio/data-tools/query-datasets).  
