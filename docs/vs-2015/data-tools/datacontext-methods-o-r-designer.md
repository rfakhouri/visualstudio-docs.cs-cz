...
ms.locfileid: "42673479"
---
# <a name="datacontext-methods-or-designer"></a>Metody DataContext (O/R Designer)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [metod DataContext (O R Designer)](https://docs.microsoft.com/visualstudio/data-tools/datacontext-methods-o-r-designer).  
