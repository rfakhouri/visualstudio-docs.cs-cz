...
Nejnovější verzi tohoto tématu můžete najít v [návod: vytvoření jednoduché služby WCF ve Windows Forms](https://docs.microsoft.com/visualstudio/data-tools/walkthrough-creating-a-simple-wcf-service-in-windows-forms).  
