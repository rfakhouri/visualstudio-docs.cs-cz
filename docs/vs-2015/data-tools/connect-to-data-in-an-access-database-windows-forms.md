...
Nejnovější verzi tohoto tématu můžete najít v [připojení k datům v databázi aplikace Access (Windows Forms)](https://docs.microsoft.com/visualstudio/data-tools/connect-to-data-in-an-access-database-windows-forms).  
