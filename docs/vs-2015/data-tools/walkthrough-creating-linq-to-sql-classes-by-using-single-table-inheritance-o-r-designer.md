...
Nejnovější verzi tohoto tématu můžete najít v [návod: vytvoření třídy LINQ to SQL děděním pomocí jedné tabulky (O R Designer)](https://docs.microsoft.com/visualstudio/data-tools/walkthrough-creating-linq-to-sql-classes-by-using-single-table-inheritance-o-r-designer).  
