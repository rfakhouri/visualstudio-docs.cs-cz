...
ms.locfileid: "42674045"
---
# <a name="add-new-connections"></a>Přidat nové připojení
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [přidat nové připojení](https://docs.microsoft.com/visualstudio/data-tools/add-new-connections).  
