...
ms.locfileid: "42666559"
---
# <a name="add-new-data-sources"></a>Přidat nové zdroje dat
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [přidat nové zdroje dat](https://docs.microsoft.com/visualstudio/data-tools/add-new-data-sources).  
