...
Nejnovější verzi tohoto tématu můžete najít v [vývoj Multiplatformních mobilních řešení v sadě Visual Studio](https://docs.microsoft.com/visualstudio/cross-platform/cross-platform-mobile-development-in-visual-studio).  
