...
ms.locfileid: "42632609"
---
# <a name="working-with-xml-data"></a>Práce s daty XML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [práci s daty XML](https://docs.microsoft.com/visualstudio/xml-tools/working-with-xml-data).  
...
## <a name="in-this-section"></a>V tomto oddílu  
 ...
 Popisuje Průzkumníka schémat XML a práce se schématy schématu XML definice jazyk (XSD).  
...
## <a name="related-sections"></a>Související oddíly  
 ...
 Poskytuje vysvětlení návrhových nástrojů pro vytváření datových sad.  
