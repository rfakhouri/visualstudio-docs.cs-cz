...
ms.locfileid: "42668413"
---
# <a name="editing-xslt-style-sheets"></a>Úpravy šablon stylů XSLT
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [úpravy šablon stylů XSLT](https://docs.microsoft.com/visualstudio/xml-tools/editing-xslt-style-sheets).  
