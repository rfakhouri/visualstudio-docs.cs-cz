...
## <a name="watermark"></a>Vodoznak  
 V podokně vodoznak obsahuje seznam odkazů na všech XSD Návrhář zobrazení, XML Editor a Průzkumník schémat XML. Pokud sadě schémat obsahuje chyby, zobrazí se na konci seznamu následující text: "K zobrazení a opravte chyby v sadě pomocí seznamu chyb."  
