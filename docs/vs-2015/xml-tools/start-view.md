---
title: Počáteční zobrazení | Dokumentace Microsoftu
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "42667355"
---
# <a name="start-view"></a>Počáteční zobrazení
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [zobrazení Start](https://docs.microsoft.com/visualstudio/xml-tools/start-view).  
...
Počáteční zobrazení je výchozím bodem pro Návrhář schématu XML (XSD). Když vytvoříte nový soubor XSD, zobrazí se zpočátku počáteční zobrazení.  
 ...
 ![Zobrazení spuštění návrháře schémat XML](../xml-tools/media/xsddesigner-startview.gif "XSDDesigner_StartView")  
  
## <a name="watermark"></a>Vodoznak  
 V podokně vodoznak obsahuje seznam odkazů na všech XSD Návrhář zobrazení, XML Editor a Průzkumník schémat XML. Pokud sadě schémat obsahuje chyby, na konci seznamu se zobrazí následující text: "K zobrazení a opravte chyby v sadě pomocí seznamu chyb."  
...
## <a name="toolbar"></a>Panel nástrojů  
 ...
 ![Panel nástrojů návrháře schémat XML](../xml-tools/media/xsdstartviewtoolbar.gif "XSDStartViewToolbar")  
