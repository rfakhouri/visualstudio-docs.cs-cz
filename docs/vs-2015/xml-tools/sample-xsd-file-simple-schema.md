...
ms.locfileid: "42668614"
---
# <a name="sample-xsd-file-simple-schema"></a>Ukázkový soubor XSD: Jednoduché schéma
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [ukázkový soubor XSD: jednoduché schéma](https://docs.microsoft.com/visualstudio/xml-tools/sample-xsd-file-simple-schema).  
