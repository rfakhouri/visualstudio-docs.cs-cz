---
title: 'Ukázkový soubor XSD: Relace | Dokumentace Microsoftu'
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "42628258"
---
# <a name="sample-xsd-file-relationships"></a>Ukázkový soubor XSD: relace
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [ukázkový soubor XSD: relace](https://docs.microsoft.com/visualstudio/xml-tools/sample-xsd-file-relationships).  
