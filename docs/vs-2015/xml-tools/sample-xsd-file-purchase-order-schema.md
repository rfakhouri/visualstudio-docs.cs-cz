...
ms.locfileid: "42672546"
---
# <a name="sample-xsd-file-purchase-order-schema"></a>Ukázkový soubor XSD: Nákupní pořadí schématu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [ukázkový soubor XSD: nákupní pořadí schématu](https://docs.microsoft.com/visualstudio/xml-tools/sample-xsd-file-purchase-order-schema).  
