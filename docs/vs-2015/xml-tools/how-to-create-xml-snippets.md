...
ms.locfileid: "42685106"
---
# <a name="how-to-create-xml-snippets"></a>Postupy: vytváření fragmentů XML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [postupy: vytváření fragmentů XML](https://docs.microsoft.com/visualstudio/xml-tools/how-to-create-xml-snippets).  
