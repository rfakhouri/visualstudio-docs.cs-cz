...
Nejnovější verzi tohoto tématu můžete najít v [postupy: spuštění samostatné aplikace rozhraní .NET Framework s Profiler k shromažďování dat souběžnosti pomocí příkazového řádku](https://docs.microsoft.com/visualstudio/profiling/how-to-launch-a-stand-alone-dotnet-framework-application-with-the-profiler-to-collect-concurrency-data-by-using-the-command-line).  
