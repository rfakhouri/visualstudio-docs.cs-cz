...
ms.locfileid: "42668778"
---
# <a name="command-line-profiling-of-stand-alone-applications"></a>Profilace samostatných aplikací z příkazového řádku
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [příkazového řádku pro profilaci ze samostatné aplikace](https://docs.microsoft.com/visualstudio/profiling/command-line-profiling-of-stand-alone-applications).  
