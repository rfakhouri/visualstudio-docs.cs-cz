...
ms.locfileid: "42670313"
---
# <a name="ui-processing-time"></a>Doba zpracování uživatelského rozhraní
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [doba zpracování uživatelského rozhraní](https://docs.microsoft.com/visualstudio/profiling/ui-processing-time).  
