...
ms.locfileid: "42627474"
---
# <a name="da0024-excessive-gc-cpu-time"></a>DA0024: Nadměrný čas procesoru uvolňování paměti
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [DA0024: nadměrný čas procesoru uvolňování paměti](https://docs.microsoft.com/visualstudio/profiling/da0024-excessive-gc-cpu-time).  
