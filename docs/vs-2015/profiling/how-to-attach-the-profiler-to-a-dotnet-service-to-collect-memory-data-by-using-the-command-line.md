...
Nejnovější verzi tohoto tématu můžete najít v [postupy: připojení Profiler ke službě .NET ke shromažďování dat paměti pomocí příkazového řádku](https://docs.microsoft.com/visualstudio/profiling/how-to-attach-the-profiler-to-a-dotnet-service-to-collect-memory-data-by-using-the-command-line).  
