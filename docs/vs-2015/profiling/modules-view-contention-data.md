...
ms.locfileid: "42628231"
---
# <a name="modules-view---contention-data"></a>Zobrazení modulů – data kolizí
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [zobrazení modulů – Data kolizí](https://docs.microsoft.com/visualstudio/profiling/modules-view-contention-data).  
