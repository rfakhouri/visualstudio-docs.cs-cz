...
Nejnovější verzi tohoto tématu můžete najít v [shromažďuje alokaci paměti .NET a Data o životním cyklu](https://docs.microsoft.com/visualstudio/profiling/collecting-dotnet-memory-allocation-and-lifetime-data).  
