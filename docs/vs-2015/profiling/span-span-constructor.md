...
ms.locfileid: "42669091"
---
# <a name="spanspan-constructor"></a>span::span – konstruktor
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [span::span – konstruktor](https://docs.microsoft.com/visualstudio/profiling/span-span-constructor).  
