...
ms.locfileid: "42666958"
---
# <a name="cvwritemessage-function"></a>CvWriteMessage – funkce
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [cvwritemessage – funkce](https://docs.microsoft.com/visualstudio/profiling/cvwritemessage-function).  
