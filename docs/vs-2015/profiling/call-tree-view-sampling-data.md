...
ms.locfileid: "42671809"
---
# <a name="call-tree-view---sampling-data"></a>Zobrazení stromu volání – vzorkování dat
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [zobrazení stromu volání – Data vzorkování](https://docs.microsoft.com/visualstudio/profiling/call-tree-view-sampling-data).  
