...
ms.locfileid: "42632375"
---
# <a name="saving-and-exporting-performance-tools-data"></a>Ukládání a export výkonu nástrojů pro Data
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [ukládání a export dat nástrojů pro výkon](https://docs.microsoft.com/visualstudio/profiling/saving-and-exporting-performance-tools-data).  
