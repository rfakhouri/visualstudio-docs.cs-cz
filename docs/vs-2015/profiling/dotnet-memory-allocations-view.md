...
ms.locfileid: "42677714"
---
# <a name="net-memory-allocations-view"></a>Přidělení paměti .NET – zobrazení
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [zobrazení přidělení paměti .NET](https://docs.microsoft.com/visualstudio/profiling/dotnet-memory-allocations-view).  
