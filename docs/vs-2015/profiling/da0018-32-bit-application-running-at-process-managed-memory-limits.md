...
Nejnovější verzi tohoto tématu můžete najít v [DA0018: 32bitová aplikace spuštěná v procesu limitech paměti spravovaného](https://docs.microsoft.com/visualstudio/profiling/da0018-32-bit-application-running-at-process-managed-memory-limits).  
