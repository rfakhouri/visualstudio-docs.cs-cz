...
Nejnovější dokumentaci k sadě Visual Studio, naleznete v tématu [DA0039: Velmi vysoká míra kolizí zámků](https://docs.microsoft.com/visualstudio/profiling/da0039-very-high-rate-of-lock-contentions).  
