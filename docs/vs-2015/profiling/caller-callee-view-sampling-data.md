...
ms.locfileid: "42669232"
---
# <a name="caller--callee-view---sampling-data"></a>Volající / volaný zobrazení – vzorkování dat
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [volající – zobrazení volaný – Data vzorkování](https://docs.microsoft.com/visualstudio/profiling/caller-callee-view-sampling-data).  
