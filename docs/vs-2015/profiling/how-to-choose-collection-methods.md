...
Nejnovější verzi tohoto tématu můžete najít v [jak: Zvolte metody kolekce](https://docs.microsoft.com/visualstudio/profiling/how-to-choose-collection-methods).  
