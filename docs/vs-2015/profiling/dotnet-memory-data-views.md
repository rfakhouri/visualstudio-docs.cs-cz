...
ms.locfileid: "42672774"
---
# <a name="net-memory-data-views"></a>Zobrazení dat paměti .NET
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [zobrazení dat paměti .NET](https://docs.microsoft.com/visualstudio/profiling/dotnet-memory-data-views).  
