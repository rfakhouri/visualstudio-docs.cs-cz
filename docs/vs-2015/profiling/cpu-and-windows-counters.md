...
ms.locfileid: "42633559"
---
# <a name="cpu-and-windows-counters"></a>Čítače procesoru a systému Windows
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [Windows čítače procesoru a](https://docs.microsoft.com/visualstudio/profiling/cpu-and-windows-counters).  
