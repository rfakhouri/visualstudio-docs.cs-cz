...
Nejnovější verzi tohoto tématu můžete najít v [postupy: připojení a odpojení výkonu nástroje pro spuštění procesů](https://docs.microsoft.com/visualstudio/profiling/how-to-attach-and-detach-performance-tools-to-running-processes).  
