...
ms.locfileid: "42628661"
---
# <a name="performance-rules-by-id"></a>Pravidla výkonu podle identifikátorů
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [pravidla výkonu podle identifikátorů](https://docs.microsoft.com/visualstudio/profiling/performance-rules-by-id).  
