...
Nejnovější verzi tohoto tématu můžete najít v [názorný postup: příkazového řádku pro profilaci instrumentace pomocí](https://docs.microsoft.com/visualstudio/profiling/walkthrough-command-line-profiling-using-instrumentation).  
