...
ms.locfileid: "42665946"
---
# <a name="summary-view---sampling-data"></a>Souhrnné zobrazení – vzorkování dat
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [souhrnné zobrazení – Data vzorkování](https://docs.microsoft.com/visualstudio/profiling/summary-view-sampling-data).  
