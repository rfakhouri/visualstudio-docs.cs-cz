...
ms.locfileid: "42669231"
---
# <a name="concurrency-visualizer-markers"></a>Značky Vizualizéru souběžnosti
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [značek Vizualizéru souběžnosti](https://docs.microsoft.com/visualstudio/profiling/concurrency-visualizer-markers).  
