...
ms.locfileid: "42674514"
---
# <a name="concurrency-visualizer-sdk"></a>SDK Vizualizéru souběžnosti
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [sada Vizualizátor souběžnosti SDK](https://docs.microsoft.com/visualstudio/profiling/concurrency-visualizer-sdk).  
