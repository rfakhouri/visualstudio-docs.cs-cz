...
Nejnovější verzi tohoto tématu můžete najít v [spuštění profilování nástroje s nebo bez ladicího programu](https://docs.microsoft.com/visualstudio/profiling/running-profiling-tools-with-or-without-the-debugger).  
