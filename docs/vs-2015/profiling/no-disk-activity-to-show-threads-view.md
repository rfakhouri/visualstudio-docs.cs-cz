...
ms.locfileid: "42629521"
---
# <a name="no-disk-activity-to-show-threads-view"></a>Žádná disková aktivita k zobrazení (Zobrazení vláken)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [žádná disková aktivita k zobrazení (zobrazení vláken)](https://docs.microsoft.com/visualstudio/profiling/no-disk-activity-to-show-threads-view).  
