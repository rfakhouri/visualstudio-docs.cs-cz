...
ms.locfileid: "42627635"
---
# <a name="performance-warnings"></a>Upozornění výkonu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [upozornění výkonu](https://docs.microsoft.com/visualstudio/code-quality/performance-warnings).  
