...
ms.locfileid: "42633620"
---
# <a name="code-analysis-application-errors"></a>Chyby aplikace Analýzy kódu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [chyby aplikace analýzy kódu](https://docs.microsoft.com/visualstudio/code-quality/code-analysis-application-errors).
