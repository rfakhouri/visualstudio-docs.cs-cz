...
Nejnovější verzi tohoto tématu můžete najít v [CA2153: Vyhněte se zpracování poškozený stav výjimky](https://docs.microsoft.com/visualstudio/code-quality/ca2153-avoid-handling-corrupted-state-exceptions).  
