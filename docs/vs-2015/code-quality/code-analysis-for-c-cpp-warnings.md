...
ms.locfileid: "65693297"
---
# <a name="code-analysis-for-cc-warnings"></a>Upozornění Analýzy kódu pro C/C++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Tato část obsahuje seznam upozornění analýzy kódu v jazyce C/C++. Informace o analýze kódu naleznete v tématu [/ analyze (Analýza kódu)](https://msdn.microsoft.com/library/81da536a-e030-4bd4-be18-383927597d08) a [rychlý Start: Analýza kódu pro C/C++](../code-quality/quick-start-code-analysis-for-c-cpp.md).  
  
## <a name="see-also"></a>Viz také  
 [Pokyny pro psaní bezpečného kódu](https://msdn.microsoft.com/9892fd19-45cd-44b6-9fa8-10f1b5cb6ea4)   
