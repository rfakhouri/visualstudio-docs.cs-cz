...
Nejnovější verzi tohoto tématu můžete najít v [postupy: povolení a zákaz analýzy celého řešení pro spravovaný kód](https://docs.microsoft.com/visualstudio/code-quality/how-to-enable-and-disable-full-solution-analysis-for-managed-code).  
