...
ms.locfileid: "42672900"
---
# <a name="code-metrics-values"></a>Hodnoty metrik kódu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [hodnoty metrik kódu](https://docs.microsoft.com/visualstudio/code-quality/code-metrics-values).  
