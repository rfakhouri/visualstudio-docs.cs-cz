...
ms.locfileid: "42668562"
---
# <a name="native-minimum-rules-rule-set"></a>Sada pravidel Nativní minimální pravidla
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [sada pravidel nativní minimální pravidla](https://docs.microsoft.com/visualstudio/code-quality/native-minimum-rules-rule-set).  
...
|[C28205](../code-quality/c28205.md)|_Success\_ nebo _On_failure\_ použít v neplatném kontextu|  
...
|[C28287](../code-quality/c28287.md)|Pro funkci. Chyba syntaxe v poznámce _At\_poznámky () (nerozeznaný název parametru)|  
|[C28288](../code-quality/c28288.md)|Pro funkci. Chyba syntaxe v poznámce _At\_poznámky () (neplatný název parametru)|  
...
|[C28302](../code-quality/c28302.md)|Navíc _deref –\_ v poznámce byl nalezen operátor.|  
