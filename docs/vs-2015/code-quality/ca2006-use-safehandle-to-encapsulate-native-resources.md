...
Nejnovější verzi tohoto tématu můžete najít v [CA2006: použijte SafeHandle pro zapouzdření nativních prostředků](https://docs.microsoft.com/visualstudio/code-quality/ca2006-use-safehandle-to-encapsulate-native-resources).
