...
ms.locfileid: "42665986"
---
# <a name="mobility-warnings"></a>Upozornění mobility
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [upozornění Mobility](https://docs.microsoft.com/visualstudio/code-quality/mobility-warnings).  
