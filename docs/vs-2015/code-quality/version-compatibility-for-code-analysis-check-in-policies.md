...
Nejnovější verzi tohoto tématu můžete najít v [Kompatibilita verzí pro Zásady vracení se změnami analýzy kódu](https://docs.microsoft.com/visualstudio/code-quality/version-compatibility-for-code-analysis-check-in-policies).  
