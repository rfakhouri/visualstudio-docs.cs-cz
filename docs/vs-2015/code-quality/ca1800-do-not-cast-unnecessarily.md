...
ms.locfileid: "42668937"
---
# <a name="ca1800-do-not-cast-unnecessarily"></a>CA1800: Nepřetypujte zbytečně
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [CA1800: nepřetypujte zbytečně](https://docs.microsoft.com/visualstudio/code-quality/ca1800-do-not-cast-unnecessarily).  
...
## <a name="see-also"></a>Viz také  
 [jako](http://msdn.microsoft.com/library/a9be126b-cbf4-4990-a70d-d0e1983cad0e)   
