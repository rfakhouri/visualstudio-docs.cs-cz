...
ms.locfileid: "42628502"
---
# <a name="usage-warnings"></a>Upozornění využití
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [upozornění využití](https://docs.microsoft.com/visualstudio/code-quality/usage-warnings).  
