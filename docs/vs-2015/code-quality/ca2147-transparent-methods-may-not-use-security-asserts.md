...
Nejnovější verzi tohoto tématu můžete najít v [CA2147: transparentní metody nemusejí podporovat použití zabezpečení nepodmíněné výrazy](https://docs.microsoft.com/visualstudio/code-quality/ca2147-transparent-methods-may-not-use-security-asserts).
