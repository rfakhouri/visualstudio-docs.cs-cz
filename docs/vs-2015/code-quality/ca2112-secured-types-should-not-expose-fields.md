...
## <a name="cause"></a>Příčina
 Veřejný nebo chráněný typ obsahuje veřejná pole a je zabezpečen pomocí [požadavky propojení](https://msdn.microsoft.com/library/a33fd5f9-2de9-4653-a4f0-d9df25082c4d).
