---
title: Doporučené postupy a příklady (poznámky SAL) | Dokumentace Microsoftu
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "42677542"
---
# <a name="best-practices-and-examples-sal"></a>Doporučené postupy a příklady (poznámky SAL)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [osvědčené postupy a příklady (poznámky SAL)](https://docs.microsoft.com/visualstudio/code-quality/best-practices-and-examples-sal).  
