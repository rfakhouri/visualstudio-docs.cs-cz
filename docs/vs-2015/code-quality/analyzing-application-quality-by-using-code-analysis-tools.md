...
Nejnovější verzi tohoto tématu můžete najít v [analýza kvality aplikace pomocí nástrojů pro analýzu kódu](https://docs.microsoft.com/visualstudio/code-quality/analyzing-application-quality-by-using-code-analysis-tools).  
