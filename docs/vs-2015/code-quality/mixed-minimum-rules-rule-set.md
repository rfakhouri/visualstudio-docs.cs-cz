...
ms.locfileid: "42672775"
---
# <a name="mixed-minimum-rules-rule-set"></a>Sada pravidel Smíšená minimální pravidla
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [sada pravidel smíšená minimální pravidla](https://docs.microsoft.com/visualstudio/code-quality/mixed-minimum-rules-rule-set).  
