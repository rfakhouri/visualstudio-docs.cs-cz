---
title: C6324 | Dokumentace Microsoftu
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "42667315"
---
# <a name="c6324"></a>C6324
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [C6324](https://docs.microsoft.com/visualstudio/code-quality/c6324).  
  
upozornění C6324: nesprávné použití \<function1 >: nechtěli jste použít \<function2 >?  
  
 Toto upozornění signalizuje, že funkci kopírování řetězce použila, ve kterém funkce porovnání řetězce by měla být použita. Nesprávné použití funkce může způsobit neočekávané logické chybě.  
...
```  
 ...
 Chcete-li opravit toto upozornění, použijte `strcmp` jak je znázorněno v následujícím kódu:  
