...
Nejnovější verzi tohoto tématu můžete najít v [CA1060: Přesuňte P-vyvolá do třídy NativeMethods](https://docs.microsoft.com/visualstudio/code-quality/ca1060-move-p-invokes-to-nativemethods-class).
