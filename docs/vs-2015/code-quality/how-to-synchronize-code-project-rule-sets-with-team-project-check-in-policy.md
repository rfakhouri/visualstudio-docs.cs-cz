...
Nejnovější verzi tohoto tématu můžete najít v [postupy: synchronizace sady pravidel projektu kódu pomocí zásad vracení se změnami týmového projektu](https://docs.microsoft.com/visualstudio/code-quality/how-to-synchronize-code-project-rule-sets-with-team-project-check-in-policy).  
