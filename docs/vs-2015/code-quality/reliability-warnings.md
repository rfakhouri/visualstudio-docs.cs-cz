...
ms.locfileid: "42667626"
---
# <a name="reliability-warnings"></a>Upozornění spolehlivosti
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [upozornění spolehlivosti](https://docs.microsoft.com/visualstudio/code-quality/reliability-warnings).  
