...
Nejnovější verzi tohoto tématu můžete najít v [sada pravidel základní pravidla obecných zásad návrhu pro spravovaný kód](https://docs.microsoft.com/visualstudio/code-quality/basic-design-guideline-rules-rule-set-for-managed-code).  
