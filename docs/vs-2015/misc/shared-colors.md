...
|![Název nabídky s výchozí piktogram](../extensibility/ux-guidelines/media/0303-003-menutitlewithglyphdefault.png "0303 003_MenuTitleWithGlyphDefault")<br /><br /> **Název nabídky glyfem**|Ohraničení|Žádná|  
...
|![Název nabídky glyfem při najetí myší](../extensibility/ux-guidelines/media/0303-005-menutitlewithglyphhover.png "0303 005_MenuTitleWithGlyphHover")<br /><br /> **Název nabídky glyfem**|Popředí (piktogram)|`Environment.CommandBarMenuMouseOverGlyph`|  
|![Název nabídky glyfem při najetí myší](../extensibility/ux-guidelines/media/0303-005-menutitlewithglyphhover.png "0303 005_MenuTitleWithGlyphHover")<br /><br /> **Název nabídky glyfem**|Ohraničení|`Environment.CommandBarBorder`|  
...
|![Název nabídky glyfem stisknutí](../extensibility/ux-guidelines/media/0303-007-menutitlewithglyphpressed.png "0303 007_MenuTitleWithGlyphPressed")<br /><br /> **Název nabídky glyfem**|Popředí (piktogram)|`Environment.CommandBarMenuMouseDownGlyph`|  
|![Název nabídky glyfem stisknutí](../extensibility/ux-guidelines/media/0303-007-menutitlewithglyphpressed.png "0303 007_MenuTitleWithGlyphPressed")<br /><br /> **Název nabídky glyfem**|Ohraničení|`Environment.CommandBarMenuBorder`<br /><br /> Pouze vlevo nahoře a pravé straně.|  
...
|![Název nabídky glyfem zakázané](../extensibility/ux-guidelines/media/0303-008-menutitlewithglyphdisabled.png "0303 008_MenuTitleWithGlyphDisabled")<br /><br /> **Název nabídky glyfem**|Ohraničení|Žádná|  
...
|![Výchozí nabídky](../extensibility/ux-guidelines/media/0303-010-menudefault.png "0303 010_MenuDefault")<br /><br /> **Nabídka**|Popředí (podnabídky piktogram)|`Environment.CommandBarMenuSubmenuGlyph`|  
|![Výchozí nabídky](../extensibility/ux-guidelines/media/0303-010-menudefault.png "0303 010_MenuDefault")<br /><br /> **Nabídka**|Ohraničení|`Environment.CommandBarMenuBorder`|  
|![Výchozí nabídky](../extensibility/ux-guidelines/media/0303-010-menudefault.png "0303 010_MenuDefault")<br /><br /> **Nabídka**|Pozadí ikony kanálu|`Environment.CommandBarMenuIconBackground`|  
|![Výchozí nabídky](../extensibility/ux-guidelines/media/0303-010-menudefault.png "0303 010_MenuDefault")<br /><br /> **Nabídka**|Oddělovač|`Environment.CommandBarMenuSeparator`|  
|![Výchozí nabídky](../extensibility/ux-guidelines/media/0303-010-menudefault.png "0303 010_MenuDefault")<br /><br /> **Nabídka**|Stín|`Environment.DropShadowBackground`|  
|![Nabídka zaškrtnutí](../extensibility/ux-guidelines/media/0303-011-menuchecked.png "0303 011_MenuChecked")<br /><br /> **Zaškrtnuto**|Zaškrtávací políčko|`Environment.CommandBarCheckBox`|  
|![Nabídka zaškrtnutí](../extensibility/ux-guidelines/media/0303-011-menuchecked.png "0303 011_MenuChecked")<br /><br /> **Zaškrtnuto**|Zaškrtávací políčko na pozadí|`Environment.CommandBarSelectedIcon`|  
|![Nabídky vybrána](../extensibility/ux-guidelines/media/0303-012-menuselected.png "0303 012_MenuSelected")<br /><br /> **Vybrané**|Pozadí ikony|`Environment.CommandBarSelected`|  
|![Nabídky vybrána](../extensibility/ux-guidelines/media/0303-012-menuselected.png "0303 012_MenuSelected")<br /><br /> **Vybrané**|Okraj ikony|`Environment.CommandBarSelectedBorder`|  
...
|![Nabídky při najetí myší](../extensibility/ux-guidelines/media/0303-013-menuhover.png "0303 013_MenuHover")<br /><br /> **Položka nabídky**|Popředí (podnabídky piktogram)|`Environment.CommandBarMenuMouseOverSubmenuGlyph`|  
|![Nabídky při najetí myší zaškrtnutí](../extensibility/ux-guidelines/media/0303-014-menuhoverchecked.png "0303 014_MenuHoverChecked")<br /><br /> **Zaškrtnuto**|Zaškrtávací políčko|`Environment.CommandBarCheckBoxMouseOver`|  
|![Nabídky při najetí myší zaškrtnutí](../extensibility/ux-guidelines/media/0303-014-menuhoverchecked.png "0303 014_MenuHoverChecked")<br /><br /> **Zaškrtnuto**|Zaškrtávací políčko na pozadí|`Environment.CommandBarHoverOverSelectedIcon`|  
|![Nabídky při najetí myší vybraný](../extensibility/ux-guidelines/media/0303-015-menuhoverselected.png "0303 015_MenuHoverSelected")<br /><br /> **Vybrané**|Pozadí ikony|`Environment.CommandBarHoverOverSelected`|  
|![Nabídky při najetí myší vybraný](../extensibility/ux-guidelines/media/0303-015-menuhoverselected.png "0303 015_MenuHoverSelected")<br /><br /> **Vybrané**|Okraj ikony|`Environment.CommandBarHoverOverSelectedIconBorder`|  
...
|![Nabídky zakázáno zaškrtnutí](../extensibility/ux-guidelines/media/0303-017-menudisabledchecked.png "0303 017_MenuDisabledChecked")<br /><br /> Zaškrtnuto|Zaškrtávací políčko|`Environment.CommandBarCheckBoxDisabled`|  
|![Nabídky zakázáno zaškrtnutí](../extensibility/ux-guidelines/media/0303-017-menudisabledchecked.png "0303 017_MenuDisabledChecked")<br /><br /> Zaškrtnuto|Zaškrtávací políčko na pozadí|`Environment.CommandBarSelectedIconDisabled`|  
...
|![Příkaz výchozí ikona](../extensibility/ux-guidelines/media/0303-023-commandicondefault.png "0303 023_CommandIconDefault")<br /><br /> **Default**|Ohraničení|Není k dispozici|  
|![Příkaz výchozí ikona vybrané](../extensibility/ux-guidelines/media/0303-024-commandicondefaultselected.png "0303 024_CommandIconDefaultSelected")<br /><br /> **Vybrané**|Pozadí|`Environment.CommandBarSelected`|  
|![Příkaz výchozí ikona vybrané](../extensibility/ux-guidelines/media/0303-024-commandicondefaultselected.png "0303 024_CommandIconDefaultSelected")<br /><br /> **Vybrané**|Popředí (Text)|`Environment.CommandBarTextSelected`|  
|![Příkaz výchozí ikona vybrané](../extensibility/ux-guidelines/media/0303-024-commandicondefaultselected.png "0303 024_CommandIconDefaultSelected")<br /><br /> **Vybrané**|Ohraničení|`Environment.CommandBarSelectedBorder`|  
...
|![Příkaz ikonu při najetí myší](../extensibility/ux-guidelines/media/0303-025-commandiconhover.png "0303 025_CommandIconHover")<br /><br /> **Standardní při najetí myší**|Ohraničení|`Environment.CommandBarBorder`|  
|![Příkaz vybrali při najetí myší ikonu](../extensibility/ux-guidelines/media/0303-026-commandiconhoverselected.png "0303 026_CommandIconHoverSelected")<br /><br /> **Vybráno při najetí myší**|Pozadí|`Environment.CommandBarHoverOverSelected`|  
|![Příkaz vybrali při najetí myší ikonu](../extensibility/ux-guidelines/media/0303-026-commandiconhoverselected.png "0303 026_CommandIconHoverSelected")<br /><br /> **Vybráno při najetí myší**|Popředí (Text)|`Environment.CommandBarTextHoverOverSelected`|  
|![Příkaz vybrali při najetí myší ikonu](../extensibility/ux-guidelines/media/0303-026-commandiconhoverselected.png "0303 026_CommandIconHoverSelected")<br /><br /> **Vybráno při najetí myší**|Ohraničení|`Environment.CommandBarHoverOverSelectedIconBorder`|  
...
|![Ikona příkaz stisknutí](../extensibility/ux-guidelines/media/0303-027-commandiconpressed.png "0303 027_CommandIconPressed")<br /><br /> **Ikona při stisknutí příkazu.**|Ohraničení|`Environment.CommandBarBorder`|  
...
|![Rozevírací pole se seznamem&#45;tlačítko](../extensibility/ux-guidelines/media/0303-031-comboboxdropdownbutton.png "0303 031_ComboBoxDropdownButton")<br /><br /> **Tlačítko rozevíracího seznamu**|Pozadí|Není k dispozici (dědí)|  
|![Rozevírací pole se seznamem&#45;tlačítko](../extensibility/ux-guidelines/media/0303-031-comboboxdropdownbutton.png "0303 031_ComboBoxDropdownButton")<br /><br /> **Tlačítko rozevíracího seznamu**|Popředí (piktogram)|`Environment.ComboBoxGlyph`|  
|![Pole se seznamem&#47;vyřadit&#45;dolů seznam](../extensibility/ux-guidelines/media/0303-032-comboboxdropdownlist.png "0303 032_ComboBoxDropdownList")<br /><br /> **Rozevírací seznam**|Pozadí|`Environment.ComboBoxPopupBackgroundBegin`<br /><br /> Přestože nepoužívá moderní uživatelské rozhraní s motivem, existují Přechodové zarážky a hodnoty pro tato na pozadí.|  
|![Pole se seznamem&#47;vyřadit&#45;dolů seznam](../extensibility/ux-guidelines/media/0303-032-comboboxdropdownlist.png "0303 032_ComboBoxDropdownList")<br /><br /> **Rozevírací seznam**|Popředí (Text)|`Environment.ComboBoxItemText`|  
|![Pole se seznamem&#47;vyřadit&#45;dolů seznam](../extensibility/ux-guidelines/media/0303-032-comboboxdropdownlist.png "0303 032_ComboBoxDropdownList")<br /><br /> **Rozevírací seznam**|Ohraničení|`Environment.ComboBoxPopupBorder`|  
...
|![Vstupní pole se seznamem při najetí myší](../extensibility/ux-guidelines/media/0303-033-comboboxinputfieldhover.png "0303 033_ComboBoxInputFieldHover")<br /><br /> **Vstupní pole**|Ohraničení|`Environment.ComboBoxMouseOverBorder`|  
|![Vstupní pole se seznamem při najetí myší](../extensibility/ux-guidelines/media/0303-033-comboboxinputfieldhover.png "0303 033_ComboBoxInputFieldHover")<br /><br /> **Vstupní pole**|Oddělovač|`Environment.ComboBoxMouseOverSeparator`|  
|![Pole se seznamem&#47;vyřadit&#45;tlačítka při najetí myší](../extensibility/ux-guidelines/media/0303-034-comboboxdropdownbuttonhover.png "0303 034_ComboBoxDropdownButtonHover")<br /><br /> **Tlačítko rozevíracího seznamu**|Pozadí|`Environment.ComboBoxButtonMouseOverBackground`|  
|![Pole se seznamem&#47;vyřadit&#45;tlačítka při najetí myší](../extensibility/ux-guidelines/media/0303-034-comboboxdropdownbuttonhover.png "0303 034_ComboBoxDropdownButtonHover")<br /><br /> **Tlačítko rozevíracího seznamu**|Popředí (piktogram)|`Environment.ComboBoxMouseOverGlyph`|  
|![Pole se seznamem&#47;vyřadit&#45;seznamu při najetí myší dolů](../extensibility/ux-guidelines/media/0303-035-comboboxdropdownlisthover.png "0303 035_ComboBoxDropdownListHover")<br /><br /> **Rozevírací seznam**|Na pozadí (položka nabídky)|`Environment.ComboBoxItemMouseOverBackground`|  
|![Pole se seznamem&#47;vyřadit&#45;seznamu při najetí myší dolů](../extensibility/ux-guidelines/media/0303-035-comboboxdropdownlisthover.png "0303 035_ComboBoxDropdownListHover")<br /><br /> **Rozevírací seznam**|Popředí (Text)|`Environment.ComboBoxItemMouseOverText`|  
|![Pole se seznamem&#47;vyřadit&#45;seznamu při najetí myší dolů](../extensibility/ux-guidelines/media/0303-035-comboboxdropdownlisthover.png "0303 035_ComboBoxDropdownListHover")<br /><br /> **Rozevírací seznam**|Ohraničení (položka nabídky)|`Environment.ComboBoxItemMouseOverBorder`|  
  
 **Fokus**  
  
|Součást|Prvek|Název tokenu: Color.category|  
|---------------|-------------|--------------------------------|  
|![Pole se seznamem vstupní fokus](../extensibility/ux-guidelines/media/0303-036-comboboxinputfieldfocused.png "0303 036_ComboBoxInputFieldFocused")<br /><br /> **Vstupní pole**|Pozadí|`Environment.ComboBoxFocusedBackground`|  
|![Pole se seznamem vstupní fokus](../extensibility/ux-guidelines/media/0303-036-comboboxinputfieldfocused.png "0303 036_ComboBoxInputFieldFocused")<br /><br /> **Vstupní pole**|Popředí (Text)|`Environment.ComboBoxFocusedText`|  
|![Pole se seznamem vstupní fokus](../extensibility/ux-guidelines/media/0303-036-comboboxinputfieldfocused.png "0303 036_ComboBoxInputFieldFocused")<br /><br /> **Vstupní pole**|Ohraničení|`Environment.ComboBoxFocusedBorder`|  
|![Pole se seznamem vstupní fokus](../extensibility/ux-guidelines/media/0303-036-comboboxinputfieldfocused.png "0303 036_ComboBoxInputFieldFocused")<br /><br /> **Vstupní pole**|Oddělovač|`Environment.ComboBoxFocusedButtonSeparator`|  
|![Pole se seznamem&#47;vyřadit&#45;tlačítko, zaměřuje](../extensibility/ux-guidelines/media/0303-037-comboboxdropdownbuttonfocused.png "0303 037_ComboBoxDropdownButtonFocused")<br /><br /> **Tlačítko rozevíracího seznamu**|Pozadí|`Environment.ComboBoxFocusedButtonBackground`|  
|![Pole se seznamem&#47;vyřadit&#45;tlačítko, zaměřuje](../extensibility/ux-guidelines/media/0303-037-comboboxdropdownbuttonfocused.png "0303 037_ComboBoxDropdownButtonFocused")<br /><br /> **Tlačítko rozevíracího seznamu**|Popředí (piktogram)|`Environment.ComboBoxFocusedGlyph`|  
  
 **Stisknutí**  
  
|Součást|Prvek|Název tokenu: Color.category|  
|---------------|-------------|--------------------------------|  
|![Pole se seznamem vstupního stisknutí](../extensibility/ux-guidelines/media/0303-038-comboboxinputfieldpressed.png "0303 038_ComboBoxInputFieldPressed")<br /><br /> **Vstupní pole**|Pozadí|`Environment.ComboBoxMouseDownBackground`|  
|![Pole se seznamem vstupního stisknutí](../extensibility/ux-guidelines/media/0303-038-comboboxinputfieldpressed.png "0303 038_ComboBoxInputFieldPressed")<br /><br /> **Vstupní pole**|Popředí (Text)|`Environment.ComboBoxMouseDownText`|  
|![Pole se seznamem vstupního stisknutí](../extensibility/ux-guidelines/media/0303-038-comboboxinputfieldpressed.png "0303 038_ComboBoxInputFieldPressed")<br /><br /> **Vstupní pole**|Ohraničení|`Environment.ComboBoxMouseDownBorder`|  
|![Pole se seznamem vstupního stisknutí](../extensibility/ux-guidelines/media/0303-038-comboboxinputfieldpressed.png "0303 038_ComboBoxInputFieldPressed")<br /><br /> **Vstupní pole**|Oddělovač|`Environment.ComboBoxMouseDownSeparator`|  
|![Pole se seznamem&#47;vyřadit&#45;dolů stisknutí tlačítka](../extensibility/ux-guidelines/media/0303-039-comboboxdropdownbuttonpressed.png "0303 039_ComboBoxDropdownButtonPressed")<br /><br /> **Tlačítko rozevíracího seznamu**|Pozadí|`Environment.ComboBoxButtonMouseDownBackground`|  
|![Pole se seznamem&#47;vyřadit&#45;dolů stisknutí tlačítka](../extensibility/ux-guidelines/media/0303-039-comboboxdropdownbuttonpressed.png "0303 039_ComboBoxDropdownButtonPressed")<br /><br /> **Tlačítko rozevíracího seznamu**|Popředí (piktogram)|`Environment.ComboBoxMouseDownGlyph`|  
  
 **Zakázané**  
  
|Součást|Prvek|Název tokenu: Color.category|  
|---------------|-------------|--------------------------------|  
|![Pole se seznamem vstupního zakázané](../extensibility/ux-guidelines/media/0303-041-comboboxinputfielddisabled.png "0303 041_ComboBoxInputFieldDisabled")<br /><br /> **Vstupní pole**|Pozadí|`Environment.ComboBoxDisabledBackground`|  
...
|![Vyřadit&#45;dolů seznam](../extensibility/ux-guidelines/media/0303-045-dropdownlist.png "0303 045_DropdownList")<br /><br /> **Rozevírací seznam**|Ohraničení|`Environment.DropDownPopupBorder`|  
|![Vyřadit&#45;dolů seznam](../extensibility/ux-guidelines/media/0303-045-dropdownlist.png "0303 045_DropdownList")<br /><br /> **Rozevírací seznam**|Stín|`Environment.DropShadowBackground`|  
...
|![Vyřadit&#45;dolů výběr pole při najetí myší](../extensibility/ux-guidelines/media/0303-046-dropdownselectionfieldhover.png "0303 046_DropdownSelectionFieldHover")<br /><br /> **Výběr pole**|Ohraničení|`Environment.DropDownMouseOverBorder`|  
|![Vyřadit&#45;dolů výběr pole při najetí myší](../extensibility/ux-guidelines/media/0303-046-dropdownselectionfieldhover.png "0303 046_DropdownSelectionFieldHover")<br /><br /> **Výběr pole**|Oddělovač|`Environment.DropDownButtonMouseOverSeparator`|  
|![Vyřadit&#45;tlačítka při najetí myší](../extensibility/ux-guidelines/media/0303-047-dropdownbuttonhover.png "0303 047_DropdownButtonHover")<br /><br /> **Tlačítko rozevíracího seznamu**|Pozadí|`Environment.DropDownButtonMouseOverBackground`|  
|![Vyřadit&#45;tlačítka při najetí myší](../extensibility/ux-guidelines/media/0303-047-dropdownbuttonhover.png "0303 047_DropdownButtonHover")<br /><br /> **Tlačítko rozevíracího seznamu**|Popředí (piktogram)|`Environment.DropDownMouseOverGlyph`|  
|![Vyřadit&#45;seznamu při najetí myší dolů](../extensibility/ux-guidelines/media/0303-048-dropdownlisthover.png "0303 048_DropdownListHover")<br /><br /> **Rozevírací seznam**|Na pozadí (položka nabídky)|`Environment.ComboBoxItemMouseOverBackground`|  
|![Vyřadit&#45;seznamu při najetí myší dolů](../extensibility/ux-guidelines/media/0303-048-dropdownlisthover.png "0303 048_DropdownListHover")<br /><br /> **Rozevírací seznam**|Popředí (Text)|`Environment.ComboBoxItemMouseOverText`|  
|![Vyřadit&#45;seznamu při najetí myší dolů](../extensibility/ux-guidelines/media/0303-048-dropdownlisthover.png "0303 048_DropdownListHover")<br /><br /> **Rozevírací seznam**|Ohraničení (položka nabídky)|`Environment.ComboBoxItemMouseOverBorder`|  
...
|![Vyřadit&#45;dolů pole výběru stisknutí](../extensibility/ux-guidelines/media/0303-049-dropdownselectionfieldpressed.png "0303 049_DropdownSelectionFieldPressed")<br /><br /> **Výběr pole**|Ohraničení|`Environment.DropDownMouseDownBorder`|  
|![Vyřadit&#45;dolů pole výběru stisknutí](../extensibility/ux-guidelines/media/0303-049-dropdownselectionfieldpressed.png "0303 049_DropdownSelectionFieldPressed")<br /><br /> **Výběr pole**|Oddělovač|`Environment.DropDownButtonMouseDownSeparator`|  
|![Vyřadit&#45;dolů stisknutí tlačítka](../extensibility/ux-guidelines/media/0303-050-dropdownbuttonpressed.png "0303 050_DropdownButtonPressed")<br /><br /> **Tlačítko rozevíracího seznamu**|Pozadí|`Environment.DropDownButtonMouseDownBackground`|  
|![Vyřadit&#45;dolů stisknutí tlačítka](../extensibility/ux-guidelines/media/0303-050-dropdownbuttonpressed.png "0303 050_DropdownButtonPressed")<br /><br /> **Tlačítko rozevíracího seznamu**|Popředí (piktogram)|`Environment.DropDownMouseDownGlyph`|  
...
|![Vyřadit&#45;dolů pole výběru zakázané](../extensibility/ux-guidelines/media/0303-051-dropdownselectionfielddisabled.png "0303 051_DropdownSelectionFieldDisabled")|Ohraničení|`Environment.DropDownDisabledBorder`|  
|![Vyřadit&#45;dolů pole výběru zakázané](../extensibility/ux-guidelines/media/0303-051-dropdownselectionfielddisabled.png "0303 051_DropdownSelectionFieldDisabled")|Oddělovač|Žádný oddělovač|  
|![Vyřadit&#45;tlačítko zakázané](../extensibility/ux-guidelines/media/0303-052-dropdownbuttondisabled.png "0303 052_DropdownButtonDisabled")|Pozadí|Není k dispozici|  
|![Vyřadit&#45;tlačítko zakázané](../extensibility/ux-guidelines/media/0303-052-dropdownbuttondisabled.png "0303 052_DropdownButtonDisabled")|Popředí (piktogram)|`Environment.DropDownDisabledGlyph`|  
  
##### <a name="split-button"></a>Tlačítko rozdělení  
 Tlačítka rozdělení sdílet s jinými ovládacími prvky příkazového řádku, jako jsou tlačítka, nabídky a panelu text příkazu mnoho názvů token. Všechny potřebné akce a tlačítkem rozevírací nabídky token názvy pro usnadnění práce tady opakují. Rozdělené tlačítko rozevírací seznamy jsou implementace panelu příkazů [nabídky](../misc/shared-colors.md#BKMK_CommandMenus).  
...
|![Tlačítko rozdělení](../extensibility/ux-guidelines/media/0303-054-splitbutton.png "0303 054_SplitButton")<br /><br /> **Tlačítko rozdělení (výchozí)**|Oddělovač|Není k dispozici|  
...
|![Stisknutí tlačítka rozdělení](../extensibility/ux-guidelines/media/0303-056-splitbuttonpressed.png "0303 056_SplitButtonPressed")<br /><br /> **Tlačítko rozdělení (stisknutí)**|Popředí (piktogram)|`Environment.CommandBarSplitButtonMouseDownGlyph`|  
|![Stisknutí tlačítka rozdělení](../extensibility/ux-guidelines/media/0303-056-splitbuttonpressed.png "0303 056_SplitButtonPressed")<br /><br /> **Tlačítko rozdělení (stisknutí)**|Ohraničení|`Environment.CommandBarBorder`|  
|![Stisknutí tlačítka rozdělení](../extensibility/ux-guidelines/media/0303-056-splitbuttonpressed.png "0303 056_SplitButtonPressed")<br /><br /> **Tlačítko rozdělení (stisknutí)**|Oddělovač|Není k dispozici|  
...
|![Tlačítko rozdělení zakázané](../extensibility/ux-guidelines/media/0303-057-splitbuttondisabled.png "0303 057_SplitButtonDisabled")<br /><br /> **Tlačítko rozdělení (zakázáno)**|Popředí (piktogram)|`Environment.CommandBarTextInactive`|  
|![Tlačítko rozdělení zakázané](../extensibility/ux-guidelines/media/0303-057-splitbuttondisabled.png "0303 057_SplitButtonDisabled")<br /><br /> **Tlačítko rozdělení (zakázáno)**|Ohraničení|Není k dispozici|  
|![Tlačítko rozdělení zakázané](../extensibility/ux-guidelines/media/0303-057-splitbuttondisabled.png "0303 057_SplitButtonDisabled")<br /><br /> **Tlačítko rozdělení (zakázáno)**|Oddělovač|Není k dispozici|  
...
|![Tlačítko přetečení](../extensibility/ux-guidelines/media/0303-060-overflow.png "0303 060_Overflow")<br /><br /> **přetečení**|Popředí (piktogram)|`Environment.CommandBarOptionsGlyph`|  
...
|![Přetečení při najetí myší](../extensibility/ux-guidelines/media/0303-062-overflowoptions.png "0303 062_OverflowOptions")<br /><br /> **přetečení**|Pozadí|`Environment.CommandBarOptionsMouseOverBackgroundBegin`<br /><br /> Přestože nepoužívá moderní uživatelské rozhraní s motivem, existují Přechodové zarážky a hodnoty pro tato na pozadí.|  
|![Přetečení při najetí myší](../extensibility/ux-guidelines/media/0303-062-overflowoptions.png "0303 062_OverflowOptions")<br /><br /> **přetečení**|Popředí (piktogram)|`Environment.CommandBarOptionsMouseDownGlyph`|  
...
|![Přetečení stisknutí](../extensibility/ux-guidelines/media/0303-064-overflowpressed.png "0303 064_OverflowPressed")<br /><br /> **přetečení**|Pozadí|`Environment.CommandBarOptionsMouseDownBackgroundBegin`<br /><br /> Přestože nepoužívá moderní uživatelské rozhraní s motivem, existují Přechodové zarážky a hodnoty pro tato na pozadí.|  
|![Přetečení stisknutí](../extensibility/ux-guidelines/media/0303-064-overflowpressed.png "0303 064_OverflowPressed")<br /><br /> **přetečení**|Popředí (piktogram)|`Environment.CommandBarOptionsMouseDownGlyph`|  
...
|![Rámce, zaměřuje](../extensibility/ux-guidelines/media/0303-067-framefocused.png "0303 067_FrameFocused")<br /><br /> **Snímek: s plovoucí desetinnou čárkou, zaměřuje**|Pozadí|`Environment.ToolWindowFloatingFrame`|  
|![Rámce, zaměřuje](../extensibility/ux-guidelines/media/0303-067-framefocused.png "0303 067_FrameFocused")<br /><br /> **Snímek: s plovoucí desetinnou čárkou, zaměřuje**|Popředí (Text)|`Environment.ToolWindowFloatingFrame`|  
|![Rámce, zaměřuje](../extensibility/ux-guidelines/media/0303-067-framefocused.png "0303 067_FrameFocused")<br /><br /> **Snímek: s plovoucí desetinnou čárkou, zaměřuje**|Popředí (piktogram)|`Environment.RaftedWindowButtonActiveGlyph`|  
|![Rámce, zaměřuje](../extensibility/ux-guidelines/media/0303-067-framefocused.png "0303 067_FrameFocused")<br /><br /> **Snímek: s plovoucí desetinnou čárkou, zaměřuje**|Ohraničení|`Environment.MainWindowActiveDefaultBorder`|  
|![Rámce, zaměřuje](../extensibility/ux-guidelines/media/0303-067-framefocused.png "0303 067_FrameFocused")<br /><br /> **Snímek: s plovoucí desetinnou čárkou, zaměřuje**|Ohraničení (piktogram)|`Environment.RaftedWindowButtonActiveBorder`<br /><br /> Nastavte na transparentní|  
|![Rámec bez fokusu](../extensibility/ux-guidelines/media/0303-068-frameunfocused.png "0303 068_FrameUnfocused")<br /><br /> **Snímek: s plovoucí desetinnou čárkou, bez fokusu**|Pozadí|`Environment.ToolWindowFloatingFrameInactive`|  
|![Rámec bez fokusu](../extensibility/ux-guidelines/media/0303-068-frameunfocused.png "0303 068_FrameUnfocused")<br /><br /> **Snímek: s plovoucí desetinnou čárkou, bez fokusu**|Popředí (Text)|`Environment.ToolWindowFloatingFrameInactive`|  
|![Rámec bez fokusu](../extensibility/ux-guidelines/media/0303-068-frameunfocused.png "0303 068_FrameUnfocused")<br /><br /> **Snímek: s plovoucí desetinnou čárkou, bez fokusu**|Popředí (piktogram)|`Environment.RaftedWindowButtonInactiveGlyph`|  
|![Rámec bez fokusu](../extensibility/ux-guidelines/media/0303-068-frameunfocused.png "0303 068_FrameUnfocused")<br /><br /> **Snímek: s plovoucí desetinnou čárkou, bez fokusu**|Ohraničení|`Environment.MainWindowInactiveBorder`|  
|![Rámec bez fokusu](../extensibility/ux-guidelines/media/0303-068-frameunfocused.png "0303 068_FrameUnfocused")<br /><br /> **Snímek: s plovoucí desetinnou čárkou, bez fokusu**|Ohraničení (piktogram)|`Environment.RaftedWindowButtonInactiveBorder`<br /><br /> Nastavte na transparentní|  
...
|![Rámce, zaměřuje při najetí myší](../extensibility/ux-guidelines/media/0303-069-framefocusedhover.png "0303 069_FrameFocusedHover")<br /><br /> **Snímek: s plovoucí desetinnou čárkou, zaměřuje**|Ohraničení (piktogram)|`Environment.RaftedWindowButtonHoverActiveBorder`|  
|![Rámce při najetí myší bez fokusu](../extensibility/ux-guidelines/media/0303-070-frameunfocusedhover.png "0303 070_FrameUnfocusedHover")<br /><br /> **Snímek: s plovoucí desetinnou čárkou, bez fokusu**|Na pozadí (piktogram)|`EnvironmentRaftedWindowButtonHoverInactive`|  
|![Rámce při najetí myší bez fokusu](../extensibility/ux-guidelines/media/0303-070-frameunfocusedhover.png "0303 070_FrameUnfocusedHover")<br /><br /> **Snímek: s plovoucí desetinnou čárkou, bez fokusu**|Popředí (piktogram)|`Environment.RaftedWindowButtonHoverInactiveGlyph`|  
|![Rámce při najetí myší bez fokusu](../extensibility/ux-guidelines/media/0303-070-frameunfocusedhover.png "0303 070_FrameUnfocusedHover")<br /><br /> **Snímek: s plovoucí desetinnou čárkou, bez fokusu**|Ohraničení (piktogram)|`Environment.RaftedWindowButtonHoverInactiveBorder`|  
...
|![Rámce, zaměřuje při stisknutí](../extensibility/ux-guidelines/media/0303-071-framefocusedpressed.png "0303 071_FrameFocusedPressed")<br /><br /> **Snímek: s plovoucí desetinnou čárkou, zaměřuje**|Ohraničení (piktogram)|`Environment.RaftedWindowButtonDownBorder`|  
...
|![Vybraná karta, zaměřuje](../extensibility/ux-guidelines/media/0303-074-selectedtabfocused.png "0303 074_SelectedTabFocused")<br /><br /> **Vybraný dokument kartu, zaměřuje**|Ohraničení|`Environment.FileTabSelectedBorder`<br /><br /> Nastavte stejnou barvu jako pozadí.|  
|![Vybraná karta, zaměřuje](../extensibility/ux-guidelines/media/0303-074-selectedtabfocused.png "0303 074_SelectedTabFocused")<br /><br /> **Vybraný dokument kartu, zaměřuje**|Dokument ohraničení|`Environment.FileTabDocumentBorderBackground`|  
...
|![Vybraná karta bez fokusu](../extensibility/ux-guidelines/media/0303-075-selectedtabunfocused.png "0303 075_SelectedTabUnfocused")<br /><br /> **Vybraný dokument karty, bez fokusu**|Ohraničení|`Environment.FileTabInactiveBorder`<br /><br /> Nastavte stejnou barvu jako pozadí.|  
|![Vybraná karta bez fokusu](../extensibility/ux-guidelines/media/0303-075-selectedtabunfocused.png "0303 075_SelectedTabUnfocused")<br /><br /> **Vybraný dokument karty, bez fokusu**|Dokument ohraničení|`Environment.FileTabInactiveDocumentBorderBackground`|  
...
|Součást|Prvek|Název tokenu: Color.category|  
|---------------|-------------|--------------------------------|  
|![Karta pozadí](../extensibility/ux-guidelines/media/0303-076-backgroundtab.png "0303 076_BackgroundTab")<br /><br /> **Výchozí kartu na pozadí**|Pozadí|`Environment.FileTabBackground`|  
|![Karta pozadí](../extensibility/ux-guidelines/media/0303-076-backgroundtab.png "0303 076_BackgroundTab")<br /><br /> **Výchozí kartu na pozadí**|Popředí (Text)|`Environment.FileTabText`|  
|![Karta pozadí](../extensibility/ux-guidelines/media/0303-076-backgroundtab.png "0303 076_BackgroundTab")<br /><br /> **Výchozí kartu na pozadí**|Ohraničení|`Environment.FileTabBorder`<br /><br /> Nastavte stejnou barvu jako pozadí.|  
  
 **Při najetí myší**  
  
|Součást|Prvek|Název tokenu: Color.category|  
|---------------|-------------|--------------------------------|  
|![Karty na pozadí při najetí myší](../extensibility/ux-guidelines/media/0303-077-backgroundtabhover.png "0303 077_BackgroundTabHover")<br /><br /> **Karty na pozadí při najetí myší**|Pozadí|`Environment.FileTabHotGradientTop`<br /><br /> Přestože nepoužívá moderní uživatelské rozhraní s motivem, existují Přechodové zarážky a hodnoty pro tato na pozadí.|  
|![Karty na pozadí při najetí myší](../extensibility/ux-guidelines/media/0303-077-backgroundtabhover.png "0303 077_BackgroundTabHover")<br /><br /> **Karty na pozadí při najetí myší**|Popředí (Text)|`Environment.FileTabHotText`|  
|![Karty na pozadí při najetí myší](../extensibility/ux-guidelines/media/0303-077-backgroundtabhover.png "0303 077_BackgroundTabHover")<br /><br /> **Karty na pozadí při najetí myší**|Ohraničení|`Environment.FileTabHotBorder`<br /><br /> Nastavte stejnou barvu jako pozadí.|  
...
|![Karta náhled na pozadí při najetí myší](../extensibility/ux-guidelines/media/0303-082-previewbackgroundtabhover.png "0303 082_PreviewBackgroundTabHover")<br /><br /> **Karty na pozadí karta náhled při najetí myší**|Ohraničení|`Environment.FileTabProvisionalHoverBorder`<br /><br /> Nastavte stejnou barvu jako pozadí.|  
...
|![Overflow](../extensibility/ux-guidelines/media/0303-084-overflow.png "0303 084_Overflow")<br /><br /> **Dokument tlačítku přetečení**|Ohraničení|Není k dispozici|  
...
|![Přetečení při najetí myší](../extensibility/ux-guidelines/media/0303-085-overflowhover.png "0303 085_OverflowHover")<br /><br /> **Dokument přetečení tlačítka při najetí myší**|Ohraničení|`Environment.DocWellOverflowButtonMouseOverBorder`|  
...
|![Přetečení stisknutí](../extensibility/ux-guidelines/media/0303-086-overflowpressed.png "0303 086_OverflowPressed")<br /><br /> **Stiskne tlačítko přetečení dokument**|Ohraničení|`Environment.DocWellOverflowButtonMouseDownBorder`|  
...
|![Záhlaví, zaměřuje](../extensibility/ux-guidelines/media/0303-093-titlebarfocused.png "0303 093_TitleBarFocused")<br /><br /> **Cílené záhlaví**|Ohraničení|`Environment.TitleBarActiveBorder`<br /><br /> Nastavte stejnou barvu jako pozadí.|  
|![Záhlaví, zaměřuje](../extensibility/ux-guidelines/media/0303-093-titlebarfocused.png "0303 093_TitleBarFocused")<br /><br /> **Cílené záhlaví**|Úchyt pro přetažení|`Environment.TitleBarDragHandleActive`|  
...
|![Záhlaví bez fokusu](../extensibility/ux-guidelines/media/0303-094-titlebarunfocused.png "0303 094_TitleBarUnfocused")<br /><br /> **Záhlaví bez fokusu**|Ohraničení|Není k dispozici|  
|![Záhlaví bez fokusu](../extensibility/ux-guidelines/media/0303-094-titlebarunfocused.png "0303 094_TitleBarUnfocused")<br /><br /> **Záhlaví bez fokusu**|Úchyt pro přetažení|`Environment.TitleBarDragHandle`|  
...
|![Záhlaví tlačítko, zaměřuje](../extensibility/ux-guidelines/media/0303-096-titlebarbuttonfocused.png "0303 096_TitleBarButtonFocused")<br /><br /> **Fokus**|Ohraničení|Není k dispozici|  
|![Záhlaví tlačítko bez fokusu](../extensibility/ux-guidelines/media/0303-097-titlebarbuttonunfocused.png "0303 097_TitleBarButtonUnfocused")<br /><br /> **Bez fokusu**|Pozadí|Není k dispozici|  
|![Záhlaví tlačítko bez fokusu](../extensibility/ux-guidelines/media/0303-097-titlebarbuttonunfocused.png "0303 097_TitleBarButtonUnfocused")<br /><br /> **Bez fokusu**|Popředí (piktogram)|`Environment.ToolWindowButtonInactiveGlyph`|  
|![Záhlaví tlačítko bez fokusu](../extensibility/ux-guidelines/media/0303-097-titlebarbuttonunfocused.png "0303 097_TitleBarButtonUnfocused")<br /><br /> **Bez fokusu**|Ohraničení|Není k dispozici|  
...
|![Tlačítko nadpisu, zaměřuje při najetí myší](../extensibility/ux-guidelines/media/0303-098-titlebarbuttonfocusedhover.png "0303 098_TitleBarButtonFocusedHover")<br /><br /> **Fokus**|Ohraničení|`Environment.ToolWindowButtonHoverActiveBorder`|  
|![Záhlaví tlačítka při najetí myší bez fokusu](../extensibility/ux-guidelines/media/0303-099-titlebarbuttonunfocusedhover.png "0303 099_TitleBarButtonUnfocusedHover")<br /><br /> **Bez fokusu**|Pozadí|`Environment.ToolWindowButtonHoverInactive`|  
|![Záhlaví tlačítka při najetí myší bez fokusu](../extensibility/ux-guidelines/media/0303-099-titlebarbuttonunfocusedhover.png "0303 099_TitleBarButtonUnfocusedHover")<br /><br /> **Bez fokusu**|Popředí (piktogram)|`Environment.ToolWindowButtonHoverInactiveGlyph`|  
|![Záhlaví tlačítka při najetí myší bez fokusu](../extensibility/ux-guidelines/media/0303-099-titlebarbuttonunfocusedhover.png "0303 099_TitleBarButtonUnfocusedHover")<br /><br /> **Bez fokusu**|Ohraničení|`Environment.ToolWindowButtonHoverInactiveBorder`|  
...
|![Záhlaví tlačítko, zaměřuje a stisknutí](../extensibility/ux-guidelines/media/0303-100-titlebarbuttonfocusedpressed.png "0303 100_TitleBarButtonFocusedPressed")<br /><br /> **Fokus**|Ohraničení|`Environment.ToolWindowButtonDownBorder`|  
|![Záhlaví tlačítko bez fokusu a při stisknutí](../extensibility/ux-guidelines/media/0303-101-titlebarbuttonunfocusedpressed.png "0303 101_TitleBarButtonUnfocusedPressed")<br /><br /> **Bez fokusu**|Pozadí|`Environment.ToolWindowButtonDown`|  
|![Záhlaví tlačítko bez fokusu a při stisknutí](../extensibility/ux-guidelines/media/0303-101-titlebarbuttonunfocusedpressed.png "0303 101_TitleBarButtonUnfocusedPressed")<br /><br /> **Bez fokusu**|Popředí (piktogram)|`Environment.ToolWindowButtonDownInactiveGlyph`|  
|![Záhlaví tlačítko bez fokusu a při stisknutí](../extensibility/ux-guidelines/media/0303-101-titlebarbuttonunfocusedpressed.png "0303 101_TitleBarButtonUnfocusedPressed")<br /><br /> **Bez fokusu**|Ohraničení|`Environment.ToolWindowButtonDownBorder`|  
...
|![Karta okna nástroje bez fokusu](../extensibility/ux-guidelines/media/0303-104-toolwindowtabunfocused.png "0303 104_ToolWindowTabUnfocused")<br /><br /> **Karta okna nástroje vybrané, bez fokusu**|Ohraničení|`Environment.ToolWindowTabSelectedBorder`<br /><br /> Nastavte stejnou barvu jako pozadí.|  
...
|![Karta Nástroje pro pozadí okna při najetí myší](../extensibility/ux-guidelines/media/0303-106-toolwindowbackgroundtabhover.png "0303 106_ToolWindowBackgroundTabHover")<br /><br /> **Karta okna nástroje na pozadí při najetí myší**|Ohraničení|`Environment.ToolWindowTabMouseOverBorder`<br /><br /> Nastavte stejnou barvu jako pozadí.|  
...
|![Automatické&#45;Skrýt kartu](../extensibility/ux-guidelines/media/0303-108-autohidetab.png "0303 108_AutoHideTab")<br /><br /> **Výchozí kartu automatického schovávání**|Ohraničení|`Environment.AutoHideTabBorder`|  
...
|![Automatické&#45;Skrýt kartu při najetí myší](../extensibility/ux-guidelines/media/0303-109-autohidetabhover.png "0303 109_AutoHideTabHover")<br /><br /> **Karta automatického schovávání při najetí myší**|Ohraničení|`Environment.AutoHideTabMouseOverBorder`|  
...
|![Tlačítko vyhledat akce, zaměřuje](../extensibility/ux-guidelines/media/0303-112-searchactionbuttonfocused.png "0303 112_SearchActionButtonFocused")<br /><br /> **Akce tlačítka**|Ohraničení|Není k dispozici|  
|![Hledání rozevírací&#45;tlačítko, zaměřuje](../extensibility/ux-guidelines/media/0303-113-searchdropdownbuttonfocused.png "0303 113_SearchDropdownButtonFocused")<br /><br /> **Tlačítko rozevíracího seznamu**|Pozadí|`SearchControl.FocusedDropDownButton`|  
|![Hledání rozevírací&#45;tlačítko, zaměřuje](../extensibility/ux-guidelines/media/0303-113-searchdropdownbuttonfocused.png "0303 113_SearchDropdownButtonFocused")<br /><br /> **Tlačítko rozevíracího seznamu**|Popředí (piktogram)|`SearchControl.FocusedDropDownButtonGlyph`|  
|![Hledání rozevírací&#45;tlačítko, zaměřuje](../extensibility/ux-guidelines/media/0303-113-searchdropdownbuttonfocused.png "0303 113_SearchDropdownButtonFocused")<br /><br /> **Tlačítko rozevíracího seznamu**|Ohraničení|`SearchControl.FocusedDropDownButtonBorder`|  
...
|![Vstupní pole hledání bez fokusu](../extensibility/ux-guidelines/media/0303-114-searchinputfieldunfocused.png "0303 114_SearchInputFieldUnfocused")<br /><br /> **Aktivní vstupní pole**|Ohraničení|`SearchControl.UnfocusedBorder`|  
|![Vstupní pole hledání bez fokusu](../extensibility/ux-guidelines/media/0303-114-searchinputfieldunfocused.png "0303 114_SearchInputFieldUnfocused")<br /><br /> **Aktivní vstupní pole**|Oddělovač|`SearchControl.DropDownSeparator`|  
|![Vstupní pole hledání bez fokusu a neaktivní](../extensibility/ux-guidelines/media/0303-114-1-searchinputfieldunfocusedinactive.png "0303. 114 1_SearchInputFieldUnfocusedInactive")<br /><br /> **Neaktivní vstupního pole**|Pozadí|`SearchControl.Unfocused`|  
|![Vstupní pole hledání bez fokusu a neaktivní](../extensibility/ux-guidelines/media/0303-114-1-searchinputfieldunfocusedinactive.png "0303. 114 1_SearchInputFieldUnfocusedInactive")<br /><br /> **Neaktivní vstupního pole**|Popředí (Text)|`SearchControl.Unfocused`|  
|![Vstupní pole hledání bez fokusu a neaktivní](../extensibility/ux-guidelines/media/0303-114-1-searchinputfieldunfocusedinactive.png "0303. 114 1_SearchInputFieldUnfocusedInactive")<br /><br /> **Neaktivní vstupního pole**|Ohraničení|`SearchControl.UnfocusedBorder`|  
|![Vstupní pole hledání bez fokusu a neaktivní](../extensibility/ux-guidelines/media/0303-114-1-searchinputfieldunfocusedinactive.png "0303. 114 1_SearchInputFieldUnfocusedInactive")<br /><br /> **Neaktivní vstupního pole**|Oddělovač|`SearchControl.DropDownSeparator`|  
|![Tlačítko akce hledání bez fokusu](../extensibility/ux-guidelines/media/0303-115-searchactionbuttonunfocused.png "0303 115_SearchActionButtonUnfocused")<br /><br /> **Akce tlačítka**|Pozadí|Není k dispozici|  
|![Tlačítko akce hledání bez fokusu](../extensibility/ux-guidelines/media/0303-115-searchactionbuttonunfocused.png "0303 115_SearchActionButtonUnfocused")<br /><br /> **Akce tlačítka**|Popředí (piktogram vyhledávání)|`SearchControl.SearchGlyph`|  
|![Tlačítko akce hledání bez fokusu](../extensibility/ux-guidelines/media/0303-115-searchactionbuttonunfocused.png "0303 115_SearchActionButtonUnfocused")<br /><br /> **Akce tlačítka**|Popředí (Zastavit piktogram)|`SearchControl.StopGlyph`|  
|![Tlačítko akce hledání bez fokusu](../extensibility/ux-guidelines/media/0303-115-searchactionbuttonunfocused.png "0303 115_SearchActionButtonUnfocused")<br /><br /> **Akce tlačítka**|Popředí (Vymazat piktogram)|`SearchControl.ClearGlyph`|  
|![Tlačítko akce hledání bez fokusu](../extensibility/ux-guidelines/media/0303-115-searchactionbuttonunfocused.png "0303 115_SearchActionButtonUnfocused")<br /><br /> **Akce tlačítka**|Ohraničení|Není k dispozici|  
|![Hledání rozevírací&#45;tlačítko bez fokusu](../extensibility/ux-guidelines/media/0303-116-searchdropdownbuttonunfocused.png "0303 116_SearchDropdownButtonUnfocused")<br /><br /> **Tlačítko rozevíracího seznamu**|Pozadí|`SearchControl.UnfocusedDropDownButton`|  
|![Hledání rozevírací&#45;tlačítko bez fokusu](../extensibility/ux-guidelines/media/0303-116-searchdropdownbuttonunfocused.png "0303 116_SearchDropdownButtonUnfocused")<br /><br /> **Tlačítko rozevíracího seznamu**|Popředí (piktogram)|`SearchControl.UnfocusedDropDownButtonGlyph`|  
|![Hledání rozevírací&#45;tlačítko bez fokusu](../extensibility/ux-guidelines/media/0303-116-searchdropdownbuttonunfocused.png "0303 116_SearchDropdownButtonUnfocused")<br /><br /> **Tlačítko rozevíracího seznamu**|Ohraničení|`SearchControl.UnfocusedDropDownButtonBorder`|  
...
|![Stisknutí tlačítka akce hledání](../extensibility/ux-guidelines/media/0303-116-1-searchactionbuttonpressed.png "0303. 116 1_SearchActionButtonPressed")<br /><br /> **Akce tlačítka**|Ohraničení|`SearchControl.ActionButtonMouseDownBorder`|  
|![Hledání rozevírací&#45;dolů stisknutí tlačítka](../extensibility/ux-guidelines/media/0303-116-2-searchdropdownbuttonpressed.png "0303. 116 2_SearchDropdownButtonPressed")<br /><br /> **Tlačítko rozevíracího seznamu**|Pozadí|`SearchControl.MouseDownDropDownButton`|  
|![Hledání rozevírací&#45;dolů stisknutí tlačítka](../extensibility/ux-guidelines/media/0303-116-2-searchdropdownbuttonpressed.png "0303. 116 2_SearchDropdownButtonPressed")<br /><br /> **Tlačítko rozevíracího seznamu**|Popředí (piktogram)|`SearchControl.MouseDownDropDownButtonGlyph`|  
|![Hledání rozevírací&#45;dolů stisknutí tlačítka](../extensibility/ux-guidelines/media/0303-116-2-searchdropdownbuttonpressed.png "0303. 116 2_SearchDropdownButtonPressed")<br /><br /> **Tlačítko rozevíracího seznamu**|Ohraničení|`SearchControl.MouseDownDropDownButtonBorder`|  
...
|![Tlačítko hledání akce zakázané](../extensibility/ux-guidelines/media/0303-122-searchactionbuttondisabled.png "0303 122_SearchActionButtonDisabled")<br /><br /> **Akce tlačítka**|Ohraničení|Žádná|  
...
|![Hledání rozevírací&#45;tlačítko zakázané](../extensibility/ux-guidelines/media/0303-123-searchdropdownbuttondisabled.png "0303 123_SearchDropdownButtonDisabled")<br /><br /> **Tlačítko rozevíracího seznamu**|Ohraničení|Žádná|  
...
|![Zaškrtávací políčko Hledat](../extensibility/ux-guidelines/media/0303-126-searchcheckbox.png "0303 126_SearchCheckbox")<br /><br /> **Možnosti hledání (zaškrtávací políčko)**|Popředí (zaškrtávací políčko text)|`SearchControl.PopupCheckboxText`|  
...
|![Hledání navrhované při najetí myší](../extensibility/ux-guidelines/media/0303-128-searchsuggestedhover.png "0303 128_SearchSuggestedHover")<br /><br /> **Navrhované hledání**|Ohraničení|`SearchControl.PopupControlMouseOverBorder`|  
|![Zaškrtávací políčko Hledat při najetí myší](../extensibility/ux-guidelines/media/0303-129-searchcheckboxhover.png "0303 129_SearchCheckboxHover")<br /><br /> **Navrhované vyhledávání (zaškrtávací políčko)**|Pozadí|`SearchControl.PopupControlMouseOverBackgroundGradientBegin`<br /><br /> Přestože nepoužívá moderní uživatelské rozhraní s motivem, existují Přechodové zarážky a hodnoty pro tato na pozadí.|  
|![Možnosti při najetí myší hledání](../extensibility/ux-guidelines/media/0303-130-searchoptionshover.png "0303 130_SearchOptionsHover")<br /><br /> **Možnosti hledání**|Pozadí|`SearchControl.PopupControlMouseOverBackgroundGradientBegin`<br /><br /> Přestože nepoužívá moderní uživatelské rozhraní s motivem, existují Přechodové zarážky a hodnoty pro tato na pozadí.|  
|![Zaškrtávací políčko Hledat při najetí myší](../extensibility/ux-guidelines/media/0303-129-searchcheckboxhover.png "0303 129_SearchCheckboxHover")<br /><br /> **Navrhované vyhledávání (zaškrtávací políčko)**|Popředí (zaškrtávací políčko text)|`SearchControl.PopupCheckboxMouseDownText`|  
|![Možnosti při najetí myší hledání](../extensibility/ux-guidelines/media/0303-130-searchoptionshover.png "0303 130_SearchOptionsHover")<br /><br /> **Možnosti hledání**|Popředí (zaškrtávací políčko text)|`SearchControl.PopupCheckboxMouseDownText`|  
|![Zaškrtávací políčko Hledat při najetí myší](../extensibility/ux-guidelines/media/0303-129-searchcheckboxhover.png "0303 129_SearchCheckboxHover")<br /><br /> **Navrhované vyhledávání (zaškrtávací políčko)**|Popředí (text odkazu)|`SearchControl.PopupButtonMouseDownText`|  
|![Možnosti při najetí myší hledání](../extensibility/ux-guidelines/media/0303-130-searchoptionshover.png "0303 130_SearchOptionsHover")<br /><br /> **Možnosti hledání**|Popředí (text odkazu)|`SearchControl.PopupButtonMouseDownText`|  
|![Zaškrtávací políčko Hledat při najetí myší](../extensibility/ux-guidelines/media/0303-129-searchcheckboxhover.png "0303 129_SearchCheckboxHover")<br /><br /> **Navrhované vyhledávání (zaškrtávací políčko)**|Ohraničení|`SearchControl.PopupControlMouseOverBorder`|  
|![Možnosti při najetí myší hledání](../extensibility/ux-guidelines/media/0303-130-searchoptionshover.png "0303 130_SearchOptionsHover")<br /><br /> **Možnosti hledání**|Ohraničení|`SearchControl.PopupControlMouseOverBorder`|  
...
|![Možnosti stisknutí hledání](../extensibility/ux-guidelines/media/0303-132-searchoptionspressed.png "0303 132_SearchOptionsPressed")<br /><br /> **Možnosti hledání**|Pozadí zaškrtávacího políčka|`SearchControl.PopupControlMouseDownBackgroundGradientEnd`<br /><br /> Přestože nepoužívá moderní uživatelské rozhraní s motivem, existují Přechodové zarážky a hodnoty pro tato na pozadí.|  
|![Hledání navrhované stisknutí](../extensibility/ux-guidelines/media/0303-131-searchsuggestedpressed.png "0303 131_SearchSuggestedPressed")<br /><br /> **Navrhované vyhledávání (zaškrtávací políčko)**|Popředí (zaškrtávací políčko text)|`SearchControl.PopupCheckboxMouseDownText`|  
|![Možnosti stisknutí hledání](../extensibility/ux-guidelines/media/0303-132-searchoptionspressed.png "0303 132_SearchOptionsPressed")<br /><br /> **Možnosti hledání**|Popředí (zaškrtávací políčko text)|`SearchControl.PopupCheckboxMouseDownText`|  
|![Hledání navrhované stisknutí](../extensibility/ux-guidelines/media/0303-131-searchsuggestedpressed.png "0303 131_SearchSuggestedPressed")<br /><br /> **Navrhované vyhledávání (zaškrtávací políčko)**|Odkaz na pozadí|`SearchControl.PopupButtonMouseDownBackgroundGradientBegin`<br /><br /> Přestože nepoužívá moderní uživatelské rozhraní s motivem, existují Přechodové zarážky a hodnoty pro tato na pozadí.|  
|![Možnosti stisknutí hledání](../extensibility/ux-guidelines/media/0303-132-searchoptionspressed.png "0303 132_SearchOptionsPressed")<br /><br /> **Možnosti hledání**|Odkaz na pozadí|`SearchControl.PopupButtonMouseDownBackgroundGradientBegin`<br /><br /> Přestože nepoužívá moderní uživatelské rozhraní s motivem, existují Přechodové zarážky a hodnoty pro tato na pozadí.|  
|![Hledání navrhované stisknutí](../extensibility/ux-guidelines/media/0303-131-searchsuggestedpressed.png "0303 131_SearchSuggestedPressed")<br /><br /> **Navrhované vyhledávání (zaškrtávací políčko)**|Popředí (text odkazu)|`SearchControl.PopupButtonMouseDownText`|  
|![Možnosti stisknutí hledání](../extensibility/ux-guidelines/media/0303-132-searchoptionspressed.png "0303 132_SearchOptionsPressed")<br /><br /> **Možnosti hledání**|Popředí (text odkazu)|`SearchControl.PopupButtonMouseDownText`|  
...
#### <a name="scroll-bar"></a>Posuvník  
 Posuvníky jsou ve stylu prostředím sady Visual Studio a nebude nutné použít motiv. Ale můžete se rozhodnout, že chcete využít barvy použité v posuvníky tak, aby vaše uživatelské rozhraní se vždy zobrazí konzistentní s tímto tuto část prostředí sady Visual Studio.  
...
|![Šipky posuvníku](../extensibility/ux-guidelines/media/0303-142-scrollbararrow.png "0303 142_ScrollbarArrow")<br /><br /> **Posouvací šipky**|Pozadí|`Environment.ScrollBarArrowBackground`<br /><br /> Nastavte stejnou barvu jako posuvníku.|  
|![Šipky posuvníku](../extensibility/ux-guidelines/media/0303-142-scrollbararrow.png "0303 142_ScrollbarArrow")<br /><br /> **Posouvací šipky**|Popředí (piktogram)|`Environment.ScrollBarArrowGlyph`|  
...
|![Posuvníku šipky při najetí myší](../extensibility/ux-guidelines/media/0303-144-scrollbararrowhover.png "0303 144_ScrollbarArrowHover")<br /><br /> **Posouvací šipky**|Pozadí|`Environment.ScrollBarArrowMouseOverBackground`<br /><br /> Nastavte stejnou barvu jako posuvníku.|  
|![Posuvníku šipky při najetí myší](../extensibility/ux-guidelines/media/0303-144-scrollbararrowhover.png "0303 144_ScrollbarArrowHover")<br /><br /> **Posouvací šipky**|Popředí (piktogram)|`Environment.ScrollBarArrowGlyphMouseOver`|  
...
|![Zobrazení stromové struktury](../extensibility/ux-guidelines/media/0303-148-treeview.png "0303 148_TreeView")|Popředí (piktogram)|`TreeView.Glyph`|  
|![Zobrazení stromové struktury](../extensibility/ux-guidelines/media/0303-148-treeview.png "0303 148_TreeView")|Ohraničení|Žádná|  
...
|![Stromové zobrazení dragover](../extensibility/ux-guidelines/media/0303-150-treeviewdragover.png "0303 150_TreeViewDragOver")|Popředí (piktogram)|`TreeView.DragOverItemGlyph`|  
|![Stromové zobrazení dragover](../extensibility/ux-guidelines/media/0303-150-treeviewdragover.png "0303 150_TreeViewDragOver")|Ohraničení|Žádná|  
...
|![Stromové zobrazení, zaměřuje](../extensibility/ux-guidelines/media/0303-151-treeviewfocused.png "0303 151_TreeViewFocused")<br /><br /> **Fokus**|Popředí (piktogram)|`TreeView.SelectedItemActiveGlyph`|  
|![Stromové zobrazení, zaměřuje](../extensibility/ux-guidelines/media/0303-151-treeviewfocused.png "0303 151_TreeViewFocused")<br /><br /> **Fokus**|Ohraničení|`TreeView.FocusVisualBorder`|  
|![Stromové zobrazení bez fokusu](../extensibility/ux-guidelines/media/0303-152-treeviewunfocused.png "0303 152_TreeViewUnfocused")<br /><br /> **Bez fokusu**|Pozadí|`TreeView.SelectedItemInactive`|  
|![Stromové zobrazení bez fokusu](../extensibility/ux-guidelines/media/0303-152-treeviewunfocused.png "0303 152_TreeViewUnfocused")<br /><br /> **Bez fokusu**|Popředí (Text)|`TreeView.SelectedItemInactive`|  
|![Stromové zobrazení bez fokusu](../extensibility/ux-guidelines/media/0303-152-treeviewunfocused.png "0303 152_TreeViewUnfocused")<br /><br /> **Bez fokusu**|Popředí (piktogram)|`TreeView.SelectedItemInactiveGlyph`|  
|![Stromové zobrazení bez fokusu](../extensibility/ux-guidelines/media/0303-152-treeviewunfocused.png "0303 152_TreeViewUnfocused")<br /><br /> **Bez fokusu**|Ohraničení|Žádná|  
...
|![Stromové zobrazení, zaměřuje při najetí myší](../extensibility/ux-guidelines/media/0303-153-treeviewfocusedhover.png "0303 153_TreeViewFocusedHover")<br /><br /> **Fokus**|Popředí (piktogram)|`TreeView.SelectedItemActiveGlyphMouseOver`|  
|![Stromové zobrazení, zaměřuje při najetí myší](../extensibility/ux-guidelines/media/0303-153-treeviewfocusedhover.png "0303 153_TreeViewFocusedHover")<br /><br /> **Fokus**|Ohraničení|None`TreeView.FocusVisualBorder`|  
|![Stromové zobrazení bez fokusu při najetí myší](../extensibility/ux-guidelines/media/0303-154-treeviewunfocusedhover.png "0303 154_TreeViewUnfocusedHover")<br /><br /> **Bez fokusu**|Pozadí|`TreeView.SelectedItemInactive`|  
|![Stromové zobrazení bez fokusu při najetí myší](../extensibility/ux-guidelines/media/0303-154-treeviewunfocusedhover.png "0303 154_TreeViewUnfocusedHover")<br /><br /> **Bez fokusu**|Popředí (Text)|`TreeView.SelectedItemInactive`|  
|![Stromové zobrazení bez fokusu při najetí myší](../extensibility/ux-guidelines/media/0303-154-treeviewunfocusedhover.png "0303 154_TreeViewUnfocusedHover")<br /><br /> **Bez fokusu**|Popředí (piktogram)|`TreeView.SelectedItemActiveGlyphMouseOver`|  
|![Stromové zobrazení bez fokusu při najetí myší](../extensibility/ux-guidelines/media/0303-154-treeviewunfocusedhover.png "0303 154_TreeViewUnfocusedHover")<br /><br /> **Bez fokusu**|Ohraničení|Žádná|  
...
|![Zaškrtněte políčko](../extensibility/ux-guidelines/media/0303-162-checkbox.png "0303 162_Checkbox")|Text|`CommonControls.CheckBoxText`|  
|![Zaškrtněte políčko](../extensibility/ux-guidelines/media/0303-162-checkbox.png "0303 162_Checkbox")|Piktogram|`CommonControls.CheckBoxGlyph`|  
...
|![Zaškrtávací políčko zakázán](../extensibility/ux-guidelines/media/0303-163-checkboxdisabled.png "0303 163_CheckboxDisabled")|Text|`CommonControls.CheckBoxTextDisabled`|  
|![Zaškrtávací políčko zakázán](../extensibility/ux-guidelines/media/0303-163-checkboxdisabled.png "0303 163_CheckboxDisabled")|Piktogram|`CommonControls.CheckBoxGlyphDisabled`|  
...
|![Zaškrtněte políčko při najetí myší](../extensibility/ux-guidelines/media/0303-164-checkboxhover.png "0303 164_CheckboxHover")|Text|`CommonControls.CheckBoxTextHover`|  
|![Zaškrtněte políčko při najetí myší](../extensibility/ux-guidelines/media/0303-164-checkboxhover.png "0303 164_CheckboxHover")|Piktogram|`CommonControls.CheckBoxGlyphHover`|  
...
|![Zaškrtněte políčko stisknutí](../extensibility/ux-guidelines/media/0303-165-checkboxpressed.png "0303 165_CheckboxPressed")|Text|`CommonControls.CheckBoxTextPressed`|  
|![Zaškrtněte políčko stisknutí](../extensibility/ux-guidelines/media/0303-165-checkboxpressed.png "0303 165_CheckboxPressed")|Piktogram|`CommonControls.CheckBoxGlyphPressed`|  
...
|![Zaškrtněte políčko, zaměřuje](../extensibility/ux-guidelines/media/0303-166-checkboxfocused.png "0303 166_CheckboxFocused")|Text|`CommonControls.CheckBoxTextFocused`|  
|![Zaškrtněte políčko, zaměřuje](../extensibility/ux-guidelines/media/0303-166-checkboxfocused.png "0303 166_CheckboxFocused")|Piktogram|`CommonControls.CheckBoxGlyphFocused`|  
...
|![Vyřadit&#45;dolů&#47;– pole se seznamem](../extensibility/ux-guidelines/media/0303-168-dropdowncombobox.png "0303 168_DropDownComboBox")|Text|`CommonControls.ComboBoxText`|  
|![Vyřadit&#45;dolů&#47;– pole se seznamem](../extensibility/ux-guidelines/media/0303-168-dropdowncombobox.png "0303 168_DropDownComboBox")|Oddělovač|`CommonControls.ComboBoxSeparator`|  
|![Vyřadit&#45;dolů&#47;– pole se seznamem](../extensibility/ux-guidelines/media/0303-168-dropdowncombobox.png "0303 168_DropDownComboBox")|Piktogram|`CommonControls.ComboBoxGlyph`|  
|![Vyřadit&#45;dolů&#47;– pole se seznamem](../extensibility/ux-guidelines/media/0303-168-dropdowncombobox.png "0303 168_DropDownComboBox")|Piktogram na pozadí|`CommonControls.ComboBoxGlyphBackground`|  
...
|![Vyřadit&#45;dolů&#47;– pole se seznamem zakázané](../extensibility/ux-guidelines/media/0303-169-dropdowncomboboxdisabled.png "0303 169_DropDownComboBoxDisabled")|Text|`CommonControls.ComboBoxTextDisabled`|  
|![Vyřadit&#45;dolů&#47;– pole se seznamem zakázané](../extensibility/ux-guidelines/media/0303-169-dropdowncomboboxdisabled.png "0303 169_DropDownComboBoxDisabled")|Oddělovač|`CommonControls.ComboBoxSeparatorDisabled`|  
|![Vyřadit&#45;dolů&#47;– pole se seznamem zakázané](../extensibility/ux-guidelines/media/0303-169-dropdowncomboboxdisabled.png "0303 169_DropDownComboBoxDisabled")|Piktogram|`CommonControls.ComboBoxGlyphDisabled`|  
|![Vyřadit&#45;dolů&#47;– pole se seznamem zakázané](../extensibility/ux-guidelines/media/0303-169-dropdowncomboboxdisabled.png "0303 169_DropDownComboBoxDisabled")|Piktogram na pozadí|`CommonControls.ComboBoxGlyphBackgroundDisabled`|  
...
|![Vyřadit&#45;dolů&#47;– pole se seznamem při najetí myší](../extensibility/ux-guidelines/media/0303-170-dropdowncomboboxhover.png "0303 170_DropDownComboBoxHover")|Text|`CommonControls.ComboBoxTextHover`|  
|![Vyřadit&#45;dolů&#47;– pole se seznamem při najetí myší](../extensibility/ux-guidelines/media/0303-170-dropdowncomboboxhover.png "0303 170_DropDownComboBoxHover")|Oddělovač|`CommonControls.ComboBoxSeparatorHover`|  
|![Vyřadit&#45;dolů&#47;– pole se seznamem při najetí myší](../extensibility/ux-guidelines/media/0303-170-dropdowncomboboxhover.png "0303 170_DropDownComboBoxHover")|Piktogram|`CommonControls.ComboBoxGlyphHover`|  
|![Vyřadit&#45;dolů&#47;– pole se seznamem při najetí myší](../extensibility/ux-guidelines/media/0303-170-dropdowncomboboxhover.png "0303 170_DropDownComboBoxHover")|Piktogram na pozadí|`CommonControls.ComboBoxGlyphBackgroundHover`|  
...
|![Vyřadit&#45;dolů&#47;– pole se seznamem stisknutí](../extensibility/ux-guidelines/media/0303-171-dropdowncomboboxpressed.png "0303 171_DropDownComboBoxPressed")|Text|`CommonControls.ComboBoxTextPressed`|  
|![Vyřadit&#45;dolů&#47;– pole se seznamem stisknutí](../extensibility/ux-guidelines/media/0303-171-dropdowncomboboxpressed.png "0303 171_DropDownComboBoxPressed")|Oddělovač|`CommonControls.ComboBoxSeparatorPressed`|  
|![Vyřadit&#45;dolů&#47;– pole se seznamem stisknutí](../extensibility/ux-guidelines/media/0303-171-dropdowncomboboxpressed.png "0303 171_DropDownComboBoxPressed")|Piktogram|`CommonControls.ComboBoxGlyphPressed`|  
|![Vyřadit&#45;dolů&#47;– pole se seznamem stisknutí](../extensibility/ux-guidelines/media/0303-171-dropdowncomboboxpressed.png "0303 171_DropDownComboBoxPressed")|Piktogram na pozadí|`CommonControls.ComboBoxGlyphBackgroundPressed`|  
...
|![Vyřadit&#45;dolů&#47;pole se seznamem, zaměřuje](../extensibility/ux-guidelines/media/0303-172-dropdowncomboboxfocused.png "0303 172_DropDownComboBoxFocused")|Text|`CommonControls.ComboBoxTextFocused`|  
|![Vyřadit&#45;dolů&#47;pole se seznamem, zaměřuje](../extensibility/ux-guidelines/media/0303-172-dropdowncomboboxfocused.png "0303 172_DropDownComboBoxFocused")|Oddělovač|`CommonControls.ComboBoxSeparatorFocused`|  
|![Vyřadit&#45;dolů&#47;pole se seznamem, zaměřuje](../extensibility/ux-guidelines/media/0303-172-dropdowncomboboxfocused.png "0303 172_DropDownComboBoxFocused")|Piktogram|`CommonControls.ComboBoxGlyphFocused`|  
|![Vyřadit&#45;dolů&#47;pole se seznamem, zaměřuje](../extensibility/ux-guidelines/media/0303-172-dropdowncomboboxfocused.png "0303 172_DropDownComboBoxFocused")|Piktogram na pozadí|`CommonControls.ComboBoxGlyphBackgroundFocused`|  
...
|Součást|Prvek|Název tokenu: Color.category|  
|---------------|-------------|--------------------------------|  
|![Vyřadit&#45;dolů&#47;zobrazení seznamu pole se seznamem](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303 174_DropDownComboBoxListView")|Pozadí|`CommonControls.ComboBoxListBackground`|  
|![Vyřadit&#45;dolů&#47;zobrazení seznamu pole se seznamem](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303 174_DropDownComboBoxListView")|Pozadí|`CommonControls.ComboBoxListBackgroundHover`|  
|![Vyřadit&#45;dolů&#47;zobrazení seznamu pole se seznamem](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303 174_DropDownComboBoxListView")|Pozadí|`CommonControls.ComboBoxListItemBackgroundPressed`|  
|![Vyřadit&#45;dolů&#47;zobrazení seznamu pole se seznamem](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303 174_DropDownComboBoxListView")|Pozadí|`CommonControls.ComboBoxListItemBackgroundFocused`|  
|![Vyřadit&#45;dolů&#47;zobrazení seznamu pole se seznamem](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303 174_DropDownComboBoxListView")|Ohraničení|`CommonControls.ComboBoxListBorder`|  
|![Vyřadit&#45;dolů&#47;zobrazení seznamu pole se seznamem](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303 174_DropDownComboBoxListView")|Ohraničení|`CommonControls.ComboBoxListBorderHover`|  
|![Vyřadit&#45;dolů&#47;zobrazení seznamu pole se seznamem](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303 174_DropDownComboBoxListView")|Ohraničení|`CommonControls.ComboBoxListBorderPressed`|  
|![Vyřadit&#45;dolů&#47;zobrazení seznamu pole se seznamem](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303 174_DropDownComboBoxListView")|Ohraničení|`CommonControls.ComboBoxListBorderFocused`|  
|![Vyřadit&#45;dolů&#47;zobrazení seznamu pole se seznamem](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303 174_DropDownComboBoxListView")|Text položky|`CommonControls.ComboBoxListItemText`|  
|![Vyřadit&#45;dolů&#47;zobrazení seznamu pole se seznamem](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303 174_DropDownComboBoxListView")|Text položky|`CommonControls.ComboBoxListItemTextHover`|  
|![Vyřadit&#45;dolů&#47;zobrazení seznamu pole se seznamem](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303 174_DropDownComboBoxListView")|Text položky|`CommonControls.ComboBoxListItemTextPressed`|  
|![Vyřadit&#45;dolů&#47;zobrazení seznamu pole se seznamem](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303 174_DropDownComboBoxListView")|Text položky|`CommonControls.ComboBoxListItemTextFocused`|  
|![Vyřadit&#45;dolů&#47;zobrazení seznamu pole se seznamem](../extensibility/ux-guidelines/media/0303-174-dropdowncomboboxlistview.png "0303 174_DropDownComboBoxListView")|Stín pozadí|`CommonControls.ComboBoxListBackgroundShadow`|  
...
|![Označit při najetí myší](../extensibility/ux-guidelines/media/0303-178-taghover.png "0303 178_TagHover")<br /><br /> **Při najetí myší**|Pozadí|`Tag.HoverBackground`|  
|![Označit při najetí myší](../extensibility/ux-guidelines/media/0303-178-taghover.png "0303 178_TagHover")<br /><br /> **Při najetí myší**|Popředí (Text)|`Tag.HoverBackgroundText`|  
|![Značka stisknutí](../extensibility/ux-guidelines/media/0303-179-tagpressed.png "0303 179_TagPressed")<br /><br /> **Stisknutí**|Pozadí|`Tag.PressedBackground`|  
|![Značka stisknutí](../extensibility/ux-guidelines/media/0303-179-tagpressed.png "0303 179_TagPressed")<br /><br /> **Stisknutí**|Popředí (Text)|`Tag.PressedBackgroundText`|  
|![Vybrané značky](../extensibility/ux-guidelines/media/0303-180-tagselected.png "0303 180_TagSelected")<br /><br /> **Vybrané**|Pozadí|`Tag.SelectedBackground`|  
|![Vybrané značky](../extensibility/ux-guidelines/media/0303-180-tagselected.png "0303 180_TagSelected")<br /><br /> **Vybrané**|Popředí (Text)|`Tag.SelectedBackgroundText`|  
...
|![Značka &#40;piktogram&#41; při najetí myší](../extensibility/ux-guidelines/media/0303-182-tagglyphhover.png "0303 182_TagGlyphHover")<br /><br /> **Podržte ukazatel myši (výchozí značky)**|Ohraničení|`Tag.TagHoverGlyphHoverBorder`|  
...
|![Značka &#40;piktogram&#41; stisknutí](../extensibility/ux-guidelines/media/0303-183-tagglyphpressed.png "0303 183_TagGlyphPressed")<br /><br /> **Stisknutí (výchozí značky)**|Ohraničení|`Tag.TagHoverGlyphPressedBorder`|  
...
|![Značky, které vybrali při najetí myší](../extensibility/ux-guidelines/media/0303-185-tagselectedhover.png "0303 185_TagSelectedHover")<br /><br /> **Podržte ukazatel myši (značky)**|Ohraničení|`Tag.TagSelectedGlyphHoverBorder`|  
...
|![Vybrané značky stisknutí](../extensibility/ux-guidelines/media/0303-186-tagselectedpressed.png "0303 186_TagSelectedPressed")<br /><br /> **Při stisknutí (značky)**|Ohraničení|`Tag.TagSelectedGlyphPressedBorder`|  
...
|Vrstvu na nejvyšší úrovni|Pozadí<br /><br /> *Přechod zastaví nastavenou na hodnotu barvy v aplikaci Visual Studio 2013 světla a tmavé motivy.*|`Environment.EnvironmentBackgroundGradientMiddle1`|  
|Vrstvu na nejvyšší úrovni|Pozadí<br /><br /> *Přechod zastaví nastavenou na hodnotu barvy v aplikaci Visual Studio 2013 světla a tmavé motivy.*|`Environment.EnvironmentBackgroundGradientMiddle2`|  
...
|Panel nabídek|Pozadí<br /><br /> *Přechod zastaví nastavenou na hodnotu barvy v aplikaci Visual Studio 2013 světla a tmavé motivy.*|`Environment.CommandShelfHighlightGradientEnd`|  
|Panel příkazů|Pozadí<br /><br /> *Přechod zastaví nastavenou na hodnotu barvy v aplikaci Visual Studio 2013 světla a tmavé motivy.*|`Environment.CommandShelfBackgroundGradientBegin`|  
|Panel příkazů|Pozadí<br /><br /> *Přechod zastaví nastavenou na hodnotu barvy v aplikaci Visual Studio 2013 světla a tmavé motivy.*|`Environment.CommandShelfBackgroundGradientMiddle`|  
|Panel příkazů|Pozadí<br /><br /> *Přechod zastaví nastavenou na hodnotu barvy v aplikaci Visual Studio 2013 světla a tmavé motivy.*|`Environment.CommandShelfBackgroundGradientEnd`|  
...
|![Panel nástrojů podřízený uzel](../extensibility/ux-guidelines/media/0303-191-toolboxchildnode.png "0303 191_ToolboxChildNode")<br /><br /> **Podřízený uzel**|Popředí (Text)|`Environment.ToolboxContent`|  
...
|![Panel nástrojů nadřazeného uzlu, zaměřuje](../extensibility/ux-guidelines/media/0303-193-toolboxparentnodefocused.png "0303 193_ToolboxParentNodeFocused")<br /><br /> **Cílené nadřazený uzel**|Ohraničení|`TreeView.FocusVisualBorder`<br /><br /> Z [zobrazení stromové struktury](../misc/shared-colors.md#BKMK_TreeView) kategorie|  
|![Panel nástrojů podřízený uzel, zaměřuje](../extensibility/ux-guidelines/media/0303-194-toolboxchildnodefocused.png "0303 194_ToolboxChildNodeFocused")<br /><br /> **Cílené podřízený uzel**|Ohraničení|`TreeView.FocusVisualBorder`<br /><br /> Z [zobrazení stromové struktury](../misc/shared-colors.md#BKMK_TreeView) kategorie|  
|![Panel nástrojů nadřazeného uzlu, zaměřuje](../extensibility/ux-guidelines/media/0303-193-toolboxparentnodefocused.png "0303 193_ToolboxParentNodeFocused")<br /><br /> **Cílené nadřazený uzel**|Popředí (piktogram)|`TreeView.SelectedItemActive`<br /><br /> Z [zobrazení stromové struktury](../misc/shared-colors.md#BKMK_TreeView) kategorie|  
|![Panel nástrojů podřízený uzel, zaměřuje](../extensibility/ux-guidelines/media/0303-194-toolboxchildnodefocused.png "0303 194_ToolboxChildNodeFocused")<br /><br /> **Cílené podřízený uzel**|Popředí (piktogram)|`TreeView.SelectedItemActive`<br /><br /> Z [zobrazení stromové struktury](../misc/shared-colors.md#BKMK_TreeView) kategorie|  
|![Panel nástrojů nadřazeného uzlu, zaměřuje](../extensibility/ux-guidelines/media/0303-193-toolboxparentnodefocused.png "0303 193_ToolboxParentNodeFocused")<br /><br /> **Cílené nadřazený uzel**|Popředí (Text)|`TreeView.SelectedItemActive`<br /><br /> Z [zobrazení stromové struktury](../misc/shared-colors.md#BKMK_TreeView) kategorie|  
...
|![Panel nástrojů podřízený uzel bez fokusu](../extensibility/ux-guidelines/media/0303-196-toolboxchildnodeunfocused.png "0303 196_ToolboxChildNodeUnfocused")<br /><br /> **Bez fokusu podřízený uzel**|Popředí (Text)|`TreeView.SelectedItemInactive`<br /><br /> Z [zobrazení stromové struktury](../misc/shared-colors.md#BKMK_TreeView) kategorie|  
  
## <a name="color-value-reference"></a>Referenční informace k hodnotám barev  
  
|||||||||  
|-|-|-|-|-|-|-|-|  
|Součást|Část|Prvek|Stav|Světlý|Tmavý|Modrá|Vysoký kontrast|  
|Oddělovač řádků|||Výchozí|FFEEEEF2|FF2D2D30|FFEEEEF2|ControlDark|  
|Piktogram rozbalení||Popředí|Výchozí|||||  
|Piktogram rozbalení||Popředí|Při najetí myší|||||  
|Piktogram rozbalení||Pozadí|Výchozí|||||  
|Piktogram rozbalení||Pozadí|Při najetí myší|||||  
|Piktogram rozbalení||Ohraničení|Výchozí|||||  
|Piktogram rozbalení||Ohraničení|Při najetí myší|||||