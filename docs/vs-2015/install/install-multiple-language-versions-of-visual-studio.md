...
## <a name="see-also"></a>Viz také
 [Microsoft Language Interface sady LIP () a Visual Studio](../install/microsoft-language-interface-packs-lips-and-visual-studio.md) [instalaci sady Visual Studio](../install/install-visual-studio-2015.md)