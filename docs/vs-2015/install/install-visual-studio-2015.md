...
##  <a name="custom"></a> Výchozí vs. Vlastní instalace  
 ...
 Vlastní komponenty zahrnují Visual C++, Visual F #, SQL Server Data Tools, nástrojů pro různé platformy mobilních a sady SDK a třetí strany sady SDK a rozšíření. Některé z těchto komponent vlastní programy můžete nainstalovat později, i pokud nevyberete je při počátečním nastavení.  
