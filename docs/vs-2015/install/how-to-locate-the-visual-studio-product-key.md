---
title: 'Postupy: Locate the Visual Studio Product Key | Dokumentace Microsoftu'
ms.custom: ''
ms.date: 11/15/2016
...
## <a name="see-also"></a>Viz také  
 [Postupy: Upgrade ze zkušební edice sady Visual Studio](../install/how-to-upgrade-from-a-trial-edition-of-visual-studio.md)   
 [Instalace sady Visual Studio](../install/install-visual-studio-2015.md)   
 [Visual Studio a dokument White Paper správy licencí MSDN](http://go.microsoft.com/fwlink/?LinkId=191417)