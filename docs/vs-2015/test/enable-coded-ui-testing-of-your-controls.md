...
Nejnovější verzi tohoto tématu můžete najít v [povolit kódované UI Testing of Your Controls](https://docs.microsoft.com/visualstudio/test/enable-coded-ui-testing-of-your-controls).  
