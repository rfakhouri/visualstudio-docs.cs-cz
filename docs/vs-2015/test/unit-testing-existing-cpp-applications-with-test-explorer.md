...
2. V Průzkumníku testů, zvolte **spustit všechny**.  
   ...
   Další informace najdete v tématu [rychlý Start: Testu řízeného rozvoje pomocí Průzkumníka testů](../test/quick-start-test-driven-development-with-test-explorer.md).
