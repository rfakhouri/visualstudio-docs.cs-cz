...
ms.locfileid: "42668888"
---
# <a name="best-practices-for-coded-ui-tests"></a>Doporučené postupy pro programové testy UI
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [osvědčené postupy pro programové testy UI](https://docs.microsoft.com/visualstudio/test/best-practices-for-coded-ui-tests).  
