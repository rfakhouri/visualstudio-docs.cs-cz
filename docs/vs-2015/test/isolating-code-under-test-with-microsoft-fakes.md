...
Nejnovější verzi tohoto tématu můžete najít v [izolace kódu v rámci testu s Microsoft Fakes](https://docs.microsoft.com/visualstudio/test/isolating-code-under-test-with-microsoft-fakes).  
