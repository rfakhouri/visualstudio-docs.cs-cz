...
ms.locfileid: "42669920"
---
# <a name="using-html5-controls-in-coded-ui-tests"></a>Použití ovládacích prvků HTML5 v programových testech UI
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [pomocí ovládacích prvků HTML5 v programových testů uživatelského rozhraní](https://docs.microsoft.com/visualstudio/test/using-html5-controls-in-coded-ui-tests).  
