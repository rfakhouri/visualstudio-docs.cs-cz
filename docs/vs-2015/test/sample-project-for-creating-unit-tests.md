...
-   [Návod: Spuštění testů a pokrytí kódu zobrazit](http://msdn.microsoft.com/d4aab8e2-2140-4975-b4e3-41ef3fa944c8). Tento návod ukazuje, jak zobrazit data o pokrytí kódu, který znázorňuje podíl kódu projektu, který je právě testováno.  
...
## <a name="see-also"></a>Viz také  
 ...
 [Návod: Spustit testy a zobrazit pokrytí kódu](http://msdn.microsoft.com/d4aab8e2-2140-4975-b4e3-41ef3fa944c8)   
