...
Nejnovější verzi tohoto tématu můžete najít v [návod: vytváření, úpravy a údržba programového testu UI](https://docs.microsoft.com/visualstudio/test/walkthrough-creating-editing-and-maintaining-a-coded-ui-test).  
