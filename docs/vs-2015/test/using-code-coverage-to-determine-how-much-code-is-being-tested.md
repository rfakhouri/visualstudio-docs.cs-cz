...
Nejnovější verzi tohoto tématu můžete najít v [pomocí pokrytí kódu k určení jak mnohem kódu je právě testováno](https://docs.microsoft.com/visualstudio/test/using-code-coverage-to-determine-how-much-code-is-being-tested).  
