...
ms.locfileid: "42675591"
---
# <a name="unit-tests-for-generic-methods"></a>Testy jednotek pro obecné metody
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [testování částí pro obecné metody](https://docs.microsoft.com/visualstudio/test/unit-tests-for-generic-methods).  
