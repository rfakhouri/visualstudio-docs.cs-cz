...
ms.locfileid: "42669093"
---
# <a name="using-the-assert-classes"></a>Používání tříd Assert
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [používání tříd Assert](https://docs.microsoft.com/visualstudio/test/using-the-assert-classes).  
