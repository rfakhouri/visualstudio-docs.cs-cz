...
Nejnovější verzi tohoto tématu můžete najít v [pomocí různých webových prohlížečů v programových testech uživatelského rozhraní](https://docs.microsoft.com/visualstudio/test/using-different-web-browsers-with-coded-ui-tests).  
