...
ms.locfileid: "42696128"
---
# <a name="how-to-sign-application-and-deployment-manifests"></a>Postupy: Podepsání manifestů aplikace a nasazení
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [postupy: přihlášení aplikace a manifesty nasazení](https://docs.microsoft.com/visualstudio/ide/how-to-sign-application-and-deployment-manifests).  
