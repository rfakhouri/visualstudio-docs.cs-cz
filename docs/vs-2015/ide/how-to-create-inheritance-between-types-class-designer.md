...
Nejnovější verzi tohoto tématu můžete najít v [postupy: vytvoření dědičnosti mezi typy (návrhář tříd)](https://docs.microsoft.com/visualstudio/ide/how-to-create-inheritance-between-types-class-designer).  
