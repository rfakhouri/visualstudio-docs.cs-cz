...
- **\<Přidat parametr >**  
   ...
   Poslední řádek parametru členu obsahuje text **< přidat parametr\>**  v **název** buňky. Kliknutím na tuto buňku vytvoříte nový parametr. Další informace najdete v tématu [přidání parametru k metodě](../ide/creating-and-configuring-type-members-class-designer.md#HowToAddParameterToMethod).  
