...
ms.locfileid: "42677301"
---
# <a name="walkthrough-creating-a-code-snippet"></a>Návod: Vytvoření fragmentu kódu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [návod: Vytvoření fragmentu kódu](https://docs.microsoft.com/visualstudio/ide/walkthrough-creating-a-code-snippet).  
