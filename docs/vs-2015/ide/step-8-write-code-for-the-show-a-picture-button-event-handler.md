...
Nejnovější verzi tohoto tématu můžete najít v [krok 8: zapište kód pro zobrazení obslužné rutiny události obrázku tlačítka](https://docs.microsoft.com/visualstudio/ide/step-8-write-code-for-the-show-a-picture-button-event-handler).  
