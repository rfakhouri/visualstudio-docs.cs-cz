...
Nejnovější verzi tohoto tématu můžete najít v [přidání Visual Studio – podpora editoru pro jiné jazyky](https://docs.microsoft.com/visualstudio/ide/adding-visual-studio-editor-support-for-other-languages).  
