...
ms.locfileid: "42631608"
---
# <a name="tutorial-1-create-a-picture-viewer"></a>Tutoriál 1: Vytvoření prohlížeče obrázků
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [kurz 1: vytvoření prohlížeče obrázků](https://docs.microsoft.com/visualstudio/ide/tutorial-1-create-a-picture-viewer).  
