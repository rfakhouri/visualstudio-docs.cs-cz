...
ms.locfileid: "42673874"
---
# <a name="tutorial-3-create-a-matching-game"></a>Tutoriál 3: Vytvoření hry s hledáním shody
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [Tutorial 3: Create a Matching Game](https://docs.microsoft.com/visualstudio/ide/tutorial-3-create-a-matching-game).  
