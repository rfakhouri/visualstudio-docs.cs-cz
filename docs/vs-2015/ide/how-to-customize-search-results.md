---
title: 'Postupy: Přizpůsobení výsledků vyhledávání | Dokumentace Microsoftu'
ms.date: 11/15/2016
...
Můžete přizpůsobit, jak se výsledky hledání zobrazeny v **hledání** kartu několika způsoby.  
  
## <a name="change-the-number-of-topics-that-appear-on-a-search-results-page"></a>Změňte počet témat, které se zobrazují na stránce výsledků hledání  
 Můžete zadat počet témat, které se zobrazují na stránce výsledků hledání jednoduchého.  
