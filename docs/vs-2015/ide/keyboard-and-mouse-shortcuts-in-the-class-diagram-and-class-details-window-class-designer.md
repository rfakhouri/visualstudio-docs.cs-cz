...
Nejnovější verzi tohoto tématu můžete najít v [klávesové zkratky a zkratky myši v diagramu tříd a okně podrobností třídy (návrhář tříd)](https://docs.microsoft.com/visualstudio/ide/keyboard-and-mouse-shortcuts-in-the-class-diagram-and-class-details-window-class-designer).  
