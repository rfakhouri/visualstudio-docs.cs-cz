...
Můžete nastavit obecné vlastnosti aplikace v jazyce Visual Basic C#, a F# aplikace, jako je typ aplikace, spouštěcí objekt a informace o sestavení v **aplikace** podokně **projektu Návrhář**.  
