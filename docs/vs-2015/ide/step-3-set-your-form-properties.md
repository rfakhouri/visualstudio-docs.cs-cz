...
ms.locfileid: "42629304"
---
# <a name="step-3-set-your-form-properties"></a>Krok 3: Nastavte vlastnosti svého formuláře
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [krok 3: Nastavte si vlastnosti formuláře](https://docs.microsoft.com/visualstudio/ide/step-3-set-your-form-properties).  
