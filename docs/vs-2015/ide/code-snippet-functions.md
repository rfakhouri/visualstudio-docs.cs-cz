...
ms.locfileid: "42668161"
---
# <a name="code-snippet-functions"></a>Funkce fragmentu kódu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [funkce fragmentu kódu](https://docs.microsoft.com/visualstudio/ide/code-snippet-functions).  
