...
## <a name="understanding-security"></a>Princip zabezpečení  
 [Zabezpečení](http://msdn.microsoft.com/library/9a9621d7-8883-4a4f-a874-65e8e09e20a6)  
 ...
 [Chránit svůj kód pomocí prvních deset tipům k zabezpečení, které musí znát každý vývojář](http://go.microsoft.com/fwlink/?LinkId=72877)  
