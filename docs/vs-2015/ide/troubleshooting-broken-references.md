...
ms.locfileid: "42669057"
---
# <a name="troubleshooting-broken-references"></a>Řešení potíží s poškozenými odkazy
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [nefunkční odkazy na řešení potíží](https://docs.microsoft.com/visualstudio/ide/troubleshooting-broken-references).  
