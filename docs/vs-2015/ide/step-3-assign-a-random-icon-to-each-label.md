...
ms.locfileid: "42666301"
---
# <a name="step-3-assign-a-random-icon-to-each-label"></a>Krok 3: Přiřaďte jednotlivým jmenovkám náhodné ikony
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [krok 3: přiřazení náhodné ikony pro každý popisek](https://docs.microsoft.com/visualstudio/ide/step-3-assign-a-random-icon-to-each-label).  
