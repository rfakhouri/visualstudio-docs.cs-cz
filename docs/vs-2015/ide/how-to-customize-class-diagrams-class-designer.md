...
ms.locfileid: "42669299"
---
# <a name="how-to-customize-class-diagrams-class-designer"></a>Postupy: Přizpůsobení diagramů tříd (návrhář tříd)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [postupy: přizpůsobení diagramů tříd (návrhář tříd)](https://docs.microsoft.com/visualstudio/ide/how-to-customize-class-diagrams-class-designer).  
