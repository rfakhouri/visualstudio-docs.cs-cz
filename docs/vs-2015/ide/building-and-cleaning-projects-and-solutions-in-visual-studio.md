---
title: Sestavování a čištění projektů a řešení v sadě Visual Studio | Dokumentace Microsoftu
ms.custom: ''
ms.date: 2018-06-30
...
Nejnovější verzi tohoto tématu můžete najít v [sestavování a čištění projektů a řešení v sadě Visual Studio](https://docs.microsoft.com/visualstudio/ide/building-and-cleaning-projects-and-solutions-in-visual-studio).  
