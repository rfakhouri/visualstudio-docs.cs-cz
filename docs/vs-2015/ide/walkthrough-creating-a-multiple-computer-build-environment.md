...
Nejnovější verzi tohoto tématu můžete najít v [návod: vytvoření prostředí s více počítači sestavení](https://docs.microsoft.com/visualstudio/ide/walkthrough-creating-a-multiple-computer-build-environment).  
