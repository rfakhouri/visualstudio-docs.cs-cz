...
Nejnovější verzi tohoto tématu můžete najít v [krok 4: přidejte obslužné rutiny události Click pro každý popisek](https://docs.microsoft.com/visualstudio/ide/step-4-add-a-click-event-handler-to-each-label).  
