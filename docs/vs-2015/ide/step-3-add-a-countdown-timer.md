...
ms.locfileid: "42673164"
---
# <a name="step-3-add-a-countdown-timer"></a>Krok 3: Přidejte časovač odpočítávání
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [krok 3: přidejte časovač odpočítávání](https://docs.microsoft.com/visualstudio/ide/step-3-add-a-countdown-timer).  
