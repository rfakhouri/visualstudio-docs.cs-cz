...
ms.locfileid: "42682051"
---
# <a name="replace-in-files-command"></a>Nahradit v souborech – příkaz
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [nahradit v souborech – příkaz](https://docs.microsoft.com/visualstudio/ide/reference/replace-in-files-command).  
