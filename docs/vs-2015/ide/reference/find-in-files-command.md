...
ms.locfileid: "42669792"
---
# <a name="find-in-files-command"></a>Najít v souborech – příkaz
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [najít v souborech – příkaz](https://docs.microsoft.com/visualstudio/ide/reference/find-in-files-command).  
