...
ms.locfileid: "42696213"
---
# <a name="miscellaneous-files"></a>Ostatní soubory
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [různé soubory](https://docs.microsoft.com/visualstudio/ide/reference/miscellaneous-files).  
