...
Nejnovější verzi tohoto tématu můžete najít v [možnosti, textový Editor, JavaScript, IntelliSense](https://docs.microsoft.com/visualstudio/ide/reference/options-text-editor-javascript-intellisense).  
