...
Nejnovější verzi tohoto tématu můžete najít v [nastavení projektu VC ++, projekty a řešení, dialogové okno Možnosti](https://docs.microsoft.com/visualstudio/ide/reference/vcpp-project-settings-projects-and-solutions-options-dialog-box).  
