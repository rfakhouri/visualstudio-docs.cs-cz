...
Nejnovější verzi tohoto tématu můžete najít v [postupy: použití klávesnice výhradně](https://docs.microsoft.com/visualstudio/ide/reference/how-to-use-the-keyboard-exclusively).  
