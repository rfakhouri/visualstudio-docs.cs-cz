...
ms.locfileid: "42627813"
---
# <a name="convert-dialog-box"></a>Dialogové okno Převést
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [dialogové okno Převést](https://docs.microsoft.com/visualstudio/ide/reference/convert-dialog-box).  
...
## <a name="see-also"></a>Viz také  
 [NOTINBUILD - postupy: Upgrade projektu z jazyka Visual Basic 6.0](http://msdn.microsoft.com/en-us/c0421e57-5bba-422e-934d-ec42ab9f2af9)   
