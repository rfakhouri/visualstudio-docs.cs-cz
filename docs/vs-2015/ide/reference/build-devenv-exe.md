...
ms.locfileid: "42671551"
---
# <a name="build-devenvexe"></a>/Build (devenv.exe)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [– sestavení (devenv.exe)](https://docs.microsoft.com/visualstudio/ide/reference/build-devenv-exe).  
