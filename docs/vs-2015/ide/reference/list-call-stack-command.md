...
ms.locfileid: "42670232"
---
# <a name="list-call-stack-command"></a>Listovat zásobník volání – příkaz
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [příkazu Call Stack seznamu](https://docs.microsoft.com/visualstudio/ide/reference/list-call-stack-command).  
