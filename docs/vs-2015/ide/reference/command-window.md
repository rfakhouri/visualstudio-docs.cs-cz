...
ms.locfileid: "42675542"
---
# <a name="command-window"></a>Příkazové okno
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [příkazové okno](https://docs.microsoft.com/visualstudio/ide/reference/command-window).  
...
## <a name="parameters-switches-and-values"></a>Parametry, přepínače a hodnoty  
 Některé [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] příkazy vyžadovala trojnásobnou investici příkazy a nepovinné argumenty, přepínače a hodnoty. Některá pravidla platí při zpracování komplexnějších pomocí těchto příkazů. Následuje příklad bohaté příkazu vyjasnit terminologii.  
