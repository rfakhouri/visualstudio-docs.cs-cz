...
ms.locfileid: "42666950"
---
# <a name="step-9-review-comment-and-test-your-code"></a>Krok 9: Zrevidujte, okomentujte a otestujte svůj kód
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [krok 9: revize, komentáře a Test kódu](https://docs.microsoft.com/visualstudio/ide/step-9-review-comment-and-test-your-code).  
