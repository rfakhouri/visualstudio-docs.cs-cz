...
ms.locfileid: "42629097"
---
# <a name="visual-c-classes-in-class-designer"></a>Třídy jazyka Visual C++ v návrháři tříd
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nejnovější verzi tohoto tématu můžete najít v [třídy Visual C++ v Návrháři tříd](https://docs.microsoft.com/visualstudio/ide/visual-cpp-classes-in-class-designer).  
