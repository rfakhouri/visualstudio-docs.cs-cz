...
Nejnovější verzi tohoto tématu můžete najít v [postupy: Konfigurace projektů pro více cílových platforem](https://docs.microsoft.com/visualstudio/ide/how-to-configure-projects-to-target-multiple-platforms).  
