...
ms.locfileid: "34815883"
---
# <a name="how-to-instrument-a-native-stand-alone-component-and-collect-timing-data-with-the-profiler-from-the-command-line"></a>Postupy: instrumentace nativní samostatné součásti a shromažďování dat časování profileru z příkazového řádku
Toto téma popisuje postup použití [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] nástroje příkazového řádku v nástrojích pro profilaci k instrumentace nativní součásti, jako je například jazyka C++. *exe* nebo. *knihovny DLL* souboru a shromažďování podrobných dat časování.  
...
3.  Spusťte profileru. Typ:  
    ...
    |[/crosssession](../profiling/crosssession.md)|Umožňuje profilace procesů v jiných relacích. Tato možnost je povinná, pokud je aplikace spuštěna v jiné relaci. Identifikátor relace, je uvedena ve **ID relace** sloupec na kartě procesy ve Správci úloh systému Windows. **/CS** lze zadat jako zkratkou pro **/crosssession**.|  
