---
title: "Shromažďování dat paměti .NET Framework pomocí příkazového řádku profileru | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Tato část popisuje postupy a možnosti pro shromažďování přidělování paměti a životnosti objektů pro .NET (samostatná) aplikace klienta pomocí metody vzorkování z příkazového řádku.  
  
## <a name="common-tasks"></a>Obecné úlohy  
  
|Úloha|Související obsah|  
|----------|---------------------|  
|**Spuštění aplikace a profil využívání paměti rozhraním .NET**|-   [Postupy: spuštění aplikace rozhraní .NET Framework s Profilerem ke shromažďování dat paměti](../profiling/how-to-launch-a-stand-alone-dotnet-framework-application-with-the-profiler-to-collect-memory-data-by-using-the-command-line.md)|  
|**Připojení profileru k aplikaci .NET**|-   [Postupy: připojení profileru k aplikaci .NET Framework ke shromažďování dat paměti](../profiling/how-to-attach-the-profiler-to-a-dotnet-framework-stand-alone-application-to-collect-memory-data-by-using-the-command-line.md)|  
|**Instrumentace aplikace ke shromažďování dat paměti .NET**|-   [Postupy: instrumentace samostatné součásti rozhraní .NET Framework a shromažďování dat paměti profilerem](../profiling/how-to-instrument-a-stand-alone-dotnet-framework-component-and-collect-memory-data-with-the-profiler-by-using-the-command-line.md)|  
...
|**Profil aktivita prostředku kolizí a přístup z více vláken**|-   [Shromažďování dat souběžnosti](../profiling/collecting-concurrency-data-for-stand-alone-applications-by-using-the-profiler-command-line.md)|  
