...
---
# <a name="use-profiling-methods-to-collect-performance-data-from-the-command-line"></a>Použití metod profilování ke shromažďování dat výkonu z příkazového řádku
