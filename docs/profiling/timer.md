...
#### <a name="parameters"></a>Parametry
 `Cycles` Celočíselná hodnota, která určuje počet hodinových cyklů procesoru v intervalu vzorkování. Pokud `Cycles` není zadán, interval je nastavená na 10 000 000. Zadejte hodnotu bez čárkami.
 ...
 **Připojení:** `PID` Připojí profiler pro proces určený identifikátorem procesu (`PID`).
 ...
 **Sys**[**:**`Events`] Nastaví událost odběru vzorků na operační systém volá a volitelně nastaví interval vzorkování na `Events`. Výchozí Sys interval je 10.
