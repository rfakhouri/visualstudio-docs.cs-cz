...
Toto téma popisuje, jak správce počítače uděluje oprávnění zabezpečení požadovaná pro profilace pro uživatele nebo skupiny, který nemá oprávnění správce na tomto počítači.  
