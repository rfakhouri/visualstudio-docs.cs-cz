...
Pokud element aktuálně vybrané vlákno reprezentuje blokované segment, který později začal k provedení po byl odblokováno jiné vlákno v aktuálním procesu, zásobník volání pro vlákno, které se odblokování se zobrazí na této kartě.  
