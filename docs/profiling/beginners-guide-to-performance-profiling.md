---
title: Využití procesoru měr ve svých aplikacích
description: Analyzujte problémy s výkonem procesoru do vaší aplikace pomocí nástroje Diagnostika integrovaná s ladicím programem.
ms.custom: mvc
ms.date: 02/27/2017
