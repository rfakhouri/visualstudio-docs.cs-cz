...
|**Konfigurace, třídění a filtrování zobrazení sestav:** můžete zadat a pořadí sloupců dat, které se zobrazí v sestavě, řazení řádků sestavy a filtrování dat budou zahrnuty pouze čas segment, který zadáte.|-   [Přizpůsobení zobrazení sestav nástrojů výkonu](../profiling/customizing-performance-tools-report-views.md)|  
