...
Od verze Visual Studio 2017, tato data lze otevřít pomocí [GPUView](/windows-hardware/drivers/display/using-gpuview) a [Analyzátor výkonu Windows](/windows-hardware/test/wpt/windows-performance-analyzer) kliknutím **otevřít v GpuView** nebo **otevřít WPA** odkazy nachází v pravém dolním rohu diagnostické relace.
