...
Toto téma popisuje postup použití [!INCLUDE[vsPreShort](../code-quality/includes/vspreshort_md.md)] nástroje příkazového řádku v nástrojích pro profilaci účelem instrumentace [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] služby a shromažďování podrobných dat časování.  
...
#### <a name="to-start-profiling-a-net-framework-service"></a>Ke spuštění profilování služby rozhraní .NET Framework  
