---
title: Správa balíčků npm v sadě Visual Studio
...
Visual Studio umožňuje snadno pracovat s npm a problém příkazy npm přes uživatelské rozhraní nebo pomocí nebo přímo. Můžete použít následující metody:
