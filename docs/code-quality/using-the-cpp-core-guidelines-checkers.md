---
title: Pomocí kameny základní pokyny pro C++
ms.date: 11/04/2016
ms.topic: conceptual
author: mikeblome
ms.author: mblome
...
Při přidávání nové pravidel pro kontrolu C++ základní pokyny, může zvýšit počet upozornění, které jsou vytvářeny pro existující kód. Sady předdefinovaných pravidel můžete použít k filtrování které typy pravidel se povolit.
Témata odkazů pro většinu pravidla jsou ve [Visual Studio C++ základní zkontrolujte Reference](code-analysis-for-cpp-corecheck.md).
...
## <a name="macros"></a>Makra
 Nástroj pro kontrolu C++ základní pokyny součástí se dodává s soubor hlaviček, který definuje makra, které usnadňují potlačit celý kategorií upozornění v kódu:
