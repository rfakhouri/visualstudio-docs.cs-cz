---
title: 'CA1414: Označte logické vyvolání P pomocí MarshalAs'
ms.date: 11/04/2016
...
## <a name="see-also"></a>Viz také
 <xref:System.Runtime.InteropServices.UnmanagedType?displayProperty=fullName> [Spolupráce s nespravovaným kódem](/dotnet/framework/interop/index)