...
2.  Na řádku nabídek zvolte **sestavení**, **spustit analýza kódu v řešení**.
    ...
    > **Neplatná hodnota parametru C6387** 'pinta, může být '0': to není ve správném specifikace pro funkci 'InCallee'.
