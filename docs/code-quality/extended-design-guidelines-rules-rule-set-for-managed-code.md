---
title: "Nastavení pravidel rozšířená pravidla pokynů návrhu pro spravovaný kód | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|[CA1020](../code-quality/ca1020-avoid-namespaces-with-few-types.md)|Vyvarujte se oborům názvu s několika typy|  
...
|[CA1700](../code-quality/ca1700-do-not-name-enum-values-reserved.md)|Nepojmenovávejte hodnoty výčtu 'Reserved'|  
|[CA1701](../code-quality/ca1701-resource-string-compound-words-should-be-cased-correctly.md)|Složených slov prostředku řetězců by měla být použita správně|  
|[CA1702](../code-quality/ca1702-compound-words-should-be-cased-correctly.md)|Složených slov by měla být použita správně|  
...
|[CA1709](../code-quality/ca1709-identifiers-should-be-cased-correctly.md)|Identifikátory by měla být použita správně|  
...
|[CA1712](../code-quality/ca1712-do-not-prefix-enum-values-with-type-name.md)|Nezadávejte na hodnoty výčtu s názvem typu|  
|[CA1713](../code-quality/ca1713-events-should-not-have-before-or-after-prefix.md)|Události by neměly mít předponu před nebo po|  
|[CA1714](../code-quality/ca1714-flags-enums-should-have-plural-names.md)|Výčty příznaků by měly mít názvy v množném čísle|  
|[CA1715](../code-quality/ca1715-identifiers-should-have-correct-prefix.md)|Identifikátory by měly mít správnou předponou.|  
...
|[CA1721](../code-quality/ca1721-property-names-should-not-match-get-methods.md)|Názvy vlastností by neměly odpovídat metody get|  
...
|[CA1725](../code-quality/ca1725-parameter-names-should-match-base-declaration.md)|Názvy parametrů by měl odpovídat základní deklaraci|  
