---
title: "Ukázka ukázka | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Tato následující postupy ukazují, jak vytvořit vzorek pro [návod: Analýza kódu C/C++ na výskyt závad](../code-quality/walkthrough-analyzing-c-cpp-code-for-defects.md). Postupy vytvořit:  
  
-   A [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] řešení s názvem CppDemo.  
...
3.  V **název** zadejte **Bug.cpp** a pak klikněte na **přidat**.  
  
4.  Zkopírujte následující kód a vložte ji do **Bug.cpp** v soubor [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] editor.  
...
8.  Zkopírujte následující kód a vložte jej do souboru Bug.h v [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] editor.  
...
4.  Zkopírujte následující kód a vložte ji do **annotations.h** v soubor [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] editor.  
...
8.  Zkopírujte následující kód a vložte ji do **annotations.cpp** v soubor [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] editor.  
