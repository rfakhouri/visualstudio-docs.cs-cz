...
## [Analyzátory Roslyn](roslyn-analyzers-overview.md)
...
### [Instalace analyzátorů Roslyn](install-roslyn-analyzers.md)
### [Konfigurace a používání analyzátorů Roslyn](use-roslyn-analyzers.md)
### [Povolení automatické analýzy kódu](how-to-enable-and-disable-automatic-code-analysis-for-managed-code.md)
### [Povolení úplné analýzy řešení](how-to-enable-and-disable-full-solution-analysis-for-managed-code.md)
### [Automatické pozastavení funkce](automatic-feature-suspension.md)
### [Ruční spuštění analýzy kódu](how-to-run-code-analysis-manually-for-managed-code.md)
...
### [Nastavení vlastností analýzy kódu](how-to-set-code-analysis-properties-for-c-cpp-projects.md)
### [Použití anotací SAL k omezení defektů kódu](using-sal-annotations-to-reduce-c-cpp-code-defects.md)
...
### [Použití sady pravidel pro spravovaný kód](how-to-configure-code-analysis-for-a-managed-code-project.md)
#### [Konfigurace analýzy kódu pro webovou aplikaci ASP.NET](how-to-configure-code-analysis-for-an-aspnet-web-application.md)
#### [Určení sad pravidel pro více projektů](how-to-specify-managed-code-rule-sets-for-multiple-projects-in-a-solution.md)
### [Použití sady pravidel pro kód C++](using-rule-sets-to-specify-the-cpp-rules-to-run.md)
### [Synchronizace sad pravidel projektu pomocí zásad vracení zpět se změnami týmového projektu](how-to-synchronize-code-project-rule-sets-with-team-project-check-in-policy.md)
### [Vytvoření vlastních sad pravidel](creating-custom-code-analysis-rule-sets.md)
#### [Vytvoření vlastní sady pravidel](how-to-create-a-custom-rule-set.md)
#### [Použití Editoru sad pravidel](working-in-the-code-analysis-rule-set-editor.md)
## [Vytvoření zásad pro vrácení analýzy kódu se změnami](how-to-create-or-update-standard-code-analysis-check-in-policies.md)
...
### [Vynucování udržitelného kódu](how-to-enforce-maintainable-code-with-a-code-analysis-check-in-policy.md)
### [Kompatibilita verzí](version-compatibility-for-code-analysis-check-in-policies.md)
## Metriky kódu
