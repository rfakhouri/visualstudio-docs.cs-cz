...
### [Sady pravidel pro kód C++](using-rule-sets-to-specify-the-cpp-rules-to-run.md)
...
## [Zásady operace vrácení se změnami](how-to-create-or-update-standard-code-analysis-check-in-policies.md)
...
### [Synchronizace sad pravidel projektu pomocí týmových zásad vracení zpět se změnami](how-to-synchronize-code-project-rule-sets-with-team-project-check-in-policy.md)
...
# Odkaz
## [Sady pravidel](rule-set-reference.md)
