# Přehled
## [Analýza kódu pro spravovaný kód](code-analysis-for-managed-code-overview.md)
## [Analýza kódu pro C/C++](code-analysis-for-c-cpp-overview.md)
## [Měření udržovatelnosti kódu pomocí metrik kódu](code-metrics-values.md)
# Rychlý start
## [Rychlý start: Analýza kódu pro C/C++](quick-start-code-analysis-for-c-cpp.md)
# Kurzy
## [Analýza defektů ve spravovaném kódu](walkthrough-analyzing-managed-code-for-code-defects.md)
## [Analýza defektů v kódu C/C++](walkthrough-analyzing-c-cpp-code-for-defects.md)
### [Demonstrační ukázka](demo-sample.md)
## [Konfigurace a použití vlastní sady pravidel](walkthrough-configuring-and-using-a-custom-rule-set.md)
# Návody
## Analýza kódu pro spravovaný kód
### [Povolení a zakázání automatické analýzy kódu pro spravovaný kód](how-to-enable-and-disable-automatic-code-analysis-for-managed-code.md)
### [Povolení a zakázání úplné analýzy řešení pro spravovaný kód](how-to-enable-and-disable-full-solution-analysis-for-managed-code.md)
### [Automatické pozastavení funkce](automatic-feature-suspension.md)
### [Ruční spuštění analýzy kódu pro spravovaný kód](how-to-run-code-analysis-manually-for-managed-code.md)
### [Potlačení upozornění](in-source-suppression-overview.md)
#### [Potlačení upozornění analýzy kódu pro vygenerovaný kód](how-to-suppress-code-analysis-warnings-for-generated-code.md)
### [Přizpůsobení slovníku analýzy kódu](how-to-customize-the-code-analysis-dictionary.md)
### [Anonymní metody a analýza kódu](anonymous-methods-and-code-analysis.md)
### [Vytvoření pracovní položky pro defekt spravovaného kódu](how-to-create-a-work-item-for-a-managed-code-defect.md)
...
### [Nastavení vlastností analýzy kódu pro projekty C/C++](how-to-set-code-analysis-properties-for-c-cpp-projects.md)
### [Použití anotací SAL k omezení defektů kódu C/C++](using-sal-annotations-to-reduce-c-cpp-code-defects.md)
#### [Princip SAL](understanding-sal.md)
#### [Anotace parametrů funkcí a návratových hodnot](annotating-function-parameters-and-return-values.md)
#### [Anotace chování funkcí](annotating-function-behavior.md)
#### [Anotace struktur a tříd](annotating-structs-and-classes.md)
#### [Anotace chování při uzamykání](annotating-locking-behavior.md)
...
## [Seskupení pravidel analýzy kódu pomocí sad pravidel](using-rule-sets-to-group-code-analysis-rules.md)
### [Konfigurace analýzy kódu pro projekt spravovaného kódu](how-to-configure-code-analysis-for-a-managed-code-project.md)
### [Konfigurace analýzy kódu pro webovou aplikaci ASP.NET](how-to-configure-code-analysis-for-an-aspnet-web-application.md)
### [Synchronizace sad pravidel projektu kódu pomocí zásad vracení zpět se změnami týmového projektu](how-to-synchronize-code-project-rule-sets-with-team-project-check-in-policy.md)
### [Určení sad pravidel spravovaného kódu pro více projektů v určitém řešení](how-to-specify-managed-code-rule-sets-for-multiple-projects-in-a-solution.md)
### [Vytváření vlastních sad pravidel analýzy kódu](creating-custom-code-analysis-rule-sets.md)
#### [Vytvoření vlastní sady pravidel](how-to-create-a-custom-rule-set.md)
#### [Použití editoru sad pravidel analýzy kódu](working-in-the-code-analysis-rule-set-editor.md)
...
## [Zvýšení kvality kódu pomocí zásad vracení zpět se změnami týmového projektu](enhancing-code-quality-with-team-project-check-in-policies.md)
### [Vytváření a použití zásad vracení zpět se změnami analýzy kódu](creating-and-using-code-analysis-check-in-policies.md)
#### [Vytváření nebo aktualizace standardních zásad vracení zpět se změnami analýzy kódu](how-to-create-or-update-standard-code-analysis-check-in-policies.md)
#### [Implementace vlastních zásad vracení zpět se změnami analýzy kódu pro spravovaný kód](implementing-custom-code-analysis-check-in-policies-for-managed-code.md)
#### [Vynucení udržovatelného kódu pomocí zásad vracení zpět se změnami analýzy kódu](how-to-enforce-maintainable-code-with-a-code-analysis-check-in-policy.md)
...
## Metriky kódu
### [Generování dat metrik kódu](how-to-generate-code-metrics-data.md)
...
## [Upozornění kontrolních mechanismů C++ Core Guidelines](code-analysis-for-cpp-corecheck.md)
### [C26400](C26400.md)
### [C26401](C26401.md)
### [C26402](C26402.md)
### [C26403](C26403.md)
