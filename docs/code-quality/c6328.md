...
```  
 ...
 `c`může být rozšířeny do přihlášeni `int` s hodnotou-37, což je mimo platný rozsah pro [isspace –](http://msdn.microsoft.com/Library/3ac254c4-92aa-4238-882a-3a3fb576cdf5).  
