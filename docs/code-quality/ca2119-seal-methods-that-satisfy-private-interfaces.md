...
## <a name="see-also"></a>Viz také
 [Rozhraní](/dotnet/csharp/programming-guide/interfaces/index) [rozhraní](/dotnet/visual-basic/programming-guide/language-features/interfaces/index)