...
|[CA1302](../code-quality/ca1302-do-not-hardcode-locale-specific-strings.md)|Proveďte závislé konkrétní řetězce národní prostředí|
...
|[CA1306](../code-quality/ca1306-set-locale-for-data-types.md)|Sada národní prostředí pro datové typy|
