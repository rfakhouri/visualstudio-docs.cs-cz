...
ms.locfileid: "65934265"
---
# <a name="c26432-defineordeletespecialops"></a>C26432 DEFINE_OR_DELETE_SPECIAL_OPS
"Pokud definujete nebo odstraníte jakoukoli výchozí operaci v typu, definujte nebo odstraňte je všechny."

**C++ Core Guidelines**: [C.21: Pokud definujete nebo = odstraníte jakoukoli výchozí operaci, definujte nebo = odstraňte je všechny](https://isocpp.github.io/CppCoreGuidelines/CppCoreGuidelines#c21-if-you-define-or-delete-any-default-operation-define-or-delete-them-all)
