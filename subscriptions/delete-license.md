---
title: Odstranění přiřazení | Microsoft Docs
author: evanwindom
ms.author: jaunger
manager: evelynp
ms.date: 10/03/2017
ms.topic: Get-Started-Article
description: Zjistěte, jak můžou správci odstranit odběr přiřazení
...
Pokud odběratel už vyžaduje předplatné sady Visual Studio, například pokud se ze společnosti odešel, dokončení projektu nebo přepněte na nové úlohy role, můžete odebrat svoje předplatné a přiřadit někomu jinému. Poznámka: při opětovném přiřazení předplatné, nebude resetovat výhody pro předplatitele.  Nový uživatel bude moct deklarace žádné kusů klíče a zobrazení dříve vyžádaná klíče, ale jsou deklarace identity omezení **není** resetovat. 
