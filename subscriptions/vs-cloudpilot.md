---
title: CloudPilot výhody v předplatných sady Visual Studio | Dokumentace Microsoftu
author: evanwindom
ms.author: lank
manager: lank
ms.date: 12/19/2018
...
2. Vyhledejte dlaždici CloudPilot výhoda v kategorii "Nástroje" a klikněte na **získat kód**.
...
0. K vytvoření vašeho účtu a aktivaci předplatného CloudPilot, vyplňte kontaktní údaje ve webovém formuláři a klikněte na **ZAREGISTROVAT**.

   > [!div class="mx-imgBorder"]
   > ![CloudPilot registrační stránku](_img/vs-cloudpilot/vs-cloudpilot-register.png)
...
0.  Poté, co váš účet je úspěšně vytvořen, obdržíte e-mailu z podpory služby VSS UnifyCloud potvrzení úspěšné vytvoření vašeho účtu. 
    ...
    > [!div class="mx-imgBorder"]
    > ![CloudPilot potvrzení e-mailu](_img/vs-cloudpilot/vs-cloudpilot-email.png)
...
|--------------------------------------------------------------------|---------------------------------------------------------|------------------------------------------------------------------|---------------|
| Visual Studio Enterprise (Standard)   | VL, Azure, maloobchodní prodej | 2 licencí, 90 dnů, neomezený počet kontrol       |  Ne.  K dispozici pro nové předplatitele pouze          |
