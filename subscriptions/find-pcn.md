---
title: Jak najít Můj "veřejné zákaznické" kontrolního číslo nebo autorizační číslo? | Microsoft Docs
author: evanwindom
ms.author: jaunger
manager: evelynp
ms.date: 12/29/2017
ms.topic: Get-Started-Article
description: Zjistěte, jak najít číslo kontrolního (veřejná čísla výrobku zákazníka) nebo autorizační číslo
...
K dokončení registrace vaší organizace na portálu pro správu předplatného, budete potřebovat veřejné zákaznické číslo (PCN) nebo autorizační číslo. Tento článek obsahuje kroky k vyhledání tato čísla pro vaši organizaci.  

## <a name="to-locate-your-pcn-or-authorization-number"></a>Vyhledejte kontrolního čísla výrobku nebo autorizační číslo
...
Pokud máte více než jeden veřejné zákaznické číslo (kontrolního čísla výrobku), obdržíte pro každý kontrolního čísla výrobku jednu e-mailovou adresou URL jedinečné registrace. Každou jedinečnou adresu URL funguje pouze odpovídající kontrolního čísla výrobku, poslední tři znaky, které jsou také uvedeny v stejnou e-mailu. Budete potřebovat k dokončení procesu registrace prostřednictvím jedinečný odkaz v každé e-mailu pro každý kontrolního čísla výrobku. 