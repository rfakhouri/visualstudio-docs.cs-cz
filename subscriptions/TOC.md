...
# Přehled
## [Porovnání možností předplatného](compare-subscriptions.md)

# Návody
##  Předplatitelé
### [Koupit předplatné](buy-vs-subscriptions.md)
### [Spravovat předplatné](manage-vs-subscriptions.md)
### [Používání souborů ke stažení pro předplatitele](subscriber-downloads.md)
...
##### [Průběžné platby za Microsoft Azure](vs-azure-payg.md) 
#### Vzdělávání
...
### [Co dělat, když je přiděleno více licencí, než máte předplaceno](handle-overclaimed-license.md)
### [Co dělat, když platnost předplatného vypršela](handle-expired-license.md)

## Prostředky
### [Podmínky použití](vs-license-terms.md)
### [Podpora pro předplatné](https://www.visualstudio.com/subscriptions/support/)
