...
description: Získejte maximum z vašich předplatných Visual Studio
...
Visual Studio [portál odběratele](https://my.visualstudio.com) vám dává možnost spravovat všechny odběry a program členství na jednom místě.  Můžete provést změny vašeho profilu, použijte všechny výhody součástí předplatných a přepínat mezi odběry snadno a rychle.  
...
Portál odběry umožňuje vytvářet a spravovat profil a usnadnit správu vašich předplatných.  Můžete provést změny vašeho Víceřádkový identity a přidružit jiné přihlášení identity z existujících účtů Azure a služby VSTS ke svým předplatným použití alternativní identit. 
