...
### <a name="using-your-contract-id-and-access-id-when-submitting-an-incident-initial-use"></a>Pomocí ID smlouvy a přístupové ID, při odesílání incidentu (počáteční použití)

#### <a name="submitting-an-incident-online"></a>Odeslání incidentu online

Při odeslání incidentu online, budete nejprve vyzváni k přihlášení. Pomocí rozevíracího seznamu vyberte produkt, který budete potřebovat pomoc s. Například pokud chcete odeslat vyberte incident pro Visual Studio Enterprise 2017 **vývojářské nástroje** řady a pak vyberte **Visual Studio 2017** produkt a klikněte na tlačítko **sady Visual Studio Enterprise 2017** jako verze.

1. Po výběru produktů, pro který potřebujete podporu, klikněte na tlačítko **Další**.

   > [!div class="mx-imgBorder"]
   > ![Technická podpora výhodu odesílání incidentů na krok 1 – produktu](_img/vs-tech-support/vs-tech-support-step1.png)

2. Popište svůj problém a klikněte na tlačítko **Další**.

   > [!div class="mx-imgBorder"]
   > ![Technická podpora výhodu odesílání incidentů na krok 2 – potíže](_img/vs-tech-support/vs-tech-support-step2.png)

3. Na stránce "Plán podpory" přejděte dolů k položce **přidat nebo nákupu plánu podpory**, rozbalte ho pomocí kláves Šipka vpravo a klikněte na tlačítko **přidat smlouvy**.

   > [!div class="mx-imgBorder"]
   > ![Technická podpora výhody oznámení případu - přidat smlouvy](_img/vs-tech-support/vs-tech-support-add-contract.png)
