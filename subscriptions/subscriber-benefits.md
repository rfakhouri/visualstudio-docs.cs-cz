...
Další informace o výhodách, které jsou součástí vašeho předplatného, podívejte se [Visual Studio stránce s cenami](https://visualstudio.microsoft.com/vs/pricing/).  Informace o určité výhody, včetně, které odběry funkci, je k dispozici v **pomocí výhody pro předplatitele** tématu níže.
